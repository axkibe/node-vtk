...
#ifdef VTK_NODE_PLUS_VTKTEXTUREMAPTOSPHEREWRAP_INITPTPL
	VTK_NODE_PLUS_VTKTEXTUREMAPTOSPHEREWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkTextureMapToSphereWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkTextureMapToSphereWrap* obj = new VtkTextureMapToSphereWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
