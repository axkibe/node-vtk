...
#ifndef NATIVE_EXTENSION_VTK_VTKQUADRATICWEDGEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKQUADRATICWEDGEWRAP_H
...
class VtkQuadraticWedgeWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkQuadraticWedgeWrap(vtkSmartPointer<vtkQuadraticWedge>);
		VtkQuadraticWedgeWrap();
		~VtkQuadraticWedgeWrap( );
...
#ifdef VTK_NODE_PLUS_VTKQUADRATICWEDGEWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKQUADRATICWEDGEWRAP_CLASSDEF
#endif
};
