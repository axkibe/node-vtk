...
void VtkExodusIIReaderWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetProducedFastPathOutput", GetProducedFastPathOutput);
	Nan::SetPrototypeMethod(tpl, "getProducedFastPathOutput", GetProducedFastPathOutput);
...
void VtkExodusIIReaderWrap::GetProducedFastPathOutput(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkExodusIIReaderWrap *wrapper = ObjectWrap::Unwrap<VtkExodusIIReaderWrap>(info.Holder());
	vtkExodusIIReader *native = (vtkExodusIIReader *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetProducedFastPathOutput();
	info.GetReturnValue().Set(Nan::New(r));
}
