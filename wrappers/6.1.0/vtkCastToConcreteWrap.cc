...
#ifdef VTK_NODE_PLUS_VTKCASTTOCONCRETEWRAP_INITPTPL
	VTK_NODE_PLUS_VTKCASTTOCONCRETEWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkCastToConcreteWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkCastToConcreteWrap* obj = new VtkCastToConcreteWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
