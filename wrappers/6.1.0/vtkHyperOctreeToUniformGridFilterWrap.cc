...
#ifdef VTK_NODE_PLUS_VTKHYPEROCTREETOUNIFORMGRIDFILTERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKHYPEROCTREETOUNIFORMGRIDFILTERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkHyperOctreeToUniformGridFilterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkHyperOctreeToUniformGridFilterWrap* obj = new VtkHyperOctreeToUniformGridFilterWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
