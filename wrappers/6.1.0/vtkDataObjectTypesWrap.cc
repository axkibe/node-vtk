...
#ifdef VTK_NODE_PLUS_VTKDATAOBJECTTYPESWRAP_INITPTPL
	VTK_NODE_PLUS_VTKDATAOBJECTTYPESWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkDataObjectTypesWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkDataObjectTypesWrap* obj = new VtkDataObjectTypesWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
