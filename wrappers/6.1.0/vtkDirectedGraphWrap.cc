...
VtkDirectedGraphWrap::VtkDirectedGraphWrap(vtkSmartPointer<vtkDirectedGraph> _native)
{ native = _native; }
...
{
	Nan::SetAccessor(exports, Nan::New("vtkDirectedGraph").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("DirectedGraph").ToLocalChecked(), ConstructorGetter);
}

void VtkDirectedGraphWrap::ConstructorGetter(
...
void VtkDirectedGraphWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKDIRECTEDGRAPHWRAP_INITPTPL
	VTK_NODE_PLUS_VTKDIRECTEDGRAPHWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}

void VtkDirectedGraphWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkDirectedGraphWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkDirectedGraphWrap::GetData(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDirectedGraphWrap *wrapper = ObjectWrap::Unwrap<VtkDirectedGraphWrap>(info.Holder());
	vtkDirectedGraph *native = (vtkDirectedGraph *)wrapper->native.GetPointer();
...
void VtkDirectedGraphWrap::GetDataObjectType(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDirectedGraphWrap *wrapper = ObjectWrap::Unwrap<VtkDirectedGraphWrap>(info.Holder());
	vtkDirectedGraph *native = (vtkDirectedGraph *)wrapper->native.GetPointer();
	int r;
...
void VtkDirectedGraphWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDirectedGraphWrap *wrapper = ObjectWrap::Unwrap<VtkDirectedGraphWrap>(info.Holder());
	vtkDirectedGraph *native = (vtkDirectedGraph *)wrapper->native.GetPointer();
...
void VtkDirectedGraphWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDirectedGraphWrap *wrapper = ObjectWrap::Unwrap<VtkDirectedGraphWrap>(info.Holder());
	vtkDirectedGraph *native = (vtkDirectedGraph *)wrapper->native.GetPointer();
	vtkDirectedGraph * r;
...
void VtkDirectedGraphWrap::SafeDownCast(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDirectedGraphWrap *wrapper = ObjectWrap::Unwrap<VtkDirectedGraphWrap>(info.Holder());
	vtkDirectedGraph *native = (vtkDirectedGraph *)wrapper->native.GetPointer();
