...
#ifndef NATIVE_EXTENSION_VTK_VTKGESIGNAREADERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKGESIGNAREADERWRAP_H
...
class VtkGESignaReaderWrap : public VtkMedicalImageReader2Wrap
{
	public:
...
#ifdef VTK_NODE_PLUS_VTKGESIGNAREADERWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKGESIGNAREADERWRAP_CLASSDEF
#endif
};
