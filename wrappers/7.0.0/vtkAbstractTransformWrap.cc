...
void VtkAbstractTransformWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "TransformDoubleNormalAtPoint", TransformDoubleNormalAtPoint);
	Nan::SetPrototypeMethod(tpl, "transformDoubleNormalAtPoint", TransformDoubleNormalAtPoint);

	Nan::SetPrototypeMethod(tpl, "TransformDoublePoint", TransformDoublePoint);
	Nan::SetPrototypeMethod(tpl, "transformDoublePoint", TransformDoublePoint);

	Nan::SetPrototypeMethod(tpl, "TransformDoubleVectorAtPoint", TransformDoubleVectorAtPoint);
	Nan::SetPrototypeMethod(tpl, "transformDoubleVectorAtPoint", TransformDoubleVectorAtPoint);

	Nan::SetPrototypeMethod(tpl, "TransformFloatNormalAtPoint", TransformFloatNormalAtPoint);
	Nan::SetPrototypeMethod(tpl, "transformFloatNormalAtPoint", TransformFloatNormalAtPoint);

	Nan::SetPrototypeMethod(tpl, "TransformFloatPoint", TransformFloatPoint);
	Nan::SetPrototypeMethod(tpl, "transformFloatPoint", TransformFloatPoint);

	Nan::SetPrototypeMethod(tpl, "TransformFloatVectorAtPoint", TransformFloatVectorAtPoint);
	Nan::SetPrototypeMethod(tpl, "transformFloatVectorAtPoint", TransformFloatVectorAtPoint);
...
#ifdef VTK_NODE_PLUS_VTKABSTRACTTRANSFORMWRAP_INITPTPL
	VTK_NODE_PLUS_VTKABSTRACTTRANSFORMWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkAbstractTransformWrap::GetMTime(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractTransformWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractTransformWrap>(info.Holder());
	vtkAbstractTransform *native = (vtkAbstractTransform *)wrapper->native.GetPointer();
	unsigned int r;
...
void VtkAbstractTransformWrap::TransformDoubleNormalAtPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractTransformWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractTransformWrap>(info.Holder());
	vtkAbstractTransform *native = (vtkAbstractTransform *)wrapper->native.GetPointer();
	size_t i;
	if(info.Length() > 0 && info[0]->IsFloat64Array())
	{
		...
		if(info.Length() > 1 && info[1]->IsFloat64Array())
		{
			...
			r = native->TransformDoubleNormalAtPoint(
...
void VtkAbstractTransformWrap::TransformDoublePoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractTransformWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractTransformWrap>(info.Holder());
	vtkAbstractTransform *native = (vtkAbstractTransform *)wrapper->native.GetPointer();
	size_t i;
...
void VtkAbstractTransformWrap::TransformDoubleVectorAtPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractTransformWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractTransformWrap>(info.Holder());
	vtkAbstractTransform *native = (vtkAbstractTransform *)wrapper->native.GetPointer();
	size_t i;
	if(info.Length() > 0 && info[0]->IsFloat64Array())
	{
		...
		if(info.Length() > 1 && info[1]->IsFloat64Array())
		{
			...
			r = native->TransformDoubleVectorAtPoint(
				(double *)(a0->Buffer()->GetContents().Data()),
				(double *)(a1->Buffer()->GetContents().Data())
			);
			Local<v8::ArrayBuffer> ab = v8::ArrayBuffer::New(v8::Isolate::GetCurrent(), 3 * sizeof(double));
...
void VtkAbstractTransformWrap::TransformFloatNormalAtPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractTransformWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractTransformWrap>(info.Holder());
	vtkAbstractTransform *native = (vtkAbstractTransform *)wrapper->native.GetPointer();
	size_t i;
	if(info.Length() > 0 && info[0]->IsFloat32Array())
	{
		...
		if(info.Length() > 1 && info[1]->IsFloat32Array())
		{
			...
			r = native->TransformFloatNormalAtPoint(
...
void VtkAbstractTransformWrap::TransformFloatPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractTransformWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractTransformWrap>(info.Holder());
	vtkAbstractTransform *native = (vtkAbstractTransform *)wrapper->native.GetPointer();
	size_t i;
...
void VtkAbstractTransformWrap::TransformFloatVectorAtPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractTransformWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractTransformWrap>(info.Holder());
	vtkAbstractTransform *native = (vtkAbstractTransform *)wrapper->native.GetPointer();
	size_t i;
	if(info.Length() > 0 && info[0]->IsFloat32Array())
	{
		...
		if(info.Length() > 1 && info[1]->IsFloat32Array())
		{
			...
			r = native->TransformFloatVectorAtPoint(
				(float *)(a0->Buffer()->GetContents().Data()),
				(float *)(a1->Buffer()->GetContents().Data())
			);
			Local<v8::ArrayBuffer> ab = v8::ArrayBuffer::New(v8::Isolate::GetCurrent(), 3 * sizeof(float));
...
void VtkAbstractTransformWrap::TransformNormalAtPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	else if(info.Length() > 0 && info[0]->IsFloat64Array())
	{
		...
		if(info.Length() > 1 && info[1]->IsFloat64Array())
		{
			...
			r = native->TransformNormalAtPoint(
				(double *)(a0->Buffer()->GetContents().Data()),
				(double *)(a1->Buffer()->GetContents().Data())
			);
			Local<v8::ArrayBuffer> ab = v8::ArrayBuffer::New(v8::Isolate::GetCurrent(), 3 * sizeof(double));
...
void VtkAbstractTransformWrap::TransformVectorAtPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	else if(info.Length() > 0 && info[0]->IsFloat64Array())
	{
		...
		if(info.Length() > 1 && info[1]->IsFloat64Array())
		{
			...
			r = native->TransformVectorAtPoint(
				(double *)(a0->Buffer()->GetContents().Data()),
				(double *)(a1->Buffer()->GetContents().Data())
			);
			Local<v8::ArrayBuffer> ab = v8::ArrayBuffer::New(v8::Isolate::GetCurrent(), 3 * sizeof(double));
