...
void VtkSelectionNodeWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "ConvertAttributeTypeToSelectionField", ConvertAttributeTypeToSelectionField);
	Nan::SetPrototypeMethod(tpl, "convertAttributeTypeToSelectionField", ConvertAttributeTypeToSelectionField);

	Nan::SetPrototypeMethod(tpl, "ConvertSelectionFieldToAttributeType", ConvertSelectionFieldToAttributeType);
	Nan::SetPrototypeMethod(tpl, "convertSelectionFieldToAttributeType", ConvertSelectionFieldToAttributeType);
...
void VtkSelectionNodeWrap::ConvertAttributeTypeToSelectionField(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkSelectionNodeWrap *wrapper = ObjectWrap::Unwrap<VtkSelectionNodeWrap>(info.Holder());
	vtkSelectionNode *native = (vtkSelectionNode *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
	{
		...
		r = native->ConvertAttributeTypeToSelectionField(
			info[0]->Int32Value()
		);
...
void VtkSelectionNodeWrap::ConvertSelectionFieldToAttributeType(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkSelectionNodeWrap *wrapper = ObjectWrap::Unwrap<VtkSelectionNodeWrap>(info.Holder());
	vtkSelectionNode *native = (vtkSelectionNode *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
	{
		...
		r = native->ConvertSelectionFieldToAttributeType(
			info[0]->Int32Value()
		);
		info.GetReturnValue().Set(Nan::New(r));
		return;
