...
#ifdef VTK_NODE_PLUS_VTKWARPSCALARWRAP_INITPTPL
	VTK_NODE_PLUS_VTKWARPSCALARWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkWarpScalarWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkWarpScalarWrap* obj = new VtkWarpScalarWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkWarpScalarWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkWarpScalarWrap::ptpl)->GetFunction();
