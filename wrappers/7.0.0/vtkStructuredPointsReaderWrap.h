...
#ifndef NATIVE_EXTENSION_VTK_VTKSTRUCTUREDPOINTSREADERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKSTRUCTUREDPOINTSREADERWRAP_H
...
class VtkStructuredPointsReaderWrap : public VtkDataReaderWrap
{
	public:
...
#ifdef VTK_NODE_PLUS_VTKSTRUCTUREDPOINTSREADERWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKSTRUCTUREDPOINTSREADERWRAP_CLASSDEF
#endif
};
