...
#ifndef NATIVE_EXTENSION_VTK_VTKPOLYLINEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKPOLYLINEWRAP_H
...
class VtkPolyLineWrap : public VtkCellWrap
{
	...
	private:
		...
		static void GenerateSlidingNormals(const Nan::FunctionCallbackInfo<v8::Value>& info);
