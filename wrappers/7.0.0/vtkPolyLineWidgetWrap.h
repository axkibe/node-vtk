...
#ifndef NATIVE_EXTENSION_VTK_VTKPOLYLINEWIDGETWRAP_H
#define NATIVE_EXTENSION_VTK_VTKPOLYLINEWIDGETWRAP_H
...
class VtkPolyLineWidgetWrap : public VtkAbstractWidgetWrap
{
	public:
		...
		VtkPolyLineWidgetWrap(vtkSmartPointer<vtkPolyLineWidget>);
		VtkPolyLineWidgetWrap();
		~VtkPolyLineWidgetWrap( );
