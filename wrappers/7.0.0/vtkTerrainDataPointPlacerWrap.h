...
#ifndef NATIVE_EXTENSION_VTK_VTKTERRAINDATAPOINTPLACERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKTERRAINDATAPOINTPLACERWRAP_H
...
class VtkTerrainDataPointPlacerWrap : public VtkPointPlacerWrap
{
	public:
		...
		VtkTerrainDataPointPlacerWrap(vtkSmartPointer<vtkTerrainDataPointPlacer>);
		VtkTerrainDataPointPlacerWrap();
		~VtkTerrainDataPointPlacerWrap( );
