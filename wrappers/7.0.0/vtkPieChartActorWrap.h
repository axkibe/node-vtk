...
#ifndef NATIVE_EXTENSION_VTK_VTKPIECHARTACTORWRAP_H
#define NATIVE_EXTENSION_VTK_VTKPIECHARTACTORWRAP_H
...
class VtkPieChartActorWrap : public VtkActor2DWrap
{
	public:
	...
	private:
		...
		static void GetPieceLabel(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetPieceColor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetPieceLabel(const Nan::FunctionCallbackInfo<v8::Value>& info);
...
#ifdef VTK_NODE_PLUS_VTKPIECHARTACTORWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKPIECHARTACTORWRAP_CLASSDEF
#endif
};
