...
void VtkThreadedSynchronizedTemplates3DWrap::GetInputMemoryLimit(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkThreadedSynchronizedTemplates3DWrap *wrapper = ObjectWrap::Unwrap<VtkThreadedSynchronizedTemplates3DWrap>(info.Holder());
	vtkThreadedSynchronizedTemplates3D *native = (vtkThreadedSynchronizedTemplates3D *)wrapper->native.GetPointer();
	unsigned int r;
...
void VtkThreadedSynchronizedTemplates3DWrap::GetMTime(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkThreadedSynchronizedTemplates3DWrap *wrapper = ObjectWrap::Unwrap<VtkThreadedSynchronizedTemplates3DWrap>(info.Holder());
	vtkThreadedSynchronizedTemplates3D *native = (vtkThreadedSynchronizedTemplates3D *)wrapper->native.GetPointer();
	unsigned int r;
...
void VtkThreadedSynchronizedTemplates3DWrap::SetInputMemoryLimit(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkThreadedSynchronizedTemplates3DWrap *wrapper = ObjectWrap::Unwrap<VtkThreadedSynchronizedTemplates3DWrap>(info.Holder());
	vtkThreadedSynchronizedTemplates3D *native = (vtkThreadedSynchronizedTemplates3D *)wrapper->native.GetPointer();
