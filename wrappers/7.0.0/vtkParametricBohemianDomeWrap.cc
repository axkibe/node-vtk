...
void VtkParametricBohemianDomeWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricBohemianDomeWrap *wrapper = ObjectWrap::Unwrap<VtkParametricBohemianDomeWrap>(info.Holder());
	vtkParametricBohemianDome *native = (vtkParametricBohemianDome *)wrapper->native.GetPointer();
	char const * r;
...
void VtkParametricBohemianDomeWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricBohemianDomeWrap *wrapper = ObjectWrap::Unwrap<VtkParametricBohemianDomeWrap>(info.Holder());
	vtkParametricBohemianDome *native = (vtkParametricBohemianDome *)wrapper->native.GetPointer();
