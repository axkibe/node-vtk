...
#ifndef NATIVE_EXTENSION_VTK_VTKCONTOURFILTERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKCONTOURFILTERWRAP_H
...
class VtkContourFilterWrap : public VtkPolyDataAlgorithmWrap
{
	public:
		...
		VtkContourFilterWrap(vtkSmartPointer<vtkContourFilter>);
		VtkContourFilterWrap();
		~VtkContourFilterWrap( );
	...
	private:
		...
		static void SetScalarTree(const Nan::FunctionCallbackInfo<v8::Value>& info);
...
#ifdef VTK_NODE_PLUS_VTKCONTOURFILTERWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKCONTOURFILTERWRAP_CLASSDEF
#endif
};
