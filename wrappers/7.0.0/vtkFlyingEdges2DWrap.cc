...
void VtkFlyingEdges2DWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFlyingEdges2DWrap *wrapper = ObjectWrap::Unwrap<VtkFlyingEdges2DWrap>(info.Holder());
	vtkFlyingEdges2D *native = (vtkFlyingEdges2D *)wrapper->native.GetPointer();
	char const * r;
...
void VtkFlyingEdges2DWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFlyingEdges2DWrap *wrapper = ObjectWrap::Unwrap<VtkFlyingEdges2DWrap>(info.Holder());
	vtkFlyingEdges2D *native = (vtkFlyingEdges2D *)wrapper->native.GetPointer();
