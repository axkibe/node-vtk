...
void VtkContextAreaWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkContextAreaWrap *wrapper = ObjectWrap::Unwrap<VtkContextAreaWrap>(info.Holder());
	vtkContextArea *native = (vtkContextArea *)wrapper->native.GetPointer();
	char const * r;
...
void VtkContextAreaWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkContextAreaWrap *wrapper = ObjectWrap::Unwrap<VtkContextAreaWrap>(info.Holder());
	vtkContextArea *native = (vtkContextArea *)wrapper->native.GetPointer();
