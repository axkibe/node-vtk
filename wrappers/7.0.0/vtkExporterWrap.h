...
#ifndef NATIVE_EXTENSION_VTK_VTKEXPORTERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKEXPORTERWRAP_H
...
class VtkExporterWrap : public VtkObjectWrap
{
	public:
		...
		VtkExporterWrap(vtkSmartPointer<vtkExporter>);
		VtkExporterWrap();
		~VtkExporterWrap( );
...
#ifdef VTK_NODE_PLUS_VTKEXPORTERWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKEXPORTERWRAP_CLASSDEF
#endif
};
