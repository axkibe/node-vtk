...
void VtkCleanPolyDataWrap::OperateOnBounds(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCleanPolyDataWrap *wrapper = ObjectWrap::Unwrap<VtkCleanPolyDataWrap>(info.Holder());
	vtkCleanPolyData *native = (vtkCleanPolyData *)wrapper->native.GetPointer();
	size_t i;
...
void VtkCleanPolyDataWrap::OperateOnPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCleanPolyDataWrap *wrapper = ObjectWrap::Unwrap<VtkCleanPolyDataWrap>(info.Holder());
	vtkCleanPolyData *native = (vtkCleanPolyData *)wrapper->native.GetPointer();
	size_t i;
