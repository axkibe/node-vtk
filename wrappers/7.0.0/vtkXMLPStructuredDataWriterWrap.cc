...
{
	Nan::SetAccessor(exports, Nan::New("vtkXMLPStructuredDataWriter").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("XMLPStructuredDataWriter").ToLocalChecked(), ConstructorGetter);
}

void VtkXMLPStructuredDataWriterWrap::ConstructorGetter(
...
void VtkXMLPStructuredDataWriterWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKXMLPSTRUCTUREDDATAWRITERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKXMLPSTRUCTUREDDATAWRITERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
