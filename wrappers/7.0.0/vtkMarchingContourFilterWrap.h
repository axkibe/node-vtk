...
#ifndef NATIVE_EXTENSION_VTK_VTKMARCHINGCONTOURFILTERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKMARCHINGCONTOURFILTERWRAP_H
...
class VtkMarchingContourFilterWrap : public VtkPolyDataAlgorithmWrap
{
	public:
		...
		VtkMarchingContourFilterWrap(vtkSmartPointer<vtkMarchingContourFilter>);
		VtkMarchingContourFilterWrap();
		~VtkMarchingContourFilterWrap( );
