...
#ifndef NATIVE_EXTENSION_VTK_VTKTHREADEDSYNCHRONIZEDTEMPLATES3DWRAP_H
#define NATIVE_EXTENSION_VTK_VTKTHREADEDSYNCHRONIZEDTEMPLATES3DWRAP_H
...
class VtkThreadedSynchronizedTemplates3DWrap : public VtkMultiBlockDataSetAlgorithmWrap
{
	public:
		...
		VtkThreadedSynchronizedTemplates3DWrap(vtkSmartPointer<vtkThreadedSynchronizedTemplates3D>);
		VtkThreadedSynchronizedTemplates3DWrap();
		~VtkThreadedSynchronizedTemplates3DWrap( );
