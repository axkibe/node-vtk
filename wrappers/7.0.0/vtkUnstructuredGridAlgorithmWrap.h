...
#ifndef NATIVE_EXTENSION_VTK_VTKUNSTRUCTUREDGRIDALGORITHMWRAP_H
#define NATIVE_EXTENSION_VTK_VTKUNSTRUCTUREDGRIDALGORITHMWRAP_H
...
class VtkUnstructuredGridAlgorithmWrap : public VtkAlgorithmWrap
{
	public:
		...
		VtkUnstructuredGridAlgorithmWrap(vtkSmartPointer<vtkUnstructuredGridAlgorithm>);
		VtkUnstructuredGridAlgorithmWrap();
		~VtkUnstructuredGridAlgorithmWrap( );
