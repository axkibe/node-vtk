...
#ifndef NATIVE_EXTENSION_VTK_VTKSYNCHRONIZEDTEMPLATES3DWRAP_H
#define NATIVE_EXTENSION_VTK_VTKSYNCHRONIZEDTEMPLATES3DWRAP_H
...
class VtkSynchronizedTemplates3DWrap : public VtkPolyDataAlgorithmWrap
{
	public:
		...
		VtkSynchronizedTemplates3DWrap(vtkSmartPointer<vtkSynchronizedTemplates3D>);
		VtkSynchronizedTemplates3DWrap();
		~VtkSynchronizedTemplates3DWrap( );
