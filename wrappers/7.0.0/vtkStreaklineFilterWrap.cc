...
{
	Nan::SetAccessor(exports, Nan::New("vtkStreaklineFilter").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("StreaklineFilter").ToLocalChecked(), ConstructorGetter);
}

void VtkStreaklineFilterWrap::ConstructorGetter(
...
void VtkStreaklineFilterWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKSTREAKLINEFILTERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKSTREAKLINEFILTERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkStreaklineFilterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkStreaklineFilterWrap* obj = new VtkStreaklineFilterWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkStreaklineFilterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	VtkStreaklineFilterWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkStreaklineFilterWrap::ptpl)->GetFunction();
