...
Nan::Persistent<v8::FunctionTemplate> VtkClipDataSetWrap::ptpl;
...
{
	Nan::SetAccessor(exports, Nan::New("vtkClipDataSet").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("ClipDataSet").ToLocalChecked(), ConstructorGetter);
}

void VtkClipDataSetWrap::ConstructorGetter(
...
void VtkClipDataSetWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKCLIPDATASETWRAP_INITPTPL
	VTK_NODE_PLUS_VTKCLIPDATASETWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkClipDataSetWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkClipDataSetWrap* obj = new VtkClipDataSetWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkClipDataSetWrap::GetMTime(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkClipDataSetWrap *wrapper = ObjectWrap::Unwrap<VtkClipDataSetWrap>(info.Holder());
	vtkClipDataSet *native = (vtkClipDataSet *)wrapper->native.GetPointer();
	unsigned int r;
...
void VtkClipDataSetWrap::GetUseValueAsOffset(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkClipDataSetWrap *wrapper = ObjectWrap::Unwrap<VtkClipDataSetWrap>(info.Holder());
	vtkClipDataSet *native = (vtkClipDataSet *)wrapper->native.GetPointer();
	bool r;
...
void VtkClipDataSetWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	VtkClipDataSetWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkClipDataSetWrap::ptpl)->GetFunction();
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
...
void VtkClipDataSetWrap::SetUseValueAsOffset(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkClipDataSetWrap *wrapper = ObjectWrap::Unwrap<VtkClipDataSetWrap>(info.Holder());
	vtkClipDataSet *native = (vtkClipDataSet *)wrapper->native.GetPointer();
