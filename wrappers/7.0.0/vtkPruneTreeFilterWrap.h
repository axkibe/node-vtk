...
#ifndef NATIVE_EXTENSION_VTK_VTKPRUNETREEFILTERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKPRUNETREEFILTERWRAP_H
...
class VtkPruneTreeFilterWrap : public VtkTreeAlgorithmWrap
{
	...
	private:
		...
		static void GetShouldPruneParentVertex(const Nan::FunctionCallbackInfo<v8::Value>& info);
