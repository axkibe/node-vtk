...
#ifdef VTK_NODE_PLUS_VTKGENERALTRANSFORMWRAP_INITPTPL
	VTK_NODE_PLUS_VTKGENERALTRANSFORMWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkGeneralTransformWrap::GetMTime(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkGeneralTransformWrap *wrapper = ObjectWrap::Unwrap<VtkGeneralTransformWrap>(info.Holder());
	vtkGeneralTransform *native = (vtkGeneralTransform *)wrapper->native.GetPointer();
	unsigned int r;
