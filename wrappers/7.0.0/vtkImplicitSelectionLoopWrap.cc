...
VtkImplicitSelectionLoopWrap::VtkImplicitSelectionLoopWrap(vtkSmartPointer<vtkImplicitSelectionLoop> _native)
{ native = _native; }
...
void VtkImplicitSelectionLoopWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "AutomaticNormalGenerationOn", AutomaticNormalGenerationOn);
	Nan::SetPrototypeMethod(tpl, "automaticNormalGenerationOn", AutomaticNormalGenerationOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetAutomaticNormalGeneration", GetAutomaticNormalGeneration);
	Nan::SetPrototypeMethod(tpl, "getAutomaticNormalGeneration", GetAutomaticNormalGeneration);
	...
	Nan::SetPrototypeMethod(tpl, "SetAutomaticNormalGeneration", SetAutomaticNormalGeneration);
	Nan::SetPrototypeMethod(tpl, "setAutomaticNormalGeneration", SetAutomaticNormalGeneration);
...
void VtkImplicitSelectionLoopWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		vtkSmartPointer<vtkImplicitSelectionLoop> native = vtkSmartPointer<vtkImplicitSelectionLoop>::New();
		VtkImplicitSelectionLoopWrap* obj = new VtkImplicitSelectionLoopWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkImplicitSelectionLoopWrap::AutomaticNormalGenerationOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	native->AutomaticNormalGenerationOff();
}

void VtkImplicitSelectionLoopWrap::AutomaticNormalGenerationOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->AutomaticNormalGenerationOn();
}

void VtkImplicitSelectionLoopWrap::EvaluateFunction(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
	size_t i;
...
void VtkImplicitSelectionLoopWrap::EvaluateGradient(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
	size_t i;
...
void VtkImplicitSelectionLoopWrap::GetAutomaticNormalGeneration(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetAutomaticNormalGeneration();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkImplicitSelectionLoopWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
	char const * r;
...
void VtkImplicitSelectionLoopWrap::GetLoop(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
	vtkPoints * r;
...
void VtkImplicitSelectionLoopWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
...
void VtkImplicitSelectionLoopWrap::SafeDownCast(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
...
void VtkImplicitSelectionLoopWrap::SetAutomaticNormalGeneration(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
	{
		...
		native->SetAutomaticNormalGeneration(
			info[0]->Int32Value()
		);
		return;
	}
...
void VtkImplicitSelectionLoopWrap::SetLoop(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
...
void VtkImplicitSelectionLoopWrap::SetNormal(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitSelectionLoopWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitSelectionLoopWrap>(info.Holder());
	vtkImplicitSelectionLoop *native = (vtkImplicitSelectionLoop *)wrapper->native.GetPointer();
	size_t i;
