...
void VtkParametricKuenWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricKuenWrap *wrapper = ObjectWrap::Unwrap<VtkParametricKuenWrap>(info.Holder());
	vtkParametricKuen *native = (vtkParametricKuen *)wrapper->native.GetPointer();
	char const * r;
...
void VtkParametricKuenWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricKuenWrap *wrapper = ObjectWrap::Unwrap<VtkParametricKuenWrap>(info.Holder());
	vtkParametricKuen *native = (vtkParametricKuen *)wrapper->native.GetPointer();
