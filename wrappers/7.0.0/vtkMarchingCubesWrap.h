...
#ifndef NATIVE_EXTENSION_VTK_VTKMARCHINGCUBESWRAP_H
#define NATIVE_EXTENSION_VTK_VTKMARCHINGCUBESWRAP_H
...
class VtkMarchingCubesWrap : public VtkPolyDataAlgorithmWrap
{
	public:
		...
		VtkMarchingCubesWrap(vtkSmartPointer<vtkMarchingCubes>);
		VtkMarchingCubesWrap();
		~VtkMarchingCubesWrap( );
...
#ifdef VTK_NODE_PLUS_VTKMARCHINGCUBESWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKMARCHINGCUBESWRAP_CLASSDEF
#endif
};
