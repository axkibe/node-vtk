...
#ifndef NATIVE_EXTENSION_VTK_VTKOPENGLCAMERAWRAP_H
#define NATIVE_EXTENSION_VTK_VTKOPENGLCAMERAWRAP_H
...
class VtkOpenGLCameraWrap : public VtkCameraWrap
{
	...
	private:
		...
		static void GetKeyMatrices(const Nan::FunctionCallbackInfo<v8::Value>& info);
