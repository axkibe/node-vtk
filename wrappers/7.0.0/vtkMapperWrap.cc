...
void VtkMapperWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "ClearInvertibleColor", ClearInvertibleColor);
	Nan::SetPrototypeMethod(tpl, "clearInvertibleColor", ClearInvertibleColor);
...
void VtkMapperWrap::ClearInvertibleColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
		if(info.Length() != 0)
