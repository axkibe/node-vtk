...
#ifndef NATIVE_EXTENSION_VTK_VTKTRANSMITSTRUCTUREDDATAPIECEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKTRANSMITSTRUCTUREDDATAPIECEWRAP_H
...
class VtkTransmitStructuredDataPieceWrap : public VtkDataSetAlgorithmWrap
{
	public:
		...
		VtkTransmitStructuredDataPieceWrap(vtkSmartPointer<vtkTransmitStructuredDataPiece>);
		VtkTransmitStructuredDataPieceWrap();
		~VtkTransmitStructuredDataPieceWrap( );
