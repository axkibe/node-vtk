...
#ifdef VTK_NODE_PLUS_VTKPOINTSETALGORITHMWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPOINTSETALGORITHMWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPointSetAlgorithmWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPointSetAlgorithmWrap* obj = new VtkPointSetAlgorithmWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkPointSetAlgorithmWrap::AddInputData(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	else if(info.Length() > 0 && info[0]->IsInt32())
	{
		...
		else if(info.Length() > 1 && info[1]->IsObject() && (Nan::New(VtkPointSetWrap::ptpl))->HasInstance(info[1]))
		{
