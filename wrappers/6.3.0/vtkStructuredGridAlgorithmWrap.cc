...
#ifdef VTK_NODE_PLUS_VTKSTRUCTUREDGRIDALGORITHMWRAP_INITPTPL
	VTK_NODE_PLUS_VTKSTRUCTUREDGRIDALGORITHMWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkStructuredGridAlgorithmWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkStructuredGridAlgorithmWrap* obj = new VtkStructuredGridAlgorithmWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
