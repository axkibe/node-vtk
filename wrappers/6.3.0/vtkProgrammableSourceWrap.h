...
#ifndef NATIVE_EXTENSION_VTK_VTKPROGRAMMABLESOURCEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKPROGRAMMABLESOURCEWRAP_H
...
class VtkProgrammableSourceWrap : public VtkDataSetAlgorithmWrap
{
	public:
		...
		VtkProgrammableSourceWrap(vtkSmartPointer<vtkProgrammableSource>);
		VtkProgrammableSourceWrap();
		~VtkProgrammableSourceWrap( );
...
#ifdef VTK_NODE_PLUS_VTKPROGRAMMABLESOURCEWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKPROGRAMMABLESOURCEWRAP_CLASSDEF
#endif
};
