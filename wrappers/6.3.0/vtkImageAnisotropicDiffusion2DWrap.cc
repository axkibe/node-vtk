...
#ifdef VTK_NODE_PLUS_VTKIMAGEANISOTROPICDIFFUSION2DWRAP_INITPTPL
	VTK_NODE_PLUS_VTKIMAGEANISOTROPICDIFFUSION2DWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkImageAnisotropicDiffusion2DWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkImageAnisotropicDiffusion2DWrap* obj = new VtkImageAnisotropicDiffusion2DWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
