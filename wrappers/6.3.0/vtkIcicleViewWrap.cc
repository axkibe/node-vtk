...
void VtkIcicleViewWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkIcicleViewWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkIcicleViewWrap *wrapper = ObjectWrap::Unwrap<VtkIcicleViewWrap>(info.Holder());
	vtkIcicleView *native = (vtkIcicleView *)wrapper->native.GetPointer();
