...
#ifndef NATIVE_EXTENSION_VTK_VTKQUADRATICLINEARQUADWRAP_H
#define NATIVE_EXTENSION_VTK_VTKQUADRATICLINEARQUADWRAP_H
...
class VtkQuadraticLinearQuadWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkQuadraticLinearQuadWrap(vtkSmartPointer<vtkQuadraticLinearQuad>);
		VtkQuadraticLinearQuadWrap();
		~VtkQuadraticLinearQuadWrap( );
...
#ifdef VTK_NODE_PLUS_VTKQUADRATICLINEARQUADWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKQUADRATICLINEARQUADWRAP_CLASSDEF
#endif
};
