...
#ifndef NATIVE_EXTENSION_VTK_VTKCONSTRAINED2DLAYOUTSTRATEGYWRAP_H
#define NATIVE_EXTENSION_VTK_VTKCONSTRAINED2DLAYOUTSTRATEGYWRAP_H
...
class VtkConstrained2DLayoutStrategyWrap : public VtkGraphLayoutStrategyWrap
{
	public:
		...
		VtkConstrained2DLayoutStrategyWrap(vtkSmartPointer<vtkConstrained2DLayoutStrategy>);
