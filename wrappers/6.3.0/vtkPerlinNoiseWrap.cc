...
#ifdef VTK_NODE_PLUS_VTKPERLINNOISEWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPERLINNOISEWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPerlinNoiseWrap::EvaluateGradient(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPerlinNoiseWrap *wrapper = ObjectWrap::Unwrap<VtkPerlinNoiseWrap>(info.Holder());
	vtkPerlinNoise *native = (vtkPerlinNoise *)wrapper->native.GetPointer();
	size_t i;
