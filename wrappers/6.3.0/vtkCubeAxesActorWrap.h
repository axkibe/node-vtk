...
class VtkCubeAxesActorWrap : public VtkActorWrap
{
	...
	private:
		...
		static void CenterStickyAxesOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void CenterStickyAxesOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetCenterStickyAxes(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetCenterStickyAxes(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void StickyAxesOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void StickyAxesOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
