...
#ifdef VTK_NODE_PLUS_VTKLEVELIDSCALARSWRAP_INITPTPL
	VTK_NODE_PLUS_VTKLEVELIDSCALARSWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkLevelIdScalarsWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkLevelIdScalarsWrap* obj = new VtkLevelIdScalarsWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
