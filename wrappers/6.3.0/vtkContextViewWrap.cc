...
#ifdef VTK_NODE_PLUS_VTKCONTEXTVIEWWRAP_INITPTPL
	VTK_NODE_PLUS_VTKCONTEXTVIEWWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkContextViewWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkContextViewWrap* obj = new VtkContextViewWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkContextViewWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkContextViewWrap::ptpl)->GetFunction();
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
