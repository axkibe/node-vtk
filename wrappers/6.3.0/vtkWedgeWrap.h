...
#ifndef NATIVE_EXTENSION_VTK_VTKWEDGEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKWEDGEWRAP_H
...
class VtkWedgeWrap : public VtkCell3DWrap
{
	public:
...
#ifdef VTK_NODE_PLUS_VTKWEDGEWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKWEDGEWRAP_CLASSDEF
#endif
};
