...
#ifdef VTK_NODE_PLUS_VTKRUNGEKUTTA2WRAP_INITPTPL
	VTK_NODE_PLUS_VTKRUNGEKUTTA2WRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkRungeKutta2Wrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkRungeKutta2Wrap* obj = new VtkRungeKutta2Wrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkRungeKutta2Wrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkRungeKutta2Wrap::ptpl)->GetFunction();
