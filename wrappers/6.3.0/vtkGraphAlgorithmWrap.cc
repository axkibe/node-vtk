...
#ifdef VTK_NODE_PLUS_VTKGRAPHALGORITHMWRAP_INITPTPL
	VTK_NODE_PLUS_VTKGRAPHALGORITHMWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkGraphAlgorithmWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkGraphAlgorithmWrap* obj = new VtkGraphAlgorithmWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
