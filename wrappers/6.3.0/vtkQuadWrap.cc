...
#ifdef VTK_NODE_PLUS_VTKQUADWRAP_INITPTPL
	VTK_NODE_PLUS_VTKQUADWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkQuadWrap::CellBoundary(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkQuadWrap::GetParametricCenter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadWrap *wrapper = ObjectWrap::Unwrap<VtkQuadWrap>(info.Holder());
	vtkQuad *native = (vtkQuad *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadWrap::InterpolateDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadWrap *wrapper = ObjectWrap::Unwrap<VtkQuadWrap>(info.Holder());
	vtkQuad *native = (vtkQuad *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadWrap::InterpolateFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadWrap *wrapper = ObjectWrap::Unwrap<VtkQuadWrap>(info.Holder());
	vtkQuad *native = (vtkQuad *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadWrap::InterpolationDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadWrap *wrapper = ObjectWrap::Unwrap<VtkQuadWrap>(info.Holder());
	vtkQuad *native = (vtkQuad *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadWrap::InterpolationFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadWrap *wrapper = ObjectWrap::Unwrap<VtkQuadWrap>(info.Holder());
	vtkQuad *native = (vtkQuad *)wrapper->native.GetPointer();
	size_t i;
