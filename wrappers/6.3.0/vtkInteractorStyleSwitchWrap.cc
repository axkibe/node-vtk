...
void VtkInteractorStyleSwitchWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "SetCurrentStyleToMultiTouchCamera", SetCurrentStyleToMultiTouchCamera);
	Nan::SetPrototypeMethod(tpl, "setCurrentStyleToMultiTouchCamera", SetCurrentStyleToMultiTouchCamera);
...
void VtkInteractorStyleSwitchWrap::SetCurrentStyleToMultiTouchCamera(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkInteractorStyleSwitchWrap *wrapper = ObjectWrap::Unwrap<VtkInteractorStyleSwitchWrap>(info.Holder());
	vtkInteractorStyleSwitch *native = (vtkInteractorStyleSwitch *)wrapper->native.GetPointer();
	if(info.Length() != 0)
	...
	native->SetCurrentStyleToMultiTouchCamera();
}
