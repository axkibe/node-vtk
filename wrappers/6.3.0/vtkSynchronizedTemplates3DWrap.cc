...
#ifdef VTK_NODE_PLUS_VTKSYNCHRONIZEDTEMPLATES3DWRAP_INITPTPL
	VTK_NODE_PLUS_VTKSYNCHRONIZEDTEMPLATES3DWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkSynchronizedTemplates3DWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkSynchronizedTemplates3DWrap* obj = new VtkSynchronizedTemplates3DWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkSynchronizedTemplates3DWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkSynchronizedTemplates3DWrap::ptpl)->GetFunction();
