...
void VtkPolyLineRepresentationWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPolyLineRepresentationWrap* obj = new VtkPolyLineRepresentationWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkPolyLineRepresentationWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPolyLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkPolyLineRepresentationWrap>(info.Holder());
	vtkPolyLineRepresentation *native = (vtkPolyLineRepresentation *)wrapper->native.GetPointer();
	char const * r;
...
void VtkPolyLineRepresentationWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPolyLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkPolyLineRepresentationWrap>(info.Holder());
	vtkPolyLineRepresentation *native = (vtkPolyLineRepresentation *)wrapper->native.GetPointer();
