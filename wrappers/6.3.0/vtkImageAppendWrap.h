...
#ifndef NATIVE_EXTENSION_VTK_VTKIMAGEAPPENDWRAP_H
#define NATIVE_EXTENSION_VTK_VTKIMAGEAPPENDWRAP_H
...
class VtkImageAppendWrap : public VtkThreadedImageAlgorithmWrap
{
	...
	private:
		...
		static void GetAppendAxis(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetInput(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetNumberOfInputs(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetPreserveExtents(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void IsA(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void PreserveExtentsOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void PreserveExtentsOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
