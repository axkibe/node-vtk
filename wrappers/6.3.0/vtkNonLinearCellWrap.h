...
#ifndef NATIVE_EXTENSION_VTK_VTKNONLINEARCELLWRAP_H
#define NATIVE_EXTENSION_VTK_VTKNONLINEARCELLWRAP_H
...
class VtkNonLinearCellWrap : public VtkCellWrap
{
	public:
		...
		VtkNonLinearCellWrap(vtkSmartPointer<vtkNonLinearCell>);
		VtkNonLinearCellWrap();
		~VtkNonLinearCellWrap( );
