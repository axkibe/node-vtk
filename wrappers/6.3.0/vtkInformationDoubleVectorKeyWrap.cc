...
Nan::Persistent<v8::FunctionTemplate> VtkInformationDoubleVectorKeyWrap::ptpl;
...
#ifdef VTK_NODE_PLUS_VTKINFORMATIONDOUBLEVECTORKEYWRAP_INITPTPL
	VTK_NODE_PLUS_VTKINFORMATIONDOUBLEVECTORKEYWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkInformationDoubleVectorKeyWrap::MakeKey(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkInformationDoubleVectorKeyWrap *wrapper = ObjectWrap::Unwrap<VtkInformationDoubleVectorKeyWrap>(info.Holder());
	vtkInformationDoubleVectorKey *native = (vtkInformationDoubleVectorKey *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsString())
