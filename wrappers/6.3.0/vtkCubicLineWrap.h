...
#ifndef NATIVE_EXTENSION_VTK_VTKCUBICLINEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKCUBICLINEWRAP_H
...
class VtkCubicLineWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkCubicLineWrap(vtkSmartPointer<vtkCubicLine>);
		VtkCubicLineWrap();
		~VtkCubicLineWrap( );
...
#ifdef VTK_NODE_PLUS_VTKCUBICLINEWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKCUBICLINEWRAP_CLASSDEF
#endif
};
