...
#ifdef VTK_NODE_PLUS_VTKREPRESENTATIONPAINTERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKREPRESENTATIONPAINTERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkRepresentationPainterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkRepresentationPainterWrap* obj = new VtkRepresentationPainterWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
