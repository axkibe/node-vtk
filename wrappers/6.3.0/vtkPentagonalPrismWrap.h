...
#ifndef NATIVE_EXTENSION_VTK_VTKPENTAGONALPRISMWRAP_H
#define NATIVE_EXTENSION_VTK_VTKPENTAGONALPRISMWRAP_H
...
class VtkPentagonalPrismWrap : public VtkCell3DWrap
{
	public:
...
#ifdef VTK_NODE_PLUS_VTKPENTAGONALPRISMWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKPENTAGONALPRISMWRAP_CLASSDEF
#endif
};
