...
void VtkParametricConicSpiralWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkParametricConicSpiralWrap* obj = new VtkParametricConicSpiralWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkParametricConicSpiralWrap::Evaluate(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkParametricConicSpiralWrap::EvaluateScalar(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricConicSpiralWrap *wrapper = ObjectWrap::Unwrap<VtkParametricConicSpiralWrap>(info.Holder());
	vtkParametricConicSpiral *native = (vtkParametricConicSpiral *)wrapper->native.GetPointer();
	size_t i;
