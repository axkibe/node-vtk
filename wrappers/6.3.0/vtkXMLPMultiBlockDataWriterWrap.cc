...
void VtkXMLPMultiBlockDataWriterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkXMLPMultiBlockDataWriterWrap* obj = new VtkXMLPMultiBlockDataWriterWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkXMLPMultiBlockDataWriterWrap::GetNumberOfPieces(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXMLPMultiBlockDataWriterWrap *wrapper = ObjectWrap::Unwrap<VtkXMLPMultiBlockDataWriterWrap>(info.Holder());
	vtkXMLPMultiBlockDataWriter *native = (vtkXMLPMultiBlockDataWriter *)wrapper->native.GetPointer();
	int r;
...
void VtkXMLPMultiBlockDataWriterWrap::GetStartPiece(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXMLPMultiBlockDataWriterWrap *wrapper = ObjectWrap::Unwrap<VtkXMLPMultiBlockDataWriterWrap>(info.Holder());
	vtkXMLPMultiBlockDataWriter *native = (vtkXMLPMultiBlockDataWriter *)wrapper->native.GetPointer();
	int r;
...
void VtkXMLPMultiBlockDataWriterWrap::SetNumberOfPieces(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXMLPMultiBlockDataWriterWrap *wrapper = ObjectWrap::Unwrap<VtkXMLPMultiBlockDataWriterWrap>(info.Holder());
	vtkXMLPMultiBlockDataWriter *native = (vtkXMLPMultiBlockDataWriter *)wrapper->native.GetPointer();
...
void VtkXMLPMultiBlockDataWriterWrap::SetStartPiece(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXMLPMultiBlockDataWriterWrap *wrapper = ObjectWrap::Unwrap<VtkXMLPMultiBlockDataWriterWrap>(info.Holder());
	vtkXMLPMultiBlockDataWriter *native = (vtkXMLPMultiBlockDataWriter *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
