...
class VtkVolumePropertyWrap : public VtkObjectWrap
{
	...
	private:
		...
		static void GetTransferFunction2D(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetTransferFunctionMode(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetTransferFunctionModeMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetTransferFunctionModeMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetTransferFunction2D(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetTransferFunctionMode(const Nan::FunctionCallbackInfo<v8::Value>& info);
