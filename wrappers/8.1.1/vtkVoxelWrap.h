...
#ifndef NATIVE_EXTENSION_VTK_VTKVOXELWRAP_H
#define NATIVE_EXTENSION_VTK_VTKVOXELWRAP_H
...
class VtkVoxelWrap : public VtkCell3DWrap
{
	public:
...
#ifdef VTK_NODE_PLUS_VTKVOXELWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKVOXELWRAP_CLASSDEF
#endif
};
