...
class VtkCompositePolyDataMapper2Wrap : public VtkOpenGLPolyDataMapperWrap
{
	public:
	...
	private:
		...
		static void ColorMissingArraysWithNanColorOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void ColorMissingArraysWithNanColorOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetColorMissingArraysWithNanColor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetColorMissingArraysWithNanColor(const Nan::FunctionCallbackInfo<v8::Value>& info);
