...
#ifdef VTK_NODE_PLUS_VTKUNICODESTRINGARRAYWRAP_INITPTPL
	VTK_NODE_PLUS_VTKUNICODESTRINGARRAYWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkUnicodeStringArrayWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkUnicodeStringArrayWrap::ptpl)->GetFunction();
