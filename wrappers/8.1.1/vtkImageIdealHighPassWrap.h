...
#ifndef NATIVE_EXTENSION_VTK_VTKIMAGEIDEALHIGHPASSWRAP_H
#define NATIVE_EXTENSION_VTK_VTKIMAGEIDEALHIGHPASSWRAP_H
...
class VtkImageIdealHighPassWrap : public VtkThreadedImageAlgorithmWrap
{
	public:
...
#ifdef VTK_NODE_PLUS_VTKIMAGEIDEALHIGHPASSWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKIMAGEIDEALHIGHPASSWRAP_CLASSDEF
#endif
};
