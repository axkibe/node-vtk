...
class VtkGL2PSExporterWrap : public VtkExporterWrap
{
	...
	private:
		...
		static void GetBufferSize(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetLineWidthFactor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetPointSizeFactor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetBufferSize(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetLineWidthFactor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetPointSizeFactor(const Nan::FunctionCallbackInfo<v8::Value>& info);
