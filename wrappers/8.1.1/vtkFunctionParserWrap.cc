...
void VtkFunctionParserWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetScalarVariableIndex", GetScalarVariableIndex);
	Nan::SetPrototypeMethod(tpl, "getScalarVariableIndex", GetScalarVariableIndex);

	Nan::SetPrototypeMethod(tpl, "GetScalarVariableName", GetScalarVariableName);
	Nan::SetPrototypeMethod(tpl, "getScalarVariableName", GetScalarVariableName);

	Nan::SetPrototypeMethod(tpl, "GetScalarVariableNeeded", GetScalarVariableNeeded);
	Nan::SetPrototypeMethod(tpl, "getScalarVariableNeeded", GetScalarVariableNeeded);

	Nan::SetPrototypeMethod(tpl, "GetScalarVariableValue", GetScalarVariableValue);
	Nan::SetPrototypeMethod(tpl, "getScalarVariableValue", GetScalarVariableValue);

	Nan::SetPrototypeMethod(tpl, "GetVectorResult", GetVectorResult);
	Nan::SetPrototypeMethod(tpl, "getVectorResult", GetVectorResult);

	Nan::SetPrototypeMethod(tpl, "GetVectorVariableIndex", GetVectorVariableIndex);
	Nan::SetPrototypeMethod(tpl, "getVectorVariableIndex", GetVectorVariableIndex);

	Nan::SetPrototypeMethod(tpl, "GetVectorVariableName", GetVectorVariableName);
	Nan::SetPrototypeMethod(tpl, "getVectorVariableName", GetVectorVariableName);

	Nan::SetPrototypeMethod(tpl, "GetVectorVariableNeeded", GetVectorVariableNeeded);
	Nan::SetPrototypeMethod(tpl, "getVectorVariableNeeded", GetVectorVariableNeeded);

	Nan::SetPrototypeMethod(tpl, "GetVectorVariableValue", GetVectorVariableValue);
	Nan::SetPrototypeMethod(tpl, "getVectorVariableValue", GetVectorVariableValue);
...
void VtkFunctionParserWrap::GetScalarVariableIndex(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFunctionParserWrap *wrapper = ObjectWrap::Unwrap<VtkFunctionParserWrap>(info.Holder());
	vtkFunctionParser *native = (vtkFunctionParser *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsString())
	{
		...
		r = native->GetScalarVariableIndex(
			*a0
		);
		info.GetReturnValue().Set(Nan::New(r));
		return;
...
void VtkFunctionParserWrap::GetScalarVariableNeeded(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFunctionParserWrap *wrapper = ObjectWrap::Unwrap<VtkFunctionParserWrap>(info.Holder());
	vtkFunctionParser *native = (vtkFunctionParser *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsString())
	{
		...
		r = native->GetScalarVariableNeeded(
			*a0
		);
		info.GetReturnValue().Set(Nan::New(r));
		return;
...
void VtkFunctionParserWrap::GetVectorResult(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFunctionParserWrap *wrapper = ObjectWrap::Unwrap<VtkFunctionParserWrap>(info.Holder());
	vtkFunctionParser *native = (vtkFunctionParser *)wrapper->native.GetPointer();
	size_t i;
...
void VtkFunctionParserWrap::GetVectorVariableIndex(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFunctionParserWrap *wrapper = ObjectWrap::Unwrap<VtkFunctionParserWrap>(info.Holder());
	vtkFunctionParser *native = (vtkFunctionParser *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsString())
	{
		...
		r = native->GetVectorVariableIndex(
			*a0
		);
		info.GetReturnValue().Set(Nan::New(r));
		return;
...
void VtkFunctionParserWrap::GetVectorVariableNeeded(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFunctionParserWrap *wrapper = ObjectWrap::Unwrap<VtkFunctionParserWrap>(info.Holder());
	vtkFunctionParser *native = (vtkFunctionParser *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsString())
	{
		...
		r = native->GetVectorVariableNeeded(
			*a0
		);
		info.GetReturnValue().Set(Nan::New(r));
		return;
...
void VtkFunctionParserWrap::GetVectorVariableValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFunctionParserWrap *wrapper = ObjectWrap::Unwrap<VtkFunctionParserWrap>(info.Holder());
	vtkFunctionParser *native = (vtkFunctionParser *)wrapper->native.GetPointer();
	size_t i;
