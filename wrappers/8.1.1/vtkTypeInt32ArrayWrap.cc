...
#ifdef VTK_NODE_PLUS_VTKTYPEINT32ARRAYWRAP_INITPTPL
	VTK_NODE_PLUS_VTKTYPEINT32ARRAYWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkTypeInt32ArrayWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkTypeInt32ArrayWrap* obj = new VtkTypeInt32ArrayWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkTypeInt32ArrayWrap::FastDownCast(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
