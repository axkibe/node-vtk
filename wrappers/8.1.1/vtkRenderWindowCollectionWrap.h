...
#ifndef NATIVE_EXTENSION_VTK_VTKRENDERWINDOWCOLLECTIONWRAP_H
#define NATIVE_EXTENSION_VTK_VTKRENDERWINDOWCOLLECTIONWRAP_H
...
class VtkRenderWindowCollectionWrap : public VtkCollectionWrap
{
	public:
		...
		VtkRenderWindowCollectionWrap(vtkSmartPointer<vtkRenderWindowCollection>);
		VtkRenderWindowCollectionWrap();
		~VtkRenderWindowCollectionWrap( );
