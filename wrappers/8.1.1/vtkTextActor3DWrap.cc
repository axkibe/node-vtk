...
#ifdef VTK_NODE_PLUS_VTKTEXTACTOR3DWRAP_INITPTPL
	VTK_NODE_PLUS_VTKTEXTACTOR3DWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkTextActor3DWrap::ForceOpaqueOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkTextActor3DWrap::ForceOpaqueOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextActor3DWrap *wrapper = ObjectWrap::Unwrap<VtkTextActor3DWrap>(info.Holder());
	vtkTextActor3D *native = (vtkTextActor3D *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkTextActor3DWrap::ForceTranslucentOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextActor3DWrap *wrapper = ObjectWrap::Unwrap<VtkTextActor3DWrap>(info.Holder());
	vtkTextActor3D *native = (vtkTextActor3D *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkTextActor3DWrap::ForceTranslucentOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextActor3DWrap *wrapper = ObjectWrap::Unwrap<VtkTextActor3DWrap>(info.Holder());
	vtkTextActor3D *native = (vtkTextActor3D *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkTextActor3DWrap::GetForceOpaque(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextActor3DWrap *wrapper = ObjectWrap::Unwrap<VtkTextActor3DWrap>(info.Holder());
	vtkTextActor3D *native = (vtkTextActor3D *)wrapper->native.GetPointer();
	bool r;
...
void VtkTextActor3DWrap::GetForceTranslucent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextActor3DWrap *wrapper = ObjectWrap::Unwrap<VtkTextActor3DWrap>(info.Holder());
	vtkTextActor3D *native = (vtkTextActor3D *)wrapper->native.GetPointer();
	bool r;
...
void VtkTextActor3DWrap::SetForceOpaque(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextActor3DWrap *wrapper = ObjectWrap::Unwrap<VtkTextActor3DWrap>(info.Holder());
	vtkTextActor3D *native = (vtkTextActor3D *)wrapper->native.GetPointer();
...
void VtkTextActor3DWrap::SetForceTranslucent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextActor3DWrap *wrapper = ObjectWrap::Unwrap<VtkTextActor3DWrap>(info.Holder());
	vtkTextActor3D *native = (vtkTextActor3D *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
