...
#ifdef VTK_NODE_PLUS_VTKTEMPORALSNAPTOTIMESTEPWRAP_INITPTPL
	VTK_NODE_PLUS_VTKTEMPORALSNAPTOTIMESTEPWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkTemporalSnapToTimeStepWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkTemporalSnapToTimeStepWrap* obj = new VtkTemporalSnapToTimeStepWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
