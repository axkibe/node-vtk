...
#ifndef NATIVE_EXTENSION_VTK_VTKBIQUADRATICTRIANGLEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKBIQUADRATICTRIANGLEWRAP_H
...
class VtkBiQuadraticTriangleWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkBiQuadraticTriangleWrap(vtkSmartPointer<vtkBiQuadraticTriangle>);
		VtkBiQuadraticTriangleWrap();
		~VtkBiQuadraticTriangleWrap( );
...
#ifdef VTK_NODE_PLUS_VTKBIQUADRATICTRIANGLEWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKBIQUADRATICTRIANGLEWRAP_CLASSDEF
#endif
};
