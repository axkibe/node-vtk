...
void VtkViewportWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetBackgroundAlpha", GetBackgroundAlpha);
	Nan::SetPrototypeMethod(tpl, "getBackgroundAlpha", GetBackgroundAlpha);

	Nan::SetPrototypeMethod(tpl, "GetBackgroundAlphaMaxValue", GetBackgroundAlphaMaxValue);
	Nan::SetPrototypeMethod(tpl, "getBackgroundAlphaMaxValue", GetBackgroundAlphaMaxValue);

	Nan::SetPrototypeMethod(tpl, "GetBackgroundAlphaMinValue", GetBackgroundAlphaMinValue);
	Nan::SetPrototypeMethod(tpl, "getBackgroundAlphaMinValue", GetBackgroundAlphaMinValue);
	...
	Nan::SetPrototypeMethod(tpl, "SetBackgroundAlpha", SetBackgroundAlpha);
	Nan::SetPrototypeMethod(tpl, "setBackgroundAlpha", SetBackgroundAlpha);
...
void VtkViewportWrap::GetBackgroundAlpha(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkViewportWrap *wrapper = ObjectWrap::Unwrap<VtkViewportWrap>(info.Holder());
	vtkViewport *native = (vtkViewport *)wrapper->native.GetPointer();
	double r;
	...
	r = native->GetBackgroundAlpha();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkViewportWrap::GetBackgroundAlphaMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkViewportWrap *wrapper = ObjectWrap::Unwrap<VtkViewportWrap>(info.Holder());
	vtkViewport *native = (vtkViewport *)wrapper->native.GetPointer();
	double r;
	...
	r = native->GetBackgroundAlphaMaxValue();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkViewportWrap::GetBackgroundAlphaMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkViewportWrap *wrapper = ObjectWrap::Unwrap<VtkViewportWrap>(info.Holder());
	vtkViewport *native = (vtkViewport *)wrapper->native.GetPointer();
	double r;
	...
	r = native->GetBackgroundAlphaMinValue();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkViewportWrap::SetBackgroundAlpha(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkViewportWrap *wrapper = ObjectWrap::Unwrap<VtkViewportWrap>(info.Holder());
	vtkViewport *native = (vtkViewport *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
