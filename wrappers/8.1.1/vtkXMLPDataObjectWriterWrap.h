...
#ifndef NATIVE_EXTENSION_VTK_VTKXMLPDATAOBJECTWRITERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKXMLPDATAOBJECTWRITERWRAP_H
...
class VtkXMLPDataObjectWriterWrap : public VtkXMLWriterWrap
{
	public:
		...
		VtkXMLPDataObjectWriterWrap(vtkSmartPointer<vtkXMLPDataObjectWriter>);
		VtkXMLPDataObjectWriterWrap();
		~VtkXMLPDataObjectWriterWrap( );
	...
	private:
		...
		static void GetUseSubdirectory(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetUseSubdirectory(const Nan::FunctionCallbackInfo<v8::Value>& info);
...
#ifdef VTK_NODE_PLUS_VTKXMLPDATAOBJECTWRITERWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKXMLPDATAOBJECTWRITERWRAP_CLASSDEF
#endif
};
