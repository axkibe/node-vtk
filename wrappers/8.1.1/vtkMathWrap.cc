...
void VtkMathWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "PlaneIntersectsAABB", PlaneIntersectsAABB);
	Nan::SetPrototypeMethod(tpl, "planeIntersectsAABB", PlaneIntersectsAABB);
	...
	Nan::SetPrototypeMethod(tpl, "RotateVectorByNormalizedQuaternion", RotateVectorByNormalizedQuaternion);
	Nan::SetPrototypeMethod(tpl, "rotateVectorByNormalizedQuaternion", RotateVectorByNormalizedQuaternion);

	Nan::SetPrototypeMethod(tpl, "RotateVectorByWXYZ", RotateVectorByWXYZ);
	Nan::SetPrototypeMethod(tpl, "rotateVectorByWXYZ", RotateVectorByWXYZ);
...
void VtkMathWrap::PlaneIntersectsAABB(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMathWrap *wrapper = ObjectWrap::Unwrap<VtkMathWrap>(info.Holder());
	vtkMath *native = (vtkMath *)wrapper->native.GetPointer();
	size_t i;
...
void VtkMathWrap::RotateVectorByNormalizedQuaternion(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMathWrap *wrapper = ObjectWrap::Unwrap<VtkMathWrap>(info.Holder());
	vtkMath *native = (vtkMath *)wrapper->native.GetPointer();
	size_t i;
	if(info.Length() > 0 && info[0]->IsFloat64Array())
	{
		...
		if(info.Length() > 1 && info[1]->IsFloat64Array())
		{
			...
			if(info.Length() > 2 && info[2]->IsFloat64Array())
			{
				...
				native->RotateVectorByNormalizedQuaternion(
					(double *)(a0->Buffer()->GetContents().Data()),
					(double *)(a1->Buffer()->GetContents().Data()),
					(double *)(a2->Buffer()->GetContents().Data())
				);
...
void VtkMathWrap::RotateVectorByWXYZ(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMathWrap *wrapper = ObjectWrap::Unwrap<VtkMathWrap>(info.Holder());
	vtkMath *native = (vtkMath *)wrapper->native.GetPointer();
	size_t i;
