...
void VtkAlgorithmWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "UpdateExtent", UpdateExtent);
	Nan::SetPrototypeMethod(tpl, "updateExtent", UpdateExtent);
	...
	Nan::SetPrototypeMethod(tpl, "UpdatePiece", UpdatePiece);
	Nan::SetPrototypeMethod(tpl, "updatePiece", UpdatePiece);

	Nan::SetPrototypeMethod(tpl, "UpdateProgress", UpdateProgress);
	Nan::SetPrototypeMethod(tpl, "updateProgress", UpdateProgress);

	Nan::SetPrototypeMethod(tpl, "UpdateTimeStep", UpdateTimeStep);
	Nan::SetPrototypeMethod(tpl, "updateTimeStep", UpdateTimeStep);
...
void VtkAlgorithmWrap::UpdateExtent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAlgorithmWrap *wrapper = ObjectWrap::Unwrap<VtkAlgorithmWrap>(info.Holder());
	vtkAlgorithm *native = (vtkAlgorithm *)wrapper->native.GetPointer();
	size_t i;
...
void VtkAlgorithmWrap::UpdatePiece(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAlgorithmWrap *wrapper = ObjectWrap::Unwrap<VtkAlgorithmWrap>(info.Holder());
	vtkAlgorithm *native = (vtkAlgorithm *)wrapper->native.GetPointer();
	size_t i;
...
void VtkAlgorithmWrap::UpdateTimeStep(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAlgorithmWrap *wrapper = ObjectWrap::Unwrap<VtkAlgorithmWrap>(info.Holder());
	vtkAlgorithm *native = (vtkAlgorithm *)wrapper->native.GetPointer();
	size_t i;
