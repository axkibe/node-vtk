...
#ifdef VTK_NODE_PLUS_VTKPOLYDATAMAPPERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPOLYDATAMAPPERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPolyDataMapperWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPolyDataMapperWrap* obj = new VtkPolyDataMapperWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkPolyDataMapperWrap::GetBounds(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
