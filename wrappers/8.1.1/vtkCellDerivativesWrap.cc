...
void VtkCellDerivativesWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "SetTensorModeToComputeGreenLagrangeStrain", SetTensorModeToComputeGreenLagrangeStrain);
	Nan::SetPrototypeMethod(tpl, "setTensorModeToComputeGreenLagrangeStrain", SetTensorModeToComputeGreenLagrangeStrain);
...
void VtkCellDerivativesWrap::SetTensorModeToComputeGreenLagrangeStrain(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCellDerivativesWrap *wrapper = ObjectWrap::Unwrap<VtkCellDerivativesWrap>(info.Holder());
	vtkCellDerivatives *native = (vtkCellDerivatives *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetTensorModeToComputeGreenLagrangeStrain();
}
