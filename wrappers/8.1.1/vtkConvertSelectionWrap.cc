...
void VtkConvertSelectionWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "AllowMissingArrayOff", AllowMissingArrayOff);
	Nan::SetPrototypeMethod(tpl, "allowMissingArrayOff", AllowMissingArrayOff);

	Nan::SetPrototypeMethod(tpl, "AllowMissingArrayOn", AllowMissingArrayOn);
	Nan::SetPrototypeMethod(tpl, "allowMissingArrayOn", AllowMissingArrayOn);

	Nan::SetPrototypeMethod(tpl, "ClearArrayNames", ClearArrayNames);
	Nan::SetPrototypeMethod(tpl, "clearArrayNames", ClearArrayNames);

	Nan::SetPrototypeMethod(tpl, "GetAllowMissingArray", GetAllowMissingArray);
	Nan::SetPrototypeMethod(tpl, "getAllowMissingArray", GetAllowMissingArray);
	...
	Nan::SetPrototypeMethod(tpl, "SetAllowMissingArray", SetAllowMissingArray);
	Nan::SetPrototypeMethod(tpl, "setAllowMissingArray", SetAllowMissingArray);
...
void VtkConvertSelectionWrap::AllowMissingArrayOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkConvertSelectionWrap *wrapper = ObjectWrap::Unwrap<VtkConvertSelectionWrap>(info.Holder());
	vtkConvertSelection *native = (vtkConvertSelection *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->AllowMissingArrayOff();
}

void VtkConvertSelectionWrap::AllowMissingArrayOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkConvertSelectionWrap *wrapper = ObjectWrap::Unwrap<VtkConvertSelectionWrap>(info.Holder());
	vtkConvertSelection *native = (vtkConvertSelection *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkConvertSelectionWrap::GetAllowMissingArray(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkConvertSelectionWrap *wrapper = ObjectWrap::Unwrap<VtkConvertSelectionWrap>(info.Holder());
	vtkConvertSelection *native = (vtkConvertSelection *)wrapper->native.GetPointer();
	bool r;
...
void VtkConvertSelectionWrap::SetAllowMissingArray(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkConvertSelectionWrap *wrapper = ObjectWrap::Unwrap<VtkConvertSelectionWrap>(info.Holder());
	vtkConvertSelection *native = (vtkConvertSelection *)wrapper->native.GetPointer();
