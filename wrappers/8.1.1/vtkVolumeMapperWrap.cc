...
void VtkVolumeMapperWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetAverageIPScalarRange", GetAverageIPScalarRange);
	Nan::SetPrototypeMethod(tpl, "getAverageIPScalarRange", GetAverageIPScalarRange);
	...
	Nan::SetPrototypeMethod(tpl, "SetAverageIPScalarRange", SetAverageIPScalarRange);
	Nan::SetPrototypeMethod(tpl, "setAverageIPScalarRange", SetAverageIPScalarRange);
	...
	Nan::SetPrototypeMethod(tpl, "SetBlendModeToAverageIntensity", SetBlendModeToAverageIntensity);
	Nan::SetPrototypeMethod(tpl, "setBlendModeToAverageIntensity", SetBlendModeToAverageIntensity);
...
void VtkVolumeMapperWrap::GetAverageIPScalarRange(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkVolumeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkVolumeMapperWrap>(info.Holder());
	vtkVolumeMapper *native = (vtkVolumeMapper *)wrapper->native.GetPointer();
	double const * r;
	...
	r = native->GetAverageIPScalarRange();
...
void VtkVolumeMapperWrap::SetAverageIPScalarRange(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkVolumeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkVolumeMapperWrap>(info.Holder());
	vtkVolumeMapper *native = (vtkVolumeMapper *)wrapper->native.GetPointer();
	size_t i;
	if(info.Length() > 0 && info[0]->IsFloat64Array())
	{
		...
		native->SetAverageIPScalarRange(
...
void VtkVolumeMapperWrap::SetBlendModeToAverageIntensity(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkVolumeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkVolumeMapperWrap>(info.Holder());
	vtkVolumeMapper *native = (vtkVolumeMapper *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetBlendModeToAverageIntensity();
}
