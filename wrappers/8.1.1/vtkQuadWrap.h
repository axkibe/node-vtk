...
#ifndef NATIVE_EXTENSION_VTK_VTKQUADWRAP_H
#define NATIVE_EXTENSION_VTK_VTKQUADWRAP_H
...
class VtkQuadWrap : public VtkCellWrap
{
	public:
...
#ifdef VTK_NODE_PLUS_VTKQUADWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKQUADWRAP_CLASSDEF
#endif
};
