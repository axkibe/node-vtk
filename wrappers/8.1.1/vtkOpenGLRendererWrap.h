...
class VtkOpenGLRendererWrap : public VtkRendererWrap
{
	...
	private:
		...
		static void HaveApplePrimitiveIdBug(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void HaveAppleQueryAllocationBug(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void IsDualDepthPeelingSupported(const Nan::FunctionCallbackInfo<v8::Value>& info);
