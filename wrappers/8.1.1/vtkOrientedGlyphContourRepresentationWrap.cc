...
#ifdef VTK_NODE_PLUS_VTKORIENTEDGLYPHCONTOURREPRESENTATIONWRAP_INITPTPL
	VTK_NODE_PLUS_VTKORIENTEDGLYPHCONTOURREPRESENTATIONWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkOrientedGlyphContourRepresentationWrap::StartWidgetInteraction(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOrientedGlyphContourRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkOrientedGlyphContourRepresentationWrap>(info.Holder());
	vtkOrientedGlyphContourRepresentation *native = (vtkOrientedGlyphContourRepresentation *)wrapper->native.GetPointer();
	size_t i;
...
void VtkOrientedGlyphContourRepresentationWrap::WidgetInteraction(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOrientedGlyphContourRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkOrientedGlyphContourRepresentationWrap>(info.Holder());
	vtkOrientedGlyphContourRepresentation *native = (vtkOrientedGlyphContourRepresentation *)wrapper->native.GetPointer();
	size_t i;
