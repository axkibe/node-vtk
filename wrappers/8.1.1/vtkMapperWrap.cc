...
Nan::Persistent<v8::FunctionTemplate> VtkMapperWrap::ptpl;
...
{
	Nan::SetAccessor(exports, Nan::New("vtkMapper").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("Mapper").ToLocalChecked(), ConstructorGetter);
}

void VtkMapperWrap::ConstructorGetter(
...
void VtkMapperWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "CanUseTextureMapForColoring", CanUseTextureMapForColoring);
	Nan::SetPrototypeMethod(tpl, "canUseTextureMapForColoring", CanUseTextureMapForColoring);

	Nan::SetPrototypeMethod(tpl, "ClearColorArrays", ClearColorArrays);
	Nan::SetPrototypeMethod(tpl, "clearColorArrays", ClearColorArrays);
	...
	Nan::SetPrototypeMethod(tpl, "GetColorCoordinates", GetColorCoordinates);
	Nan::SetPrototypeMethod(tpl, "getColorCoordinates", GetColorCoordinates);

	Nan::SetPrototypeMethod(tpl, "GetColorMapColors", GetColorMapColors);
	Nan::SetPrototypeMethod(tpl, "getColorMapColors", GetColorMapColors);
	...
	Nan::SetPrototypeMethod(tpl, "GetColorTextureMap", GetColorTextureMap);
	Nan::SetPrototypeMethod(tpl, "getColorTextureMap", GetColorTextureMap);
	...
	Nan::SetPrototypeMethod(tpl, "SetRelativeCoincidentTopologyLineOffsetParameters", SetRelativeCoincidentTopologyLineOffsetParameters);
	Nan::SetPrototypeMethod(tpl, "setRelativeCoincidentTopologyLineOffsetParameters", SetRelativeCoincidentTopologyLineOffsetParameters);

	Nan::SetPrototypeMethod(tpl, "SetRelativeCoincidentTopologyPointOffsetParameter", SetRelativeCoincidentTopologyPointOffsetParameter);
	Nan::SetPrototypeMethod(tpl, "setRelativeCoincidentTopologyPointOffsetParameter", SetRelativeCoincidentTopologyPointOffsetParameter);

	Nan::SetPrototypeMethod(tpl, "SetRelativeCoincidentTopologyPolygonOffsetParameters", SetRelativeCoincidentTopologyPolygonOffsetParameters);
	Nan::SetPrototypeMethod(tpl, "setRelativeCoincidentTopologyPolygonOffsetParameters", SetRelativeCoincidentTopologyPolygonOffsetParameters);
	...
	Nan::SetPrototypeMethod(tpl, "SetResolveCoincidentTopologyLineOffsetParameters", SetResolveCoincidentTopologyLineOffsetParameters);
	Nan::SetPrototypeMethod(tpl, "setResolveCoincidentTopologyLineOffsetParameters", SetResolveCoincidentTopologyLineOffsetParameters);

	Nan::SetPrototypeMethod(tpl, "SetResolveCoincidentTopologyPointOffsetParameter", SetResolveCoincidentTopologyPointOffsetParameter);
	Nan::SetPrototypeMethod(tpl, "setResolveCoincidentTopologyPointOffsetParameter", SetResolveCoincidentTopologyPointOffsetParameter);
...
void VtkMapperWrap::CanUseTextureMapForColoring(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkDataObjectWrap::ptpl))->HasInstance(info[0]))
	{
		...
		r = native->CanUseTextureMapForColoring(
...
void VtkMapperWrap::ClearColorArrays(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkMapperWrap::GetBounds(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	size_t i;
...
void VtkMapperWrap::GetColorCoordinates(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	vtkFloatArray * r;
...
void VtkMapperWrap::GetColorMapColors(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
...
void VtkMapperWrap::GetColorTextureMap(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	vtkImageData * r;
...
void VtkMapperWrap::GetScalarRange(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	double const * r;
...
void VtkMapperWrap::SetArrayAccessMode(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
...
void VtkMapperWrap::SetArrayComponent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkMapperWrap::SetArrayId(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkMapperWrap::SetArrayName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsString())
...
void VtkMapperWrap::SetColorModeToDirectScalars(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkMapperWrap::SetRelativeCoincidentTopologyLineOffsetParameters(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
	{
		if(info.Length() > 1 && info[1]->IsNumber())
		{
			...
			native->SetRelativeCoincidentTopologyLineOffsetParameters(
				info[0]->NumberValue(),
				info[1]->NumberValue()
			);
			return;
...
void VtkMapperWrap::SetRelativeCoincidentTopologyPointOffsetParameter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
	{
		...
		native->SetRelativeCoincidentTopologyPointOffsetParameter(
			info[0]->NumberValue()
		);
		return;
	}
...
void VtkMapperWrap::SetRelativeCoincidentTopologyPolygonOffsetParameters(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
	{
		if(info.Length() > 1 && info[1]->IsNumber())
		{
			...
			native->SetRelativeCoincidentTopologyPolygonOffsetParameters(
				info[0]->NumberValue(),
				info[1]->NumberValue()
			);
			return;
...
void VtkMapperWrap::SetResolveCoincidentTopologyLineOffsetParameters(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
	{
		if(info.Length() > 1 && info[1]->IsNumber())
		{
			...
			native->SetResolveCoincidentTopologyLineOffsetParameters(
				info[0]->NumberValue(),
				info[1]->NumberValue()
			);
			return;
...
void VtkMapperWrap::SetResolveCoincidentTopologyPointOffsetParameter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMapperWrap>(info.Holder());
	vtkMapper *native = (vtkMapper *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
	{
		...
		native->SetResolveCoincidentTopologyPointOffsetParameter(
			info[0]->NumberValue()
		);
		return;
	}
