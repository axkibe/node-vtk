...
void VtkProbeFilterWrap::CategoricalDataOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkProbeFilterWrap::CategoricalDataOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkProbeFilterWrap *wrapper = ObjectWrap::Unwrap<VtkProbeFilterWrap>(info.Holder());
	vtkProbeFilter *native = (vtkProbeFilter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkProbeFilterWrap::GetCategoricalData(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkProbeFilterWrap *wrapper = ObjectWrap::Unwrap<VtkProbeFilterWrap>(info.Holder());
	vtkProbeFilter *native = (vtkProbeFilter *)wrapper->native.GetPointer();
	int r;
...
void VtkProbeFilterWrap::SetCategoricalData(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkProbeFilterWrap *wrapper = ObjectWrap::Unwrap<VtkProbeFilterWrap>(info.Holder());
	vtkProbeFilter *native = (vtkProbeFilter *)wrapper->native.GetPointer();
