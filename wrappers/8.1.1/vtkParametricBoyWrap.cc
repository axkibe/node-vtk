...
void VtkParametricBoyWrap::Evaluate(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkParametricBoyWrap::EvaluateScalar(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricBoyWrap *wrapper = ObjectWrap::Unwrap<VtkParametricBoyWrap>(info.Holder());
	vtkParametricBoy *native = (vtkParametricBoy *)wrapper->native.GetPointer();
	size_t i;
