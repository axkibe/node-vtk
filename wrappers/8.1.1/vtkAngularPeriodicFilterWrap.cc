...
void VtkAngularPeriodicFilterWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "ComputeRotationsOnTheFlyOff", ComputeRotationsOnTheFlyOff);
	Nan::SetPrototypeMethod(tpl, "computeRotationsOnTheFlyOff", ComputeRotationsOnTheFlyOff);

	Nan::SetPrototypeMethod(tpl, "ComputeRotationsOnTheFlyOn", ComputeRotationsOnTheFlyOn);
	Nan::SetPrototypeMethod(tpl, "computeRotationsOnTheFlyOn", ComputeRotationsOnTheFlyOn);

	Nan::SetPrototypeMethod(tpl, "GetCenter", GetCenter);
	Nan::SetPrototypeMethod(tpl, "getCenter", GetCenter);

	Nan::SetPrototypeMethod(tpl, "GetComputeRotationsOnTheFly", GetComputeRotationsOnTheFly);
	Nan::SetPrototypeMethod(tpl, "getComputeRotationsOnTheFly", GetComputeRotationsOnTheFly);
	...
	Nan::SetPrototypeMethod(tpl, "SetComputeRotationsOnTheFly", SetComputeRotationsOnTheFly);
	Nan::SetPrototypeMethod(tpl, "setComputeRotationsOnTheFly", SetComputeRotationsOnTheFly);
...
void VtkAngularPeriodicFilterWrap::ComputeRotationsOnTheFlyOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	native->ComputeRotationsOnTheFlyOff();
}

void VtkAngularPeriodicFilterWrap::ComputeRotationsOnTheFlyOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAngularPeriodicFilterWrap *wrapper = ObjectWrap::Unwrap<VtkAngularPeriodicFilterWrap>(info.Holder());
	vtkAngularPeriodicFilter *native = (vtkAngularPeriodicFilter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->ComputeRotationsOnTheFlyOn();
}
...
void VtkAngularPeriodicFilterWrap::GetComputeRotationsOnTheFly(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAngularPeriodicFilterWrap *wrapper = ObjectWrap::Unwrap<VtkAngularPeriodicFilterWrap>(info.Holder());
	vtkAngularPeriodicFilter *native = (vtkAngularPeriodicFilter *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetComputeRotationsOnTheFly();
...
void VtkAngularPeriodicFilterWrap::SetComputeRotationsOnTheFly(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAngularPeriodicFilterWrap *wrapper = ObjectWrap::Unwrap<VtkAngularPeriodicFilterWrap>(info.Holder());
	vtkAngularPeriodicFilter *native = (vtkAngularPeriodicFilter *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
	{
		...
		native->SetComputeRotationsOnTheFly(
			info[0]->BooleanValue()
		);
		return;
	}
