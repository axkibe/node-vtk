...
#ifdef VTK_NODE_PLUS_VTKIMAGESLICEMAPPERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKIMAGESLICEMAPPERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkImageSliceMapperWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkImageSliceMapperWrap* obj = new VtkImageSliceMapperWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
