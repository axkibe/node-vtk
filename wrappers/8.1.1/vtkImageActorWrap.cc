...
void VtkImageActorWrap::ForceOpaqueOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkImageActorWrap::ForceOpaqueOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImageActorWrap *wrapper = ObjectWrap::Unwrap<VtkImageActorWrap>(info.Holder());
	vtkImageActor *native = (vtkImageActor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkImageActorWrap::GetForceOpaque(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImageActorWrap *wrapper = ObjectWrap::Unwrap<VtkImageActorWrap>(info.Holder());
	vtkImageActor *native = (vtkImageActor *)wrapper->native.GetPointer();
	bool r;
...
void VtkImageActorWrap::SetForceOpaque(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImageActorWrap *wrapper = ObjectWrap::Unwrap<VtkImageActorWrap>(info.Holder());
	vtkImageActor *native = (vtkImageActor *)wrapper->native.GetPointer();
