...
#ifdef VTK_NODE_PLUS_VTKFIXEDPOINTVOLUMERAYCASTCOMPOSITESHADEHELPERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKFIXEDPOINTVOLUMERAYCASTCOMPOSITESHADEHELPERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
