...
void VtkDataSetAttributesWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetCopyAttribute", GetCopyAttribute);
	Nan::SetPrototypeMethod(tpl, "getCopyAttribute", GetCopyAttribute);
	...
	Nan::SetPrototypeMethod(tpl, "SetupForCopy", SetupForCopy);
	Nan::SetPrototypeMethod(tpl, "setupForCopy", SetupForCopy);
...
void VtkDataSetAttributesWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkDataSetAttributesWrap* obj = new VtkDataSetAttributesWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkDataSetAttributesWrap::GetCopyAttribute(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataSetAttributesWrap *wrapper = ObjectWrap::Unwrap<VtkDataSetAttributesWrap>(info.Holder());
	vtkDataSetAttributes *native = (vtkDataSetAttributes *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkDataSetAttributesWrap::SetupForCopy(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataSetAttributesWrap *wrapper = ObjectWrap::Unwrap<VtkDataSetAttributesWrap>(info.Holder());
	vtkDataSetAttributes *native = (vtkDataSetAttributes *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkDataSetAttributesWrap::ptpl))->HasInstance(info[0]))
