...
#ifndef NATIVE_EXTENSION_VTK_VTKLAGRANGECURVEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKLAGRANGECURVEWRAP_H
...
class VtkLagrangeCurveWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkLagrangeCurveWrap(vtkSmartPointer<vtkLagrangeCurve>);
		VtkLagrangeCurveWrap();
		~VtkLagrangeCurveWrap( );
...
#ifdef VTK_NODE_PLUS_VTKLAGRANGECURVEWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKLAGRANGECURVEWRAP_CLASSDEF
#endif
};
