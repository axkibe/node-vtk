...
void VtkPropertyWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetRenderLinesAsTubes", GetRenderLinesAsTubes);
	Nan::SetPrototypeMethod(tpl, "getRenderLinesAsTubes", GetRenderLinesAsTubes);

	Nan::SetPrototypeMethod(tpl, "GetRenderPointsAsSpheres", GetRenderPointsAsSpheres);
	Nan::SetPrototypeMethod(tpl, "getRenderPointsAsSpheres", GetRenderPointsAsSpheres);
	...
	Nan::SetPrototypeMethod(tpl, "GetVertexColor", GetVertexColor);
	Nan::SetPrototypeMethod(tpl, "getVertexColor", GetVertexColor);

	Nan::SetPrototypeMethod(tpl, "GetVertexVisibility", GetVertexVisibility);
	Nan::SetPrototypeMethod(tpl, "getVertexVisibility", GetVertexVisibility);
	...
	Nan::SetPrototypeMethod(tpl, "RenderLinesAsTubesOff", RenderLinesAsTubesOff);
	Nan::SetPrototypeMethod(tpl, "renderLinesAsTubesOff", RenderLinesAsTubesOff);

	Nan::SetPrototypeMethod(tpl, "RenderLinesAsTubesOn", RenderLinesAsTubesOn);
	Nan::SetPrototypeMethod(tpl, "renderLinesAsTubesOn", RenderLinesAsTubesOn);

	Nan::SetPrototypeMethod(tpl, "RenderPointsAsSpheresOff", RenderPointsAsSpheresOff);
	Nan::SetPrototypeMethod(tpl, "renderPointsAsSpheresOff", RenderPointsAsSpheresOff);

	Nan::SetPrototypeMethod(tpl, "RenderPointsAsSpheresOn", RenderPointsAsSpheresOn);
	Nan::SetPrototypeMethod(tpl, "renderPointsAsSpheresOn", RenderPointsAsSpheresOn);
	...
	Nan::SetPrototypeMethod(tpl, "SetMaterialName", SetMaterialName);
	Nan::SetPrototypeMethod(tpl, "setMaterialName", SetMaterialName);
	...
	Nan::SetPrototypeMethod(tpl, "SetRenderLinesAsTubes", SetRenderLinesAsTubes);
	Nan::SetPrototypeMethod(tpl, "setRenderLinesAsTubes", SetRenderLinesAsTubes);

	Nan::SetPrototypeMethod(tpl, "SetRenderPointsAsSpheres", SetRenderPointsAsSpheres);
	Nan::SetPrototypeMethod(tpl, "setRenderPointsAsSpheres", SetRenderPointsAsSpheres);
	...
	Nan::SetPrototypeMethod(tpl, "SetVertexColor", SetVertexColor);
	Nan::SetPrototypeMethod(tpl, "setVertexColor", SetVertexColor);

	Nan::SetPrototypeMethod(tpl, "SetVertexVisibility", SetVertexVisibility);
	Nan::SetPrototypeMethod(tpl, "setVertexVisibility", SetVertexVisibility);
	...
	Nan::SetPrototypeMethod(tpl, "VertexVisibilityOff", VertexVisibilityOff);
	Nan::SetPrototypeMethod(tpl, "vertexVisibilityOff", VertexVisibilityOff);

	Nan::SetPrototypeMethod(tpl, "VertexVisibilityOn", VertexVisibilityOn);
	Nan::SetPrototypeMethod(tpl, "vertexVisibilityOn", VertexVisibilityOn);
...
void VtkPropertyWrap::GetInformation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	vtkInformation * r;
...
void VtkPropertyWrap::GetRenderLinesAsTubes(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetRenderLinesAsTubes();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkPropertyWrap::GetRenderPointsAsSpheres(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetRenderPointsAsSpheres();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkPropertyWrap::GetVertexColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	double const * r;
...
void VtkPropertyWrap::GetVertexVisibility(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	int r;
...
void VtkPropertyWrap::RenderLinesAsTubesOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->RenderLinesAsTubesOff();
}

void VtkPropertyWrap::RenderLinesAsTubesOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->RenderLinesAsTubesOn();
}

void VtkPropertyWrap::RenderPointsAsSpheresOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->RenderPointsAsSpheresOff();
}

void VtkPropertyWrap::RenderPointsAsSpheresOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->RenderPointsAsSpheresOn();
}
...
void VtkPropertyWrap::SetInformation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
...
void VtkPropertyWrap::SetMaterialName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsString())
...
void VtkPropertyWrap::SetRenderLinesAsTubes(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
...
void VtkPropertyWrap::SetRenderPointsAsSpheres(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
	{
		...
		native->SetRenderPointsAsSpheres(
			info[0]->BooleanValue()
		);
		return;
	}
...
void VtkPropertyWrap::SetVertexColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	size_t i;
...
void VtkPropertyWrap::SetVertexVisibility(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkPropertyWrap::VertexVisibilityOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->VertexVisibilityOff();
}

void VtkPropertyWrap::VertexVisibilityOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkPropertyWrap>(info.Holder());
	vtkProperty *native = (vtkProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
