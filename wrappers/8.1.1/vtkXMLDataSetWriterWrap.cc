...
void VtkXMLDataSetWriterWrap::InitPtpl()
{
	...
	tpl->Inherit(Nan::New<FunctionTemplate>(VtkXMLDataObjectWriterWrap::ptpl));
...
#ifdef VTK_NODE_PLUS_VTKXMLDATASETWRITERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKXMLDATASETWRITERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
