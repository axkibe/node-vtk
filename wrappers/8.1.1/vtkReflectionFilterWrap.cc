...
void VtkReflectionFilterWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "FlipAllInputArraysOff", FlipAllInputArraysOff);
	Nan::SetPrototypeMethod(tpl, "flipAllInputArraysOff", FlipAllInputArraysOff);

	Nan::SetPrototypeMethod(tpl, "FlipAllInputArraysOn", FlipAllInputArraysOn);
	Nan::SetPrototypeMethod(tpl, "flipAllInputArraysOn", FlipAllInputArraysOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetFlipAllInputArrays", GetFlipAllInputArrays);
	Nan::SetPrototypeMethod(tpl, "getFlipAllInputArrays", GetFlipAllInputArrays);
	...
	Nan::SetPrototypeMethod(tpl, "SetFlipAllInputArrays", SetFlipAllInputArrays);
	Nan::SetPrototypeMethod(tpl, "setFlipAllInputArrays", SetFlipAllInputArrays);
...
void VtkReflectionFilterWrap::FlipAllInputArraysOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkReflectionFilterWrap *wrapper = ObjectWrap::Unwrap<VtkReflectionFilterWrap>(info.Holder());
	vtkReflectionFilter *native = (vtkReflectionFilter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->FlipAllInputArraysOff();
}

void VtkReflectionFilterWrap::FlipAllInputArraysOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkReflectionFilterWrap *wrapper = ObjectWrap::Unwrap<VtkReflectionFilterWrap>(info.Holder());
	vtkReflectionFilter *native = (vtkReflectionFilter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkReflectionFilterWrap::GetFlipAllInputArrays(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkReflectionFilterWrap *wrapper = ObjectWrap::Unwrap<VtkReflectionFilterWrap>(info.Holder());
	vtkReflectionFilter *native = (vtkReflectionFilter *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetFlipAllInputArrays();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkReflectionFilterWrap::SetFlipAllInputArrays(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkReflectionFilterWrap *wrapper = ObjectWrap::Unwrap<VtkReflectionFilterWrap>(info.Holder());
	vtkReflectionFilter *native = (vtkReflectionFilter *)wrapper->native.GetPointer();
