...
class VtkMoleculeWrap : public VtkUndirectedGraphWrap
{
	...
	private:
		...
		static void ClearLattice(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetLattice(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void HasLattice(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void Initialize(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SafeDownCast(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetElectronicData(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetLattice(const Nan::FunctionCallbackInfo<v8::Value>& info);
