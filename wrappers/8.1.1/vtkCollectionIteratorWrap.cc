...
#ifdef VTK_NODE_PLUS_VTKCOLLECTIONITERATORWRAP_INITPTPL
	VTK_NODE_PLUS_VTKCOLLECTIONITERATORWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkCollectionIteratorWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkCollectionIteratorWrap* obj = new VtkCollectionIteratorWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
