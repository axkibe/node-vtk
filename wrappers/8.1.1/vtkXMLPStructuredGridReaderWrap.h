...
#ifndef NATIVE_EXTENSION_VTK_VTKXMLPSTRUCTUREDGRIDREADERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKXMLPSTRUCTUREDGRIDREADERWRAP_H
...
class VtkXMLPStructuredGridReaderWrap : public VtkXMLPStructuredDataReaderWrap
{
	public:
		...
		VtkXMLPStructuredGridReaderWrap(vtkSmartPointer<vtkXMLPStructuredGridReader>);
		VtkXMLPStructuredGridReaderWrap();
		~VtkXMLPStructuredGridReaderWrap( );
