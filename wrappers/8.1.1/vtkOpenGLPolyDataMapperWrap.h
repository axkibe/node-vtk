...
class VtkOpenGLPolyDataMapperWrap : public VtkPolyDataMapperWrap
{
	...
	private:
		...
		static void ForceHaveAppleBugOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void ForceHaveAppleBugOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetHaveAppleBug(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetVBOs(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetVBOShiftScaleMethod(const Nan::FunctionCallbackInfo<v8::Value>& info);
