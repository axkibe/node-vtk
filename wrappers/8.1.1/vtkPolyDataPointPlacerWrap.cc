...
#ifdef VTK_NODE_PLUS_VTKPOLYDATAPOINTPLACERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPOLYDATAPOINTPLACERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPolyDataPointPlacerWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPolyDataPointPlacerWrap* obj = new VtkPolyDataPointPlacerWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkPolyDataPointPlacerWrap::ComputeWorldPosition(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPolyDataPointPlacerWrap *wrapper = ObjectWrap::Unwrap<VtkPolyDataPointPlacerWrap>(info.Holder());
	vtkPolyDataPointPlacer *native = (vtkPolyDataPointPlacer *)wrapper->native.GetPointer();
	size_t i;
...
void VtkPolyDataPointPlacerWrap::ValidateDisplayPosition(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPolyDataPointPlacerWrap *wrapper = ObjectWrap::Unwrap<VtkPolyDataPointPlacerWrap>(info.Holder());
	vtkPolyDataPointPlacer *native = (vtkPolyDataPointPlacer *)wrapper->native.GetPointer();
	size_t i;
...
void VtkPolyDataPointPlacerWrap::ValidateWorldPosition(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPolyDataPointPlacerWrap *wrapper = ObjectWrap::Unwrap<VtkPolyDataPointPlacerWrap>(info.Holder());
	vtkPolyDataPointPlacer *native = (vtkPolyDataPointPlacer *)wrapper->native.GetPointer();
	size_t i;
