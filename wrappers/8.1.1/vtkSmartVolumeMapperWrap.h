...
class VtkSmartVolumeMapperWrap : public VtkVolumeMapperWrap
{
	...
	private:
		...
		static void GetVectorComponentMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetVectorComponentMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetRequestedRenderModeToOSPRay(const Nan::FunctionCallbackInfo<v8::Value>& info);
