...
#ifdef VTK_NODE_PLUS_VTKPARTICLETRACERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPARTICLETRACERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkParticleTracerWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkParticleTracerWrap* obj = new VtkParticleTracerWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
