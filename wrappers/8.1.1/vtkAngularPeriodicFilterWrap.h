...
class VtkAngularPeriodicFilterWrap : public VtkPeriodicFilterWrap
{
	...
	private:
		...
		static void ComputeRotationsOnTheFlyOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void ComputeRotationsOnTheFlyOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetCenter(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetComputeRotationsOnTheFly(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetComputeRotationsOnTheFly(const Nan::FunctionCallbackInfo<v8::Value>& info);
