...
#ifdef VTK_NODE_PLUS_VTKCARDINALSPLINEWRAP_INITPTPL
	VTK_NODE_PLUS_VTKCARDINALSPLINEWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkCardinalSplineWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkCardinalSplineWrap* obj = new VtkCardinalSplineWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
