...
#ifndef NATIVE_EXTENSION_VTK_VTKBIOMTABLEREADERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKBIOMTABLEREADERWRAP_H
...
class VtkBiomTableReaderWrap : public VtkTableReaderWrap
{
	public:
		...
		VtkBiomTableReaderWrap(vtkSmartPointer<vtkBiomTableReader>);
		VtkBiomTableReaderWrap();
		~VtkBiomTableReaderWrap( );
