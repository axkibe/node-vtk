...
class VtkDataSetAttributesWrap : public VtkFieldDataWrap
{
	...
	private:
		...
		static void GetCopyAttribute(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GhostArrayName(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetupForCopy(const Nan::FunctionCallbackInfo<v8::Value>& info);
