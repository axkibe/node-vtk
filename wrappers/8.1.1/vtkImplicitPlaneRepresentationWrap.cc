...
void VtkImplicitPlaneRepresentationWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "CropPlaneToBoundingBoxOff", CropPlaneToBoundingBoxOff);
	Nan::SetPrototypeMethod(tpl, "cropPlaneToBoundingBoxOff", CropPlaneToBoundingBoxOff);

	Nan::SetPrototypeMethod(tpl, "CropPlaneToBoundingBoxOn", CropPlaneToBoundingBoxOn);
	Nan::SetPrototypeMethod(tpl, "cropPlaneToBoundingBoxOn", CropPlaneToBoundingBoxOn);

	Nan::SetPrototypeMethod(tpl, "DrawOutlineOff", DrawOutlineOff);
	Nan::SetPrototypeMethod(tpl, "drawOutlineOff", DrawOutlineOff);

	Nan::SetPrototypeMethod(tpl, "DrawOutlineOn", DrawOutlineOn);
	Nan::SetPrototypeMethod(tpl, "drawOutlineOn", DrawOutlineOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetCropPlaneToBoundingBox", GetCropPlaneToBoundingBox);
	Nan::SetPrototypeMethod(tpl, "getCropPlaneToBoundingBox", GetCropPlaneToBoundingBox);

	Nan::SetPrototypeMethod(tpl, "GetDrawOutline", GetDrawOutline);
	Nan::SetPrototypeMethod(tpl, "getDrawOutline", GetDrawOutline);
	...
	Nan::SetPrototypeMethod(tpl, "GetUnderlyingPlane", GetUnderlyingPlane);
	Nan::SetPrototypeMethod(tpl, "getUnderlyingPlane", GetUnderlyingPlane);
	...
	Nan::SetPrototypeMethod(tpl, "SetCropPlaneToBoundingBox", SetCropPlaneToBoundingBox);
	Nan::SetPrototypeMethod(tpl, "setCropPlaneToBoundingBox", SetCropPlaneToBoundingBox);

	Nan::SetPrototypeMethod(tpl, "SetDrawOutline", SetDrawOutline);
	Nan::SetPrototypeMethod(tpl, "setDrawOutline", SetDrawOutline);
...
void VtkImplicitPlaneRepresentationWrap::ConstrainToWidgetBoundsOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkImplicitPlaneRepresentationWrap::ConstrainToWidgetBoundsOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkImplicitPlaneRepresentationWrap::CropPlaneToBoundingBoxOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->CropPlaneToBoundingBoxOff();
}

void VtkImplicitPlaneRepresentationWrap::CropPlaneToBoundingBoxOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->CropPlaneToBoundingBoxOn();
}

void VtkImplicitPlaneRepresentationWrap::DrawOutlineOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->DrawOutlineOff();
}

void VtkImplicitPlaneRepresentationWrap::DrawOutlineOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkImplicitPlaneRepresentationWrap::GetConstrainToWidgetBounds(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
	int r;
...
void VtkImplicitPlaneRepresentationWrap::GetCropPlaneToBoundingBox(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetCropPlaneToBoundingBox();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkImplicitPlaneRepresentationWrap::GetDrawOutline(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
	int r;
...
void VtkImplicitPlaneRepresentationWrap::GetUnderlyingPlane(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
	vtkPlane * r;
...
void VtkImplicitPlaneRepresentationWrap::GetWidgetBounds(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
	double const * r;
...
void VtkImplicitPlaneRepresentationWrap::SetConstrainToWidgetBounds(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkImplicitPlaneRepresentationWrap::SetCropPlaneToBoundingBox(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
	{
		...
		native->SetCropPlaneToBoundingBox(
			info[0]->BooleanValue()
		);
		return;
	}
...
void VtkImplicitPlaneRepresentationWrap::SetDrawOutline(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkImplicitPlaneRepresentationWrap::SetWidgetBounds(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImplicitPlaneRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkImplicitPlaneRepresentationWrap>(info.Holder());
	vtkImplicitPlaneRepresentation *native = (vtkImplicitPlaneRepresentation *)wrapper->native.GetPointer();
	size_t i;
