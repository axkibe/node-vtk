...
#ifdef VTK_NODE_PLUS_VTKDIRECTEDACYCLICGRAPHWRAP_INITPTPL
	VTK_NODE_PLUS_VTKDIRECTEDACYCLICGRAPHWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkDirectedAcyclicGraphWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkDirectedAcyclicGraphWrap* obj = new VtkDirectedAcyclicGraphWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
