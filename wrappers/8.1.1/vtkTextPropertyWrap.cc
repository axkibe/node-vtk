...
void VtkTextPropertyWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "FrameOff", FrameOff);
	Nan::SetPrototypeMethod(tpl, "frameOff", FrameOff);

	Nan::SetPrototypeMethod(tpl, "FrameOn", FrameOn);
	Nan::SetPrototypeMethod(tpl, "frameOn", FrameOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetFrameColor", GetFrameColor);
	Nan::SetPrototypeMethod(tpl, "getFrameColor", GetFrameColor);

	Nan::SetPrototypeMethod(tpl, "GetFrameWidth", GetFrameWidth);
	Nan::SetPrototypeMethod(tpl, "getFrameWidth", GetFrameWidth);

	Nan::SetPrototypeMethod(tpl, "GetFrameWidthMaxValue", GetFrameWidthMaxValue);
	Nan::SetPrototypeMethod(tpl, "getFrameWidthMaxValue", GetFrameWidthMaxValue);

	Nan::SetPrototypeMethod(tpl, "GetFrameWidthMinValue", GetFrameWidthMinValue);
	Nan::SetPrototypeMethod(tpl, "getFrameWidthMinValue", GetFrameWidthMinValue);
	...
	Nan::SetPrototypeMethod(tpl, "GetUseTightBoundingBox", GetUseTightBoundingBox);
	Nan::SetPrototypeMethod(tpl, "getUseTightBoundingBox", GetUseTightBoundingBox);
	...
	Nan::SetPrototypeMethod(tpl, "SetFrame", SetFrame);
	Nan::SetPrototypeMethod(tpl, "setFrame", SetFrame);

	Nan::SetPrototypeMethod(tpl, "SetFrameColor", SetFrameColor);
	Nan::SetPrototypeMethod(tpl, "setFrameColor", SetFrameColor);

	Nan::SetPrototypeMethod(tpl, "SetFrameWidth", SetFrameWidth);
	Nan::SetPrototypeMethod(tpl, "setFrameWidth", SetFrameWidth);
	...
	Nan::SetPrototypeMethod(tpl, "SetUseTightBoundingBox", SetUseTightBoundingBox);
	Nan::SetPrototypeMethod(tpl, "setUseTightBoundingBox", SetUseTightBoundingBox);
	...
	Nan::SetPrototypeMethod(tpl, "UseTightBoundingBoxOff", UseTightBoundingBoxOff);
	Nan::SetPrototypeMethod(tpl, "useTightBoundingBoxOff", UseTightBoundingBoxOff);

	Nan::SetPrototypeMethod(tpl, "UseTightBoundingBoxOn", UseTightBoundingBoxOn);
	Nan::SetPrototypeMethod(tpl, "useTightBoundingBoxOn", UseTightBoundingBoxOn);
...
void VtkTextPropertyWrap::FrameOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkTextPropertyWrap::FrameOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkTextPropertyWrap::GetBackgroundOpacityMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	double r;
...
void VtkTextPropertyWrap::GetBackgroundOpacityMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	double r;
...
void VtkTextPropertyWrap::GetFrame(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	int r;
...
void VtkTextPropertyWrap::GetFrameColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	double const * r;
...
void VtkTextPropertyWrap::GetFrameWidth(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetFrameWidth();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkTextPropertyWrap::GetFrameWidthMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetFrameWidthMaxValue();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkTextPropertyWrap::GetFrameWidthMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetFrameWidthMinValue();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkTextPropertyWrap::GetOpacityMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	double r;
...
void VtkTextPropertyWrap::GetOpacityMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	double r;
...
void VtkTextPropertyWrap::GetUseTightBoundingBox(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetUseTightBoundingBox();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkTextPropertyWrap::SetBackgroundColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	size_t i;
...
void VtkTextPropertyWrap::SetBackgroundOpacity(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
...
void VtkTextPropertyWrap::SetFrame(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkTextPropertyWrap::SetFrameColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	size_t i;
...
void VtkTextPropertyWrap::SetFrameWidth(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkTextPropertyWrap::SetUseTightBoundingBox(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkTextPropertyWrap::UseTightBoundingBoxOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->UseTightBoundingBoxOff();
}

void VtkTextPropertyWrap::UseTightBoundingBoxOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTextPropertyWrap *wrapper = ObjectWrap::Unwrap<VtkTextPropertyWrap>(info.Holder());
	vtkTextProperty *native = (vtkTextProperty *)wrapper->native.GetPointer();
		if(info.Length() != 0)
