...
#ifndef NATIVE_EXTENSION_VTK_VTKLAGRANGEHEXAHEDRONWRAP_H
#define NATIVE_EXTENSION_VTK_VTKLAGRANGEHEXAHEDRONWRAP_H
...
class VtkLagrangeHexahedronWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkLagrangeHexahedronWrap(vtkSmartPointer<vtkLagrangeHexahedron>);
		VtkLagrangeHexahedronWrap();
		~VtkLagrangeHexahedronWrap( );
...
#ifdef VTK_NODE_PLUS_VTKLAGRANGEHEXAHEDRONWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKLAGRANGEHEXAHEDRONWRAP_CLASSDEF
#endif
};
