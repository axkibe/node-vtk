...
class VtkMathWrap : public VtkObjectWrap
{
	...
	private:
		...
		static void PlaneIntersectsAABB(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void RotateVectorByNormalizedQuaternion(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void RotateVectorByWXYZ(const Nan::FunctionCallbackInfo<v8::Value>& info);
