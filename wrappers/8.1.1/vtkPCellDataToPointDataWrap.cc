...
#ifdef VTK_NODE_PLUS_VTKPCELLDATATOPOINTDATAWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPCELLDATATOPOINTDATAWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPCellDataToPointDataWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPCellDataToPointDataWrap* obj = new VtkPCellDataToPointDataWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
