...
#ifdef VTK_NODE_PLUS_VTKQUADRATICWEDGEWRAP_INITPTPL
	VTK_NODE_PLUS_VTKQUADRATICWEDGEWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkQuadraticWedgeWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkQuadraticWedgeWrap* obj = new VtkQuadraticWedgeWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkQuadraticWedgeWrap::CellBoundary(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkQuadraticWedgeWrap::GetParametricCenter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticWedgeWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticWedgeWrap>(info.Holder());
	vtkQuadraticWedge *native = (vtkQuadraticWedge *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticWedgeWrap::InterpolateDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticWedgeWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticWedgeWrap>(info.Holder());
	vtkQuadraticWedge *native = (vtkQuadraticWedge *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticWedgeWrap::InterpolateFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticWedgeWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticWedgeWrap>(info.Holder());
	vtkQuadraticWedge *native = (vtkQuadraticWedge *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticWedgeWrap::InterpolationDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticWedgeWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticWedgeWrap>(info.Holder());
	vtkQuadraticWedge *native = (vtkQuadraticWedge *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticWedgeWrap::InterpolationFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticWedgeWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticWedgeWrap>(info.Holder());
	vtkQuadraticWedge *native = (vtkQuadraticWedge *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticWedgeWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkQuadraticWedgeWrap::ptpl)->GetFunction();
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
