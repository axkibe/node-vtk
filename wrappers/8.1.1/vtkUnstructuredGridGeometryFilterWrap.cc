...
void VtkUnstructuredGridGeometryFilterWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "DuplicateGhostCellClippingOff", DuplicateGhostCellClippingOff);
	Nan::SetPrototypeMethod(tpl, "duplicateGhostCellClippingOff", DuplicateGhostCellClippingOff);

	Nan::SetPrototypeMethod(tpl, "DuplicateGhostCellClippingOn", DuplicateGhostCellClippingOn);
	Nan::SetPrototypeMethod(tpl, "duplicateGhostCellClippingOn", DuplicateGhostCellClippingOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetDuplicateGhostCellClipping", GetDuplicateGhostCellClipping);
	Nan::SetPrototypeMethod(tpl, "getDuplicateGhostCellClipping", GetDuplicateGhostCellClipping);
	...
	Nan::SetPrototypeMethod(tpl, "SetDuplicateGhostCellClipping", SetDuplicateGhostCellClipping);
	Nan::SetPrototypeMethod(tpl, "setDuplicateGhostCellClipping", SetDuplicateGhostCellClipping);
...
void VtkUnstructuredGridGeometryFilterWrap::DuplicateGhostCellClippingOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkUnstructuredGridGeometryFilterWrap *wrapper = ObjectWrap::Unwrap<VtkUnstructuredGridGeometryFilterWrap>(info.Holder());
	vtkUnstructuredGridGeometryFilter *native = (vtkUnstructuredGridGeometryFilter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->DuplicateGhostCellClippingOff();
}

void VtkUnstructuredGridGeometryFilterWrap::DuplicateGhostCellClippingOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkUnstructuredGridGeometryFilterWrap *wrapper = ObjectWrap::Unwrap<VtkUnstructuredGridGeometryFilterWrap>(info.Holder());
	vtkUnstructuredGridGeometryFilter *native = (vtkUnstructuredGridGeometryFilter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->DuplicateGhostCellClippingOn();
}
...
void VtkUnstructuredGridGeometryFilterWrap::GetDuplicateGhostCellClipping(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkUnstructuredGridGeometryFilterWrap *wrapper = ObjectWrap::Unwrap<VtkUnstructuredGridGeometryFilterWrap>(info.Holder());
	vtkUnstructuredGridGeometryFilter *native = (vtkUnstructuredGridGeometryFilter *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetDuplicateGhostCellClipping();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkUnstructuredGridGeometryFilterWrap::SetDuplicateGhostCellClipping(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkUnstructuredGridGeometryFilterWrap *wrapper = ObjectWrap::Unwrap<VtkUnstructuredGridGeometryFilterWrap>(info.Holder());
	vtkUnstructuredGridGeometryFilter *native = (vtkUnstructuredGridGeometryFilter *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
	{
		...
		native->SetDuplicateGhostCellClipping(
			info[0]->Int32Value()
		);
		return;
	}
