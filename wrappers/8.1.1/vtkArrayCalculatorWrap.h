...
class VtkArrayCalculatorWrap : public VtkPassInputTypeAlgorithmWrap
{
	public:
	...
	private:
		...
		static void GetDataSetOutput(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetAttributeTypeToCellData(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetAttributeTypeToDefault(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetAttributeTypeToEdgeData(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetAttributeTypeToPointData(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetAttributeTypeToRowData(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetAttributeTypeToVertexData(const Nan::FunctionCallbackInfo<v8::Value>& info);
