...
void VtkRenderWindowInteractorWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "EndPanEvent", EndPanEvent);
	Nan::SetPrototypeMethod(tpl, "endPanEvent", EndPanEvent);

	Nan::SetPrototypeMethod(tpl, "EndPickCallback", EndPickCallback);
	Nan::SetPrototypeMethod(tpl, "endPickCallback", EndPickCallback);

	Nan::SetPrototypeMethod(tpl, "EndPinchEvent", EndPinchEvent);
	Nan::SetPrototypeMethod(tpl, "endPinchEvent", EndPinchEvent);

	Nan::SetPrototypeMethod(tpl, "EndRotateEvent", EndRotateEvent);
	Nan::SetPrototypeMethod(tpl, "endRotateEvent", EndRotateEvent);
	...
	Nan::SetPrototypeMethod(tpl, "FifthButtonPressEvent", FifthButtonPressEvent);
	Nan::SetPrototypeMethod(tpl, "fifthButtonPressEvent", FifthButtonPressEvent);

	Nan::SetPrototypeMethod(tpl, "FifthButtonReleaseEvent", FifthButtonReleaseEvent);
	Nan::SetPrototypeMethod(tpl, "fifthButtonReleaseEvent", FifthButtonReleaseEvent);
	...
	Nan::SetPrototypeMethod(tpl, "FourthButtonPressEvent", FourthButtonPressEvent);
	Nan::SetPrototypeMethod(tpl, "fourthButtonPressEvent", FourthButtonPressEvent);

	Nan::SetPrototypeMethod(tpl, "FourthButtonReleaseEvent", FourthButtonReleaseEvent);
	Nan::SetPrototypeMethod(tpl, "fourthButtonReleaseEvent", FourthButtonReleaseEvent);
	...
	Nan::SetPrototypeMethod(tpl, "GetLastRotation", GetLastRotation);
	Nan::SetPrototypeMethod(tpl, "getLastRotation", GetLastRotation);

	Nan::SetPrototypeMethod(tpl, "GetLastScale", GetLastScale);
	Nan::SetPrototypeMethod(tpl, "getLastScale", GetLastScale);

	Nan::SetPrototypeMethod(tpl, "GetLastTranslation", GetLastTranslation);
	Nan::SetPrototypeMethod(tpl, "getLastTranslation", GetLastTranslation);
	...
	Nan::SetPrototypeMethod(tpl, "GetPointersDownCount", GetPointersDownCount);
	Nan::SetPrototypeMethod(tpl, "getPointersDownCount", GetPointersDownCount);

	Nan::SetPrototypeMethod(tpl, "GetRecognizeGestures", GetRecognizeGestures);
	Nan::SetPrototypeMethod(tpl, "getRecognizeGestures", GetRecognizeGestures);
	...
	Nan::SetPrototypeMethod(tpl, "LongTapEvent", LongTapEvent);
	Nan::SetPrototypeMethod(tpl, "longTapEvent", LongTapEvent);
	...
	Nan::SetPrototypeMethod(tpl, "PanEvent", PanEvent);
	Nan::SetPrototypeMethod(tpl, "panEvent", PanEvent);

	Nan::SetPrototypeMethod(tpl, "PinchEvent", PinchEvent);
	Nan::SetPrototypeMethod(tpl, "pinchEvent", PinchEvent);
	...
	Nan::SetPrototypeMethod(tpl, "RotateEvent", RotateEvent);
	Nan::SetPrototypeMethod(tpl, "rotateEvent", RotateEvent);
	...
	Nan::SetPrototypeMethod(tpl, "SetRecognizeGestures", SetRecognizeGestures);
	Nan::SetPrototypeMethod(tpl, "setRecognizeGestures", SetRecognizeGestures);
	...
	Nan::SetPrototypeMethod(tpl, "StartPanEvent", StartPanEvent);
	Nan::SetPrototypeMethod(tpl, "startPanEvent", StartPanEvent);

	Nan::SetPrototypeMethod(tpl, "StartPickCallback", StartPickCallback);
	Nan::SetPrototypeMethod(tpl, "startPickCallback", StartPickCallback);

	Nan::SetPrototypeMethod(tpl, "StartPinchEvent", StartPinchEvent);
	Nan::SetPrototypeMethod(tpl, "startPinchEvent", StartPinchEvent);

	Nan::SetPrototypeMethod(tpl, "StartRotateEvent", StartRotateEvent);
	Nan::SetPrototypeMethod(tpl, "startRotateEvent", StartRotateEvent);

	Nan::SetPrototypeMethod(tpl, "SwipeEvent", SwipeEvent);
	Nan::SetPrototypeMethod(tpl, "swipeEvent", SwipeEvent);

	Nan::SetPrototypeMethod(tpl, "TapEvent", TapEvent);
	Nan::SetPrototypeMethod(tpl, "tapEvent", TapEvent);
...
void VtkRenderWindowInteractorWrap::EndPanEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkRenderWindowInteractorWrap::EndPinchEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->EndPinchEvent();
}

void VtkRenderWindowInteractorWrap::EndRotateEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkRenderWindowInteractorWrap::FifthButtonPressEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->FifthButtonPressEvent();
}

void VtkRenderWindowInteractorWrap::FifthButtonReleaseEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->FifthButtonReleaseEvent();
}
...
void VtkRenderWindowInteractorWrap::FourthButtonPressEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->FourthButtonPressEvent();
}

void VtkRenderWindowInteractorWrap::FourthButtonReleaseEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->FourthButtonReleaseEvent();
}
...
void VtkRenderWindowInteractorWrap::GetLastRotation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	double r;
	...
	r = native->GetLastRotation();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkRenderWindowInteractorWrap::GetLastScale(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	double r;
	...
	r = native->GetLastScale();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkRenderWindowInteractorWrap::GetLastTranslation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	double const * r;
...
void VtkRenderWindowInteractorWrap::GetPointersDownCount(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetPointersDownCount();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkRenderWindowInteractorWrap::GetRecognizeGestures(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	bool r;
...
void VtkRenderWindowInteractorWrap::GetRotation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	double r;
...
void VtkRenderWindowInteractorWrap::GetScale(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	double r;
...
void VtkRenderWindowInteractorWrap::GetTranslation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	double const * r;
...
void VtkRenderWindowInteractorWrap::LongTapEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkRenderWindowInteractorWrap::PanEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkRenderWindowInteractorWrap::PinchEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkRenderWindowInteractorWrap::RotateEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkRenderWindowInteractorWrap::SetRecognizeGestures(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
...
void VtkRenderWindowInteractorWrap::SetRotation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
...
void VtkRenderWindowInteractorWrap::SetScale(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
...
void VtkRenderWindowInteractorWrap::SetTranslation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
	size_t i;
...
void VtkRenderWindowInteractorWrap::StartPanEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkRenderWindowInteractorWrap::StartPinchEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->StartPinchEvent();
}

void VtkRenderWindowInteractorWrap::StartRotateEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->StartRotateEvent();
}

void VtkRenderWindowInteractorWrap::SwipeEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkRenderWindowInteractorWrap::TapEvent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowInteractorWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowInteractorWrap>(info.Holder());
	vtkRenderWindowInteractor *native = (vtkRenderWindowInteractor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
