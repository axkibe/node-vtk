...
{
	Nan::SetAccessor(exports, Nan::New("vtkDataSetCellIterator").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("DataSetCellIterator").ToLocalChecked(), ConstructorGetter);
}

void VtkDataSetCellIteratorWrap::ConstructorGetter(
...
void VtkDataSetCellIteratorWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKDATASETCELLITERATORWRAP_INITPTPL
	VTK_NODE_PLUS_VTKDATASETCELLITERATORWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkDataSetCellIteratorWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	VtkDataSetCellIteratorWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkDataSetCellIteratorWrap::ptpl)->GetFunction();
