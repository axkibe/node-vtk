...
#ifdef VTK_NODE_PLUS_VTKTREELEVELSFILTERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKTREELEVELSFILTERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkTreeLevelsFilterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkTreeLevelsFilterWrap* obj = new VtkTreeLevelsFilterWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
