...
#ifdef VTK_NODE_PLUS_VTKABSTRACTPICKERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKABSTRACTPICKERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkAbstractPickerWrap::Pick3DPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractPickerWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractPickerWrap>(info.Holder());
	vtkAbstractPicker *native = (vtkAbstractPicker *)wrapper->native.GetPointer();
	size_t i;
...
void VtkAbstractPickerWrap::Pick3DRay(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractPickerWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractPickerWrap>(info.Holder());
	vtkAbstractPicker *native = (vtkAbstractPicker *)wrapper->native.GetPointer();
	size_t i;
