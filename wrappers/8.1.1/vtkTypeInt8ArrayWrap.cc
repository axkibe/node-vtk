...
#ifdef VTK_NODE_PLUS_VTKTYPEINT8ARRAYWRAP_INITPTPL
	VTK_NODE_PLUS_VTKTYPEINT8ARRAYWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkTypeInt8ArrayWrap::FastDownCast(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
