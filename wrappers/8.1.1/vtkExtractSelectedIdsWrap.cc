...
{
	Nan::SetAccessor(exports, Nan::New("vtkExtractSelectedIds").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("ExtractSelectedIds").ToLocalChecked(), ConstructorGetter);
}

void VtkExtractSelectedIdsWrap::ConstructorGetter(
...
void VtkExtractSelectedIdsWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKEXTRACTSELECTEDIDSWRAP_INITPTPL
	VTK_NODE_PLUS_VTKEXTRACTSELECTEDIDSWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkExtractSelectedIdsWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkExtractSelectedIdsWrap* obj = new VtkExtractSelectedIdsWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkExtractSelectedIdsWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	VtkExtractSelectedIdsWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkExtractSelectedIdsWrap::ptpl)->GetFunction();
