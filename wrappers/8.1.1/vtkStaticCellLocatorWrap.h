...
#ifndef NATIVE_EXTENSION_VTK_VTKSTATICCELLLOCATORWRAP_H
#define NATIVE_EXTENSION_VTK_VTKSTATICCELLLOCATORWRAP_H
...
class VtkStaticCellLocatorWrap : public VtkAbstractCellLocatorWrap
{
	public:
		...
		VtkStaticCellLocatorWrap(vtkSmartPointer<vtkStaticCellLocator>);
		VtkStaticCellLocatorWrap();
		~VtkStaticCellLocatorWrap( );
...
#ifdef VTK_NODE_PLUS_VTKSTATICCELLLOCATORWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKSTATICCELLLOCATORWRAP_CLASSDEF
#endif
};
