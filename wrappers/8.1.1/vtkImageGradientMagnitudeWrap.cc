...
#ifdef VTK_NODE_PLUS_VTKIMAGEGRADIENTMAGNITUDEWRAP_INITPTPL
	VTK_NODE_PLUS_VTKIMAGEGRADIENTMAGNITUDEWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkImageGradientMagnitudeWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkImageGradientMagnitudeWrap* obj = new VtkImageGradientMagnitudeWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
