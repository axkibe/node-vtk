...
void VtkGenericCellWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetRepresentativeCell", GetRepresentativeCell);
	Nan::SetPrototypeMethod(tpl, "getRepresentativeCell", GetRepresentativeCell);
	...
	Nan::SetPrototypeMethod(tpl, "SetCellTypeToLagrangeCurve", SetCellTypeToLagrangeCurve);
	Nan::SetPrototypeMethod(tpl, "setCellTypeToLagrangeCurve", SetCellTypeToLagrangeCurve);

	Nan::SetPrototypeMethod(tpl, "SetCellTypeToLagrangeHexahedron", SetCellTypeToLagrangeHexahedron);
	Nan::SetPrototypeMethod(tpl, "setCellTypeToLagrangeHexahedron", SetCellTypeToLagrangeHexahedron);

	Nan::SetPrototypeMethod(tpl, "SetCellTypeToLagrangeQuadrilateral", SetCellTypeToLagrangeQuadrilateral);
	Nan::SetPrototypeMethod(tpl, "setCellTypeToLagrangeQuadrilateral", SetCellTypeToLagrangeQuadrilateral);

	Nan::SetPrototypeMethod(tpl, "SetCellTypeToLagrangeTetra", SetCellTypeToLagrangeTetra);
	Nan::SetPrototypeMethod(tpl, "setCellTypeToLagrangeTetra", SetCellTypeToLagrangeTetra);

	Nan::SetPrototypeMethod(tpl, "SetCellTypeToLagrangeTriangle", SetCellTypeToLagrangeTriangle);
	Nan::SetPrototypeMethod(tpl, "setCellTypeToLagrangeTriangle", SetCellTypeToLagrangeTriangle);

	Nan::SetPrototypeMethod(tpl, "SetCellTypeToLagrangeWedge", SetCellTypeToLagrangeWedge);
	Nan::SetPrototypeMethod(tpl, "setCellTypeToLagrangeWedge", SetCellTypeToLagrangeWedge);
...
void VtkGenericCellWrap::GetRepresentativeCell(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkGenericCellWrap *wrapper = ObjectWrap::Unwrap<VtkGenericCellWrap>(info.Holder());
	vtkGenericCell *native = (vtkGenericCell *)wrapper->native.GetPointer();
	vtkCell * r;
	...
	r = native->GetRepresentativeCell();
	VtkCellWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
...
void VtkGenericCellWrap::SetCellTypeToLagrangeCurve(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkGenericCellWrap *wrapper = ObjectWrap::Unwrap<VtkGenericCellWrap>(info.Holder());
	vtkGenericCell *native = (vtkGenericCell *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetCellTypeToLagrangeCurve();
}

void VtkGenericCellWrap::SetCellTypeToLagrangeHexahedron(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkGenericCellWrap *wrapper = ObjectWrap::Unwrap<VtkGenericCellWrap>(info.Holder());
	vtkGenericCell *native = (vtkGenericCell *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetCellTypeToLagrangeHexahedron();
}

void VtkGenericCellWrap::SetCellTypeToLagrangeQuadrilateral(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkGenericCellWrap *wrapper = ObjectWrap::Unwrap<VtkGenericCellWrap>(info.Holder());
	vtkGenericCell *native = (vtkGenericCell *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetCellTypeToLagrangeQuadrilateral();
}

void VtkGenericCellWrap::SetCellTypeToLagrangeTetra(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkGenericCellWrap *wrapper = ObjectWrap::Unwrap<VtkGenericCellWrap>(info.Holder());
	vtkGenericCell *native = (vtkGenericCell *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetCellTypeToLagrangeTetra();
}

void VtkGenericCellWrap::SetCellTypeToLagrangeTriangle(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkGenericCellWrap *wrapper = ObjectWrap::Unwrap<VtkGenericCellWrap>(info.Holder());
	vtkGenericCell *native = (vtkGenericCell *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetCellTypeToLagrangeTriangle();
}

void VtkGenericCellWrap::SetCellTypeToLagrangeWedge(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkGenericCellWrap *wrapper = ObjectWrap::Unwrap<VtkGenericCellWrap>(info.Holder());
	vtkGenericCell *native = (vtkGenericCell *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetCellTypeToLagrangeWedge();
}
