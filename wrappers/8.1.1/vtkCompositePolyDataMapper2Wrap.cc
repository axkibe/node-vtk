...
void VtkCompositePolyDataMapper2Wrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "ColorMissingArraysWithNanColorOff", ColorMissingArraysWithNanColorOff);
	Nan::SetPrototypeMethod(tpl, "colorMissingArraysWithNanColorOff", ColorMissingArraysWithNanColorOff);

	Nan::SetPrototypeMethod(tpl, "ColorMissingArraysWithNanColorOn", ColorMissingArraysWithNanColorOn);
	Nan::SetPrototypeMethod(tpl, "colorMissingArraysWithNanColorOn", ColorMissingArraysWithNanColorOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetColorMissingArraysWithNanColor", GetColorMissingArraysWithNanColor);
	Nan::SetPrototypeMethod(tpl, "getColorMissingArraysWithNanColor", GetColorMissingArraysWithNanColor);
	...
	Nan::SetPrototypeMethod(tpl, "SetColorMissingArraysWithNanColor", SetColorMissingArraysWithNanColor);
	Nan::SetPrototypeMethod(tpl, "setColorMissingArraysWithNanColor", SetColorMissingArraysWithNanColor);
...
void VtkCompositePolyDataMapper2Wrap::ColorMissingArraysWithNanColorOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	native->ColorMissingArraysWithNanColorOff();
}

void VtkCompositePolyDataMapper2Wrap::ColorMissingArraysWithNanColorOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCompositePolyDataMapper2Wrap *wrapper = ObjectWrap::Unwrap<VtkCompositePolyDataMapper2Wrap>(info.Holder());
	vtkCompositePolyDataMapper2 *native = (vtkCompositePolyDataMapper2 *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->ColorMissingArraysWithNanColorOn();
}
...
void VtkCompositePolyDataMapper2Wrap::GetColorMissingArraysWithNanColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCompositePolyDataMapper2Wrap *wrapper = ObjectWrap::Unwrap<VtkCompositePolyDataMapper2Wrap>(info.Holder());
	vtkCompositePolyDataMapper2 *native = (vtkCompositePolyDataMapper2 *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetColorMissingArraysWithNanColor();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkCompositePolyDataMapper2Wrap::ReleaseGraphicsResources(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCompositePolyDataMapper2Wrap *wrapper = ObjectWrap::Unwrap<VtkCompositePolyDataMapper2Wrap>(info.Holder());
	vtkCompositePolyDataMapper2 *native = (vtkCompositePolyDataMapper2 *)wrapper->native.GetPointer();
...
void VtkCompositePolyDataMapper2Wrap::RemoveBlockVisibilities(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCompositePolyDataMapper2Wrap *wrapper = ObjectWrap::Unwrap<VtkCompositePolyDataMapper2Wrap>(info.Holder());
	vtkCompositePolyDataMapper2 *native = (vtkCompositePolyDataMapper2 *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkCompositePolyDataMapper2Wrap::SetColorMissingArraysWithNanColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCompositePolyDataMapper2Wrap *wrapper = ObjectWrap::Unwrap<VtkCompositePolyDataMapper2Wrap>(info.Holder());
	vtkCompositePolyDataMapper2 *native = (vtkCompositePolyDataMapper2 *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
	{
		...
		native->SetColorMissingArraysWithNanColor(
			info[0]->BooleanValue()
		);
		return;
	}
