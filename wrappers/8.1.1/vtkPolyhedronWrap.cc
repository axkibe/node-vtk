...
#ifdef VTK_NODE_PLUS_VTKPOLYHEDRONWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPOLYHEDRONWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPolyhedronWrap::IsConvex(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPolyhedronWrap *wrapper = ObjectWrap::Unwrap<VtkPolyhedronWrap>(info.Holder());
	vtkPolyhedron *native = (vtkPolyhedron *)wrapper->native.GetPointer();
	bool r;
