...
#ifndef NATIVE_EXTENSION_VTK_VTKQUADRATICTETRAWRAP_H
#define NATIVE_EXTENSION_VTK_VTKQUADRATICTETRAWRAP_H
...
class VtkQuadraticTetraWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkQuadraticTetraWrap(vtkSmartPointer<vtkQuadraticTetra>);
		VtkQuadraticTetraWrap();
		~VtkQuadraticTetraWrap( );
...
#ifdef VTK_NODE_PLUS_VTKQUADRATICTETRAWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKQUADRATICTETRAWRAP_CLASSDEF
#endif
};
