...
class VtkDelimitedTextReaderWrap : public VtkTableAlgorithmWrap
{
	...
	private:
		...
		static void AddTabFieldDelimiterOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void AddTabFieldDelimiterOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetAddTabFieldDelimiter(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetAddTabFieldDelimiter(const Nan::FunctionCallbackInfo<v8::Value>& info);
