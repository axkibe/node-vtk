...
#ifndef NATIVE_EXTENSION_VTK_VTKPOINTINTERPOLATORWRAP_H
#define NATIVE_EXTENSION_VTK_VTKPOINTINTERPOLATORWRAP_H
...
class VtkPointInterpolatorWrap : public VtkDataSetAlgorithmWrap
{
	public:
		...
		VtkPointInterpolatorWrap(vtkSmartPointer<vtkPointInterpolator>);
		VtkPointInterpolatorWrap();
		~VtkPointInterpolatorWrap( );
	...
	private:
		...
		static void SetNullPointsStrategyToClosestPoint(const Nan::FunctionCallbackInfo<v8::Value>& info);
...
#ifdef VTK_NODE_PLUS_VTKPOINTINTERPOLATORWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKPOINTINTERPOLATORWRAP_CLASSDEF
#endif
};
