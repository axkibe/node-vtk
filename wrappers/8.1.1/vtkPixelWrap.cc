...
#ifdef VTK_NODE_PLUS_VTKPIXELWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPIXELWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPixelWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPixelWrap* obj = new VtkPixelWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkPixelWrap::CellBoundary(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkPixelWrap::GetParametricCenter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPixelWrap *wrapper = ObjectWrap::Unwrap<VtkPixelWrap>(info.Holder());
	vtkPixel *native = (vtkPixel *)wrapper->native.GetPointer();
	size_t i;
...
void VtkPixelWrap::InterpolateDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPixelWrap *wrapper = ObjectWrap::Unwrap<VtkPixelWrap>(info.Holder());
	vtkPixel *native = (vtkPixel *)wrapper->native.GetPointer();
	size_t i;
...
void VtkPixelWrap::InterpolateFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPixelWrap *wrapper = ObjectWrap::Unwrap<VtkPixelWrap>(info.Holder());
	vtkPixel *native = (vtkPixel *)wrapper->native.GetPointer();
	size_t i;
...
void VtkPixelWrap::InterpolationDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPixelWrap *wrapper = ObjectWrap::Unwrap<VtkPixelWrap>(info.Holder());
	vtkPixel *native = (vtkPixel *)wrapper->native.GetPointer();
	size_t i;
...
void VtkPixelWrap::InterpolationFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPixelWrap *wrapper = ObjectWrap::Unwrap<VtkPixelWrap>(info.Holder());
	vtkPixel *native = (vtkPixel *)wrapper->native.GetPointer();
	size_t i;
