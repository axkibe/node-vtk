...
void VtkInformationWrap::Append(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	else if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkInformationObjectBaseVectorKeyWrap::ptpl))->HasInstance(info[0]))
	{
		VtkInformationObjectBaseVectorKeyWrap *a0 = ObjectWrap::Unwrap<VtkInformationObjectBaseVectorKeyWrap>(info[0]->ToObject());
		if(info.Length() > 1 && info[1]->IsObject() && (Nan::New(VtkObjectBaseWrap::ptpl))->HasInstance(info[1]))
		{
			...
			native->Append(
				(vtkInformationObjectBaseVectorKey *) a0->native.GetPointer(),
...
void VtkInformationWrap::CopyEntry(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkInformationWrap::ptpl))->HasInstance(info[0]))
	{
		...
		else if(info.Length() > 1 && info[1]->IsObject() && (Nan::New(VtkInformationObjectBaseVectorKeyWrap::ptpl))->HasInstance(info[1]))
		{
			VtkInformationObjectBaseVectorKeyWrap *a1 = ObjectWrap::Unwrap<VtkInformationObjectBaseVectorKeyWrap>(info[1]->ToObject());
			if(info.Length() > 2 && info[2]->IsInt32())
			{
								if(info.Length() != 3)
				{
				...
				native->CopyEntry(
					(vtkInformation *) a0->native.GetPointer(),
					(vtkInformationObjectBaseVectorKey *) a1->native.GetPointer(),
					info[2]->Int32Value()
				);
				return;
			}
...
void VtkInformationWrap::Get(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkInformationWrap *wrapper = ObjectWrap::Unwrap<VtkInformationWrap>(info.Holder());
	vtkInformation *native = (vtkInformation *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkInformationObjectBaseVectorKeyWrap::ptpl))->HasInstance(info[0]))
	{
		VtkInformationObjectBaseVectorKeyWrap *a0 = ObjectWrap::Unwrap<VtkInformationObjectBaseVectorKeyWrap>(info[0]->ToObject());
		if(info.Length() > 1 && info[1]->IsInt32())
		{
