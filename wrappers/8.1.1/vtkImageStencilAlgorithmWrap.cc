...
#ifdef VTK_NODE_PLUS_VTKIMAGESTENCILALGORITHMWRAP_INITPTPL
	VTK_NODE_PLUS_VTKIMAGESTENCILALGORITHMWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkImageStencilAlgorithmWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkImageStencilAlgorithmWrap* obj = new VtkImageStencilAlgorithmWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
