...
#ifndef NATIVE_EXTENSION_VTK_VTKLAGRANGETRIANGLEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKLAGRANGETRIANGLEWRAP_H
...
class VtkLagrangeTriangleWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkLagrangeTriangleWrap(vtkSmartPointer<vtkLagrangeTriangle>);
		VtkLagrangeTriangleWrap();
		~VtkLagrangeTriangleWrap( );
...
#ifdef VTK_NODE_PLUS_VTKLAGRANGETRIANGLEWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKLAGRANGETRIANGLEWRAP_CLASSDEF
#endif
};
