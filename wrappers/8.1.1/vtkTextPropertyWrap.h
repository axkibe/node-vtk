...
class VtkTextPropertyWrap : public VtkObjectWrap
{
	...
	private:
		...
		static void FrameOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void FrameOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetFrame(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetFrameColor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetFrameWidth(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetFrameWidthMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetFrameWidthMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetUseTightBoundingBox(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetFrame(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetFrameColor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetFrameWidth(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetUseTightBoundingBox(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void UseTightBoundingBoxOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void UseTightBoundingBoxOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
