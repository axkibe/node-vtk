...
Nan::Persistent<v8::FunctionTemplate> VtkDataSetToDataObjectFilterWrap::ptpl;
...
{
	Nan::SetAccessor(exports, Nan::New("vtkDataSetToDataObjectFilter").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("DataSetToDataObjectFilter").ToLocalChecked(), ConstructorGetter);
}

void VtkDataSetToDataObjectFilterWrap::ConstructorGetter(
...
void VtkDataSetToDataObjectFilterWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKDATASETTODATAOBJECTFILTERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKDATASETTODATAOBJECTFILTERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkDataSetToDataObjectFilterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkDataSetToDataObjectFilterWrap::ptpl)->GetFunction();
