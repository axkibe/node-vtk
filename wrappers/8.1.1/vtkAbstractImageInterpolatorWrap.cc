...
void VtkAbstractImageInterpolatorWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetSlidingWindow", GetSlidingWindow);
	Nan::SetPrototypeMethod(tpl, "getSlidingWindow", GetSlidingWindow);
	...
	Nan::SetPrototypeMethod(tpl, "SetSlidingWindow", SetSlidingWindow);
	Nan::SetPrototypeMethod(tpl, "setSlidingWindow", SetSlidingWindow);

	Nan::SetPrototypeMethod(tpl, "SetTolerance", SetTolerance);
	Nan::SetPrototypeMethod(tpl, "setTolerance", SetTolerance);

	Nan::SetPrototypeMethod(tpl, "SlidingWindowOff", SlidingWindowOff);
	Nan::SetPrototypeMethod(tpl, "slidingWindowOff", SlidingWindowOff);

	Nan::SetPrototypeMethod(tpl, "SlidingWindowOn", SlidingWindowOn);
	Nan::SetPrototypeMethod(tpl, "slidingWindowOn", SlidingWindowOn);

	Nan::SetPrototypeMethod(tpl, "Update", Update);
	Nan::SetPrototypeMethod(tpl, "update", Update);

#ifdef VTK_NODE_PLUS_VTKABSTRACTIMAGEINTERPOLATORWRAP_INITPTPL
	VTK_NODE_PLUS_VTKABSTRACTIMAGEINTERPOLATORWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkAbstractImageInterpolatorWrap::GetExtent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractImageInterpolatorWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractImageInterpolatorWrap>(info.Holder());
	vtkAbstractImageInterpolator *native = (vtkAbstractImageInterpolator *)wrapper->native.GetPointer();
	int const * r;
...
void VtkAbstractImageInterpolatorWrap::GetOrigin(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractImageInterpolatorWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractImageInterpolatorWrap>(info.Holder());
	vtkAbstractImageInterpolator *native = (vtkAbstractImageInterpolator *)wrapper->native.GetPointer();
	double const * r;
...
void VtkAbstractImageInterpolatorWrap::GetSlidingWindow(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractImageInterpolatorWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractImageInterpolatorWrap>(info.Holder());
	vtkAbstractImageInterpolator *native = (vtkAbstractImageInterpolator *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetSlidingWindow();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkAbstractImageInterpolatorWrap::GetSpacing(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractImageInterpolatorWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractImageInterpolatorWrap>(info.Holder());
	vtkAbstractImageInterpolator *native = (vtkAbstractImageInterpolator *)wrapper->native.GetPointer();
	double const * r;
...
void VtkAbstractImageInterpolatorWrap::GetWholeExtent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractImageInterpolatorWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractImageInterpolatorWrap>(info.Holder());
	vtkAbstractImageInterpolator *native = (vtkAbstractImageInterpolator *)wrapper->native.GetPointer();
	size_t i;
...
void VtkAbstractImageInterpolatorWrap::SetSlidingWindow(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractImageInterpolatorWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractImageInterpolatorWrap>(info.Holder());
	vtkAbstractImageInterpolator *native = (vtkAbstractImageInterpolator *)wrapper->native.GetPointer();
...
void VtkAbstractImageInterpolatorWrap::SlidingWindowOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractImageInterpolatorWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractImageInterpolatorWrap>(info.Holder());
	vtkAbstractImageInterpolator *native = (vtkAbstractImageInterpolator *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SlidingWindowOff();
}

void VtkAbstractImageInterpolatorWrap::SlidingWindowOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAbstractImageInterpolatorWrap *wrapper = ObjectWrap::Unwrap<VtkAbstractImageInterpolatorWrap>(info.Holder());
	vtkAbstractImageInterpolator *native = (vtkAbstractImageInterpolator *)wrapper->native.GetPointer();
		if(info.Length() != 0)
