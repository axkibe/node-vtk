...
class VtkDataArrayWrap : public VtkAbstractArrayWrap
{
	...
	private:
		...
		static void GetFiniteRange(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void L2_NORM_FINITE_RANGE(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void UNITS_LABEL(const Nan::FunctionCallbackInfo<v8::Value>& info);
