...
{
	Nan::SetAccessor(exports, Nan::New("vtkContourLineInterpolator").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("ContourLineInterpolator").ToLocalChecked(), ConstructorGetter);
}

void VtkContourLineInterpolatorWrap::ConstructorGetter(
...
void VtkContourLineInterpolatorWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKCONTOURLINEINTERPOLATORWRAP_INITPTPL
	VTK_NODE_PLUS_VTKCONTOURLINEINTERPOLATORWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkContourLineInterpolatorWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkContourLineInterpolatorWrap::ptpl)->GetFunction();
