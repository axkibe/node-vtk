...
#ifndef NATIVE_EXTENSION_VTK_VTKFLYINGEDGES3DWRAP_H
#define NATIVE_EXTENSION_VTK_VTKFLYINGEDGES3DWRAP_H
...
class VtkFlyingEdges3DWrap : public VtkPolyDataAlgorithmWrap
{
	public:
		...
		VtkFlyingEdges3DWrap(vtkSmartPointer<vtkFlyingEdges3D>);
		VtkFlyingEdges3DWrap();
		~VtkFlyingEdges3DWrap( );
