...
#ifdef VTK_NODE_PLUS_VTKPOLYDATANORMALSWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPOLYDATANORMALSWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPolyDataNormalsWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkPolyDataNormalsWrap::ptpl)->GetFunction();
