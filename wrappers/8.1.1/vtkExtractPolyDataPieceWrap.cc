...
#ifdef VTK_NODE_PLUS_VTKEXTRACTPOLYDATAPIECEWRAP_INITPTPL
	VTK_NODE_PLUS_VTKEXTRACTPOLYDATAPIECEWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkExtractPolyDataPieceWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkExtractPolyDataPieceWrap* obj = new VtkExtractPolyDataPieceWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
