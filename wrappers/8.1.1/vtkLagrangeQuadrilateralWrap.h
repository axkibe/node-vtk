...
#ifndef NATIVE_EXTENSION_VTK_VTKLAGRANGEQUADRILATERALWRAP_H
#define NATIVE_EXTENSION_VTK_VTKLAGRANGEQUADRILATERALWRAP_H
...
class VtkLagrangeQuadrilateralWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkLagrangeQuadrilateralWrap(vtkSmartPointer<vtkLagrangeQuadrilateral>);
		VtkLagrangeQuadrilateralWrap();
		~VtkLagrangeQuadrilateralWrap( );
...
#ifdef VTK_NODE_PLUS_VTKLAGRANGEQUADRILATERALWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKLAGRANGEQUADRILATERALWRAP_CLASSDEF
#endif
};
