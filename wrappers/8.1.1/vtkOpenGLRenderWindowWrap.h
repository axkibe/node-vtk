...
class VtkOpenGLRenderWindowWrap : public VtkRenderWindowWrap
{
	...
	private:
		...
		static void GetDefaultFrameBufferId(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetFrameBufferObject(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetUsingSRGBColorSpace(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetSwapControl(const Nan::FunctionCallbackInfo<v8::Value>& info);
