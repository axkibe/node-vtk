...
void VtkOpenFOAMReaderWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetSkipZeroTime", GetSkipZeroTime);
	Nan::SetPrototypeMethod(tpl, "getSkipZeroTime", GetSkipZeroTime);

	Nan::SetPrototypeMethod(tpl, "GetTimeValues", GetTimeValues);
	Nan::SetPrototypeMethod(tpl, "getTimeValues", GetTimeValues);

	Nan::SetPrototypeMethod(tpl, "GetUse64BitFloats", GetUse64BitFloats);
	Nan::SetPrototypeMethod(tpl, "getUse64BitFloats", GetUse64BitFloats);

	Nan::SetPrototypeMethod(tpl, "GetUse64BitLabels", GetUse64BitLabels);
	Nan::SetPrototypeMethod(tpl, "getUse64BitLabels", GetUse64BitLabels);
	...
	Nan::SetPrototypeMethod(tpl, "SetSkipZeroTime", SetSkipZeroTime);
	Nan::SetPrototypeMethod(tpl, "setSkipZeroTime", SetSkipZeroTime);

	Nan::SetPrototypeMethod(tpl, "SetTimeValue", SetTimeValue);
	Nan::SetPrototypeMethod(tpl, "setTimeValue", SetTimeValue);

	Nan::SetPrototypeMethod(tpl, "SetUse64BitFloats", SetUse64BitFloats);
	Nan::SetPrototypeMethod(tpl, "setUse64BitFloats", SetUse64BitFloats);

	Nan::SetPrototypeMethod(tpl, "SetUse64BitLabels", SetUse64BitLabels);
	Nan::SetPrototypeMethod(tpl, "setUse64BitLabels", SetUse64BitLabels);

	Nan::SetPrototypeMethod(tpl, "SkipZeroTimeOff", SkipZeroTimeOff);
	Nan::SetPrototypeMethod(tpl, "skipZeroTimeOff", SkipZeroTimeOff);

	Nan::SetPrototypeMethod(tpl, "SkipZeroTimeOn", SkipZeroTimeOn);
	Nan::SetPrototypeMethod(tpl, "skipZeroTimeOn", SkipZeroTimeOn);

	Nan::SetPrototypeMethod(tpl, "Use64BitFloatsOff", Use64BitFloatsOff);
	Nan::SetPrototypeMethod(tpl, "use64BitFloatsOff", Use64BitFloatsOff);

	Nan::SetPrototypeMethod(tpl, "Use64BitFloatsOn", Use64BitFloatsOn);
	Nan::SetPrototypeMethod(tpl, "use64BitFloatsOn", Use64BitFloatsOn);

	Nan::SetPrototypeMethod(tpl, "Use64BitLabelsOff", Use64BitLabelsOff);
	Nan::SetPrototypeMethod(tpl, "use64BitLabelsOff", Use64BitLabelsOff);

	Nan::SetPrototypeMethod(tpl, "Use64BitLabelsOn", Use64BitLabelsOn);
	Nan::SetPrototypeMethod(tpl, "use64BitLabelsOn", Use64BitLabelsOn);
...
void VtkOpenFOAMReaderWrap::GetSkipZeroTime(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
	bool r;
...
void VtkOpenFOAMReaderWrap::GetUse64BitFloats(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetUse64BitFloats();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkOpenFOAMReaderWrap::GetUse64BitLabels(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
	bool r;
...
void VtkOpenFOAMReaderWrap::SetSkipZeroTime(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
...
void VtkOpenFOAMReaderWrap::SetUse64BitFloats(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
...
void VtkOpenFOAMReaderWrap::SetUse64BitLabels(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
...
void VtkOpenFOAMReaderWrap::SkipZeroTimeOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SkipZeroTimeOff();
}

void VtkOpenFOAMReaderWrap::SkipZeroTimeOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SkipZeroTimeOn();
}

void VtkOpenFOAMReaderWrap::Use64BitFloatsOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->Use64BitFloatsOff();
}

void VtkOpenFOAMReaderWrap::Use64BitFloatsOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->Use64BitFloatsOn();
}

void VtkOpenFOAMReaderWrap::Use64BitLabelsOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->Use64BitLabelsOff();
}

void VtkOpenFOAMReaderWrap::Use64BitLabelsOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOpenFOAMReaderWrap *wrapper = ObjectWrap::Unwrap<VtkOpenFOAMReaderWrap>(info.Holder());
	vtkOpenFOAMReader *native = (vtkOpenFOAMReader *)wrapper->native.GetPointer();
		if(info.Length() != 0)
