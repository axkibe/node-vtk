...
void VtkAxisActorWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "ExponentVisibilityOff", ExponentVisibilityOff);
	Nan::SetPrototypeMethod(tpl, "exponentVisibilityOff", ExponentVisibilityOff);

	Nan::SetPrototypeMethod(tpl, "ExponentVisibilityOn", ExponentVisibilityOn);
	Nan::SetPrototypeMethod(tpl, "exponentVisibilityOn", ExponentVisibilityOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetAxisMainLineProperty", GetAxisMainLineProperty);
	Nan::SetPrototypeMethod(tpl, "getAxisMainLineProperty", GetAxisMainLineProperty);

	Nan::SetPrototypeMethod(tpl, "GetAxisMajorTicksProperty", GetAxisMajorTicksProperty);
	Nan::SetPrototypeMethod(tpl, "getAxisMajorTicksProperty", GetAxisMajorTicksProperty);

	Nan::SetPrototypeMethod(tpl, "GetAxisMinorTicksProperty", GetAxisMinorTicksProperty);
	Nan::SetPrototypeMethod(tpl, "getAxisMinorTicksProperty", GetAxisMinorTicksProperty);
	...
	Nan::SetPrototypeMethod(tpl, "GetExponentActor", GetExponentActor);
	Nan::SetPrototypeMethod(tpl, "getExponentActor", GetExponentActor);

	Nan::SetPrototypeMethod(tpl, "GetExponentLocation", GetExponentLocation);
	Nan::SetPrototypeMethod(tpl, "getExponentLocation", GetExponentLocation);

	Nan::SetPrototypeMethod(tpl, "GetExponentOffset", GetExponentOffset);
	Nan::SetPrototypeMethod(tpl, "getExponentOffset", GetExponentOffset);

	Nan::SetPrototypeMethod(tpl, "GetExponentProp3D", GetExponentProp3D);
	Nan::SetPrototypeMethod(tpl, "getExponentProp3D", GetExponentProp3D);

	Nan::SetPrototypeMethod(tpl, "GetExponentVisibility", GetExponentVisibility);
	Nan::SetPrototypeMethod(tpl, "getExponentVisibility", GetExponentVisibility);
	...
	Nan::SetPrototypeMethod(tpl, "GetLastMajorTickPointCorrection", GetLastMajorTickPointCorrection);
	Nan::SetPrototypeMethod(tpl, "getLastMajorTickPointCorrection", GetLastMajorTickPointCorrection);
	...
	Nan::SetPrototypeMethod(tpl, "GetTitleAlignLocation", GetTitleAlignLocation);
	Nan::SetPrototypeMethod(tpl, "getTitleAlignLocation", GetTitleAlignLocation);
	...
	Nan::SetPrototypeMethod(tpl, "LastMajorTickPointCorrectionOff", LastMajorTickPointCorrectionOff);
	Nan::SetPrototypeMethod(tpl, "lastMajorTickPointCorrectionOff", LastMajorTickPointCorrectionOff);

	Nan::SetPrototypeMethod(tpl, "LastMajorTickPointCorrectionOn", LastMajorTickPointCorrectionOn);
	Nan::SetPrototypeMethod(tpl, "lastMajorTickPointCorrectionOn", LastMajorTickPointCorrectionOn);
	...
	Nan::SetPrototypeMethod(tpl, "SetAxisMainLineProperty", SetAxisMainLineProperty);
	Nan::SetPrototypeMethod(tpl, "setAxisMainLineProperty", SetAxisMainLineProperty);

	Nan::SetPrototypeMethod(tpl, "SetAxisMajorTicksProperty", SetAxisMajorTicksProperty);
	Nan::SetPrototypeMethod(tpl, "setAxisMajorTicksProperty", SetAxisMajorTicksProperty);

	Nan::SetPrototypeMethod(tpl, "SetAxisMinorTicksProperty", SetAxisMinorTicksProperty);
	Nan::SetPrototypeMethod(tpl, "setAxisMinorTicksProperty", SetAxisMinorTicksProperty);
	...
	Nan::SetPrototypeMethod(tpl, "SetExponentOffset", SetExponentOffset);
	Nan::SetPrototypeMethod(tpl, "setExponentOffset", SetExponentOffset);

	Nan::SetPrototypeMethod(tpl, "SetExponentVisibility", SetExponentVisibility);
	Nan::SetPrototypeMethod(tpl, "setExponentVisibility", SetExponentVisibility);
	...
	Nan::SetPrototypeMethod(tpl, "SetLastMajorTickPointCorrection", SetLastMajorTickPointCorrection);
	Nan::SetPrototypeMethod(tpl, "setLastMajorTickPointCorrection", SetLastMajorTickPointCorrection);
	...
	Nan::SetPrototypeMethod(tpl, "SetTitleAlignLocation", SetTitleAlignLocation);
	Nan::SetPrototypeMethod(tpl, "setTitleAlignLocation", SetTitleAlignLocation);
...
void VtkAxisActorWrap::ExponentVisibilityOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->ExponentVisibilityOff();
}

void VtkAxisActorWrap::ExponentVisibilityOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkAxisActorWrap::GetAxisMainLineProperty(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	vtkProperty * r;
	...
	r = native->GetAxisMainLineProperty();
	VtkPropertyWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
...
void VtkAxisActorWrap::GetAxisMajorTicksProperty(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	vtkProperty * r;
	...
	r = native->GetAxisMajorTicksProperty();
	VtkPropertyWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
...
void VtkAxisActorWrap::GetAxisMinorTicksProperty(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	vtkProperty * r;
	...
	r = native->GetAxisMinorTicksProperty();
	VtkPropertyWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
...
void VtkAxisActorWrap::GetExponent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	char const * r;
...
void VtkAxisActorWrap::GetExponentActor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	vtkAxisFollower * r;
...
void VtkAxisActorWrap::GetExponentLocation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	int r;
...
void VtkAxisActorWrap::GetExponentOffset(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	double r;
	...
	r = native->GetExponentOffset();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkAxisActorWrap::GetExponentProp3D(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
...
void VtkAxisActorWrap::GetExponentVisibility(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetExponentVisibility();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkAxisActorWrap::GetLastMajorTickPointCorrection(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetLastMajorTickPointCorrection();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkAxisActorWrap::GetLog(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	bool r;
...
void VtkAxisActorWrap::GetTitleAlignLocation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetTitleAlignLocation();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkAxisActorWrap::LastMajorTickPointCorrectionOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->LastMajorTickPointCorrectionOff();
}

void VtkAxisActorWrap::LastMajorTickPointCorrectionOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->LastMajorTickPointCorrectionOn();
}

void VtkAxisActorWrap::LogOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkAxisActorWrap::LogOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkAxisActorWrap::SetAxisMainLineProperty(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkPropertyWrap::ptpl))->HasInstance(info[0]))
	{
		...
		native->SetAxisMainLineProperty(
			(vtkProperty *) a0->native.GetPointer()
		);
		return;
	}
...
void VtkAxisActorWrap::SetAxisMajorTicksProperty(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkPropertyWrap::ptpl))->HasInstance(info[0]))
	{
		...
		native->SetAxisMajorTicksProperty(
			(vtkProperty *) a0->native.GetPointer()
		);
		return;
	}
...
void VtkAxisActorWrap::SetAxisMinorTicksProperty(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkPropertyWrap::ptpl))->HasInstance(info[0]))
	{
		...
		native->SetAxisMinorTicksProperty(
			(vtkProperty *) a0->native.GetPointer()
		);
		return;
	}
...
void VtkAxisActorWrap::SetExponent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
...
void VtkAxisActorWrap::SetExponentLocation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkAxisActorWrap::SetExponentOffset(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
...
void VtkAxisActorWrap::SetExponentVisibility(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
...
void VtkAxisActorWrap::SetLastMajorTickPointCorrection(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
	{
		...
		native->SetLastMajorTickPointCorrection(
			info[0]->BooleanValue()
		);
		return;
	}
...
void VtkAxisActorWrap::SetLog(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
...
void VtkAxisActorWrap::SetTitleAlignLocation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkAxisActorWrap *wrapper = ObjectWrap::Unwrap<VtkAxisActorWrap>(info.Holder());
	vtkAxisActor *native = (vtkAxisActor *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
