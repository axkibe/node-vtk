...
#ifndef NATIVE_EXTENSION_VTK_VTKLAGRANGEWEDGEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKLAGRANGEWEDGEWRAP_H
...
class VtkLagrangeWedgeWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkLagrangeWedgeWrap(vtkSmartPointer<vtkLagrangeWedge>);
		VtkLagrangeWedgeWrap();
		~VtkLagrangeWedgeWrap( );
	...
	private:
		...
		static void GetNumberOfApproximatingWedges(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void PointIndexFromIJK(const Nan::FunctionCallbackInfo<v8::Value>& info);
...
#ifdef VTK_NODE_PLUS_VTKLAGRANGEWEDGEWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKLAGRANGEWEDGEWRAP_CLASSDEF
#endif
};
