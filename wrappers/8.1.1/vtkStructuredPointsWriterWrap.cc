...
void VtkStructuredPointsWriterWrap::GetWriteExtent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkStructuredPointsWriterWrap *wrapper = ObjectWrap::Unwrap<VtkStructuredPointsWriterWrap>(info.Holder());
	vtkStructuredPointsWriter *native = (vtkStructuredPointsWriter *)wrapper->native.GetPointer();
	bool r;
...
void VtkStructuredPointsWriterWrap::SetWriteExtent(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkStructuredPointsWriterWrap *wrapper = ObjectWrap::Unwrap<VtkStructuredPointsWriterWrap>(info.Holder());
	vtkStructuredPointsWriter *native = (vtkStructuredPointsWriter *)wrapper->native.GetPointer();
...
void VtkStructuredPointsWriterWrap::WriteExtentOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkStructuredPointsWriterWrap *wrapper = ObjectWrap::Unwrap<VtkStructuredPointsWriterWrap>(info.Holder());
	vtkStructuredPointsWriter *native = (vtkStructuredPointsWriter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkStructuredPointsWriterWrap::WriteExtentOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkStructuredPointsWriterWrap *wrapper = ObjectWrap::Unwrap<VtkStructuredPointsWriterWrap>(info.Holder());
	vtkStructuredPointsWriter *native = (vtkStructuredPointsWriter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
