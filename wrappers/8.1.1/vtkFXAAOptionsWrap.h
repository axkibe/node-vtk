...
#ifndef NATIVE_EXTENSION_VTK_VTKFXAAOPTIONSWRAP_H
#define NATIVE_EXTENSION_VTK_VTKFXAAOPTIONSWRAP_H
...
class VtkFXAAOptionsWrap : public VtkObjectWrap
{
	public:
		...
		VtkFXAAOptionsWrap(vtkSmartPointer<vtkFXAAOptions>);
		VtkFXAAOptionsWrap();
		~VtkFXAAOptionsWrap( );
...
#ifdef VTK_NODE_PLUS_VTKFXAAOPTIONSWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKFXAAOPTIONSWRAP_CLASSDEF
#endif
};
