...
void VtkPointSourceWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetRandomSequence", GetRandomSequence);
	Nan::SetPrototypeMethod(tpl, "getRandomSequence", GetRandomSequence);
	...
	Nan::SetPrototypeMethod(tpl, "SetRandomSequence", SetRandomSequence);
	Nan::SetPrototypeMethod(tpl, "setRandomSequence", SetRandomSequence);

#ifdef VTK_NODE_PLUS_VTKPOINTSOURCEWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPOINTSOURCEWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPointSourceWrap::GetRandomSequence(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPointSourceWrap *wrapper = ObjectWrap::Unwrap<VtkPointSourceWrap>(info.Holder());
	vtkPointSource *native = (vtkPointSource *)wrapper->native.GetPointer();
	vtkRandomSequence * r;
...
void VtkPointSourceWrap::SetRandomSequence(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPointSourceWrap *wrapper = ObjectWrap::Unwrap<VtkPointSourceWrap>(info.Holder());
	vtkPointSource *native = (vtkPointSource *)wrapper->native.GetPointer();
