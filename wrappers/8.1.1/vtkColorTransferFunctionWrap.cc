...
void VtkColorTransferFunctionWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "SetColorSpaceToLabCIEDE2000", SetColorSpaceToLabCIEDE2000);
	Nan::SetPrototypeMethod(tpl, "setColorSpaceToLabCIEDE2000", SetColorSpaceToLabCIEDE2000);
...
void VtkColorTransferFunctionWrap::SetColorSpaceToLabCIEDE2000(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkColorTransferFunctionWrap *wrapper = ObjectWrap::Unwrap<VtkColorTransferFunctionWrap>(info.Holder());
	vtkColorTransferFunction *native = (vtkColorTransferFunction *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetColorSpaceToLabCIEDE2000();
}
