...
class VtkConvertSelectionWrap : public VtkSelectionAlgorithmWrap
{
	...
	private:
		...
		static void AllowMissingArrayOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void AllowMissingArrayOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void ClearArrayNames(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetAllowMissingArray(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetAllowMissingArray(const Nan::FunctionCallbackInfo<v8::Value>& info);
