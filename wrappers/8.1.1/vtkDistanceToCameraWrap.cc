...
#ifdef VTK_NODE_PLUS_VTKDISTANCETOCAMERAWRAP_INITPTPL
	VTK_NODE_PLUS_VTKDISTANCETOCAMERAWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkDistanceToCameraWrap::GetDistanceArrayName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkDistanceToCameraWrap::SetDistanceArrayName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDistanceToCameraWrap *wrapper = ObjectWrap::Unwrap<VtkDistanceToCameraWrap>(info.Holder());
	vtkDistanceToCamera *native = (vtkDistanceToCamera *)wrapper->native.GetPointer();
