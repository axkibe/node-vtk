...
void VtkFixedWidthTextReaderWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetTableErrorObserver", GetTableErrorObserver);
	Nan::SetPrototypeMethod(tpl, "getTableErrorObserver", GetTableErrorObserver);
	...
	Nan::SetPrototypeMethod(tpl, "SetTableErrorObserver", SetTableErrorObserver);
	Nan::SetPrototypeMethod(tpl, "setTableErrorObserver", SetTableErrorObserver);
...
void VtkFixedWidthTextReaderWrap::GetTableErrorObserver(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFixedWidthTextReaderWrap *wrapper = ObjectWrap::Unwrap<VtkFixedWidthTextReaderWrap>(info.Holder());
	vtkFixedWidthTextReader *native = (vtkFixedWidthTextReader *)wrapper->native.GetPointer();
	vtkCommand * r;
...
void VtkFixedWidthTextReaderWrap::SetTableErrorObserver(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkFixedWidthTextReaderWrap *wrapper = ObjectWrap::Unwrap<VtkFixedWidthTextReaderWrap>(info.Holder());
	vtkFixedWidthTextReader *native = (vtkFixedWidthTextReader *)wrapper->native.GetPointer();
