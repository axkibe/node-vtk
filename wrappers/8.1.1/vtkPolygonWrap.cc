...
void VtkPolygonWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "BoundedTriangulate", BoundedTriangulate);
	Nan::SetPrototypeMethod(tpl, "boundedTriangulate", BoundedTriangulate);
	...
	Nan::SetPrototypeMethod(tpl, "IsConvex", IsConvex);
	Nan::SetPrototypeMethod(tpl, "isConvex", IsConvex);
...
void VtkPolygonWrap::BoundedTriangulate(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkPolygonWrap::IsConvex(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPolygonWrap *wrapper = ObjectWrap::Unwrap<VtkPolygonWrap>(info.Holder());
	vtkPolygon *native = (vtkPolygon *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkIdTypeArrayWrap::ptpl))->HasInstance(info[0]))
