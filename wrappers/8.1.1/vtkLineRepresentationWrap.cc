...
void VtkLineRepresentationWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "DirectionalLineOff", DirectionalLineOff);
	Nan::SetPrototypeMethod(tpl, "directionalLineOff", DirectionalLineOff);

	Nan::SetPrototypeMethod(tpl, "DirectionalLineOn", DirectionalLineOn);
	Nan::SetPrototypeMethod(tpl, "directionalLineOn", DirectionalLineOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetDirectionalLine", GetDirectionalLine);
	Nan::SetPrototypeMethod(tpl, "getDirectionalLine", GetDirectionalLine);
	...
	Nan::SetPrototypeMethod(tpl, "GetRestrictFlagMaxValue", GetRestrictFlagMaxValue);
	Nan::SetPrototypeMethod(tpl, "getRestrictFlagMaxValue", GetRestrictFlagMaxValue);

	Nan::SetPrototypeMethod(tpl, "GetRestrictFlagMinValue", GetRestrictFlagMinValue);
	Nan::SetPrototypeMethod(tpl, "getRestrictFlagMinValue", GetRestrictFlagMinValue);
	...
	Nan::SetPrototypeMethod(tpl, "SetDirectionalLine", SetDirectionalLine);
	Nan::SetPrototypeMethod(tpl, "setDirectionalLine", SetDirectionalLine);
	...
	Nan::SetPrototypeMethod(tpl, "SetRestrictFlag", SetRestrictFlag);
	Nan::SetPrototypeMethod(tpl, "setRestrictFlag", SetRestrictFlag);
...
#ifdef VTK_NODE_PLUS_VTKLINEREPRESENTATIONWRAP_INITPTPL
	VTK_NODE_PLUS_VTKLINEREPRESENTATIONWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkLineRepresentationWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkLineRepresentationWrap* obj = new VtkLineRepresentationWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkLineRepresentationWrap::DirectionalLineOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkLineRepresentationWrap>(info.Holder());
	vtkLineRepresentation *native = (vtkLineRepresentation *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->DirectionalLineOff();
}

void VtkLineRepresentationWrap::DirectionalLineOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkLineRepresentationWrap>(info.Holder());
	vtkLineRepresentation *native = (vtkLineRepresentation *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkLineRepresentationWrap::GetBounds(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkLineRepresentationWrap>(info.Holder());
	vtkLineRepresentation *native = (vtkLineRepresentation *)wrapper->native.GetPointer();
	double const * r;
...
void VtkLineRepresentationWrap::GetDirectionalLine(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkLineRepresentationWrap>(info.Holder());
	vtkLineRepresentation *native = (vtkLineRepresentation *)wrapper->native.GetPointer();
	bool r;
...
void VtkLineRepresentationWrap::GetPoint1DisplayPosition(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	r = native->GetPoint1DisplayPosition();
...
void VtkLineRepresentationWrap::GetPoint1WorldPosition(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	r = native->GetPoint1WorldPosition();
	Local<v8::ArrayBuffer> ab = v8::ArrayBuffer::New(v8::Isolate::GetCurrent(), 3 * sizeof(double));
	Local<v8::Float64Array> at = v8::Float64Array::New(ab, 0, 3);
	memcpy(ab->GetContents().Data(), r, 3 * sizeof(double));
	info.GetReturnValue().Set(at);
...
void VtkLineRepresentationWrap::GetPoint2DisplayPosition(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	r = native->GetPoint2DisplayPosition();
	Local<v8::ArrayBuffer> ab = v8::ArrayBuffer::New(v8::Isolate::GetCurrent(), 3 * sizeof(double));
	Local<v8::Float64Array> at = v8::Float64Array::New(ab, 0, 3);
	memcpy(ab->GetContents().Data(), r, 3 * sizeof(double));
	info.GetReturnValue().Set(at);
...
void VtkLineRepresentationWrap::GetPoint2WorldPosition(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	r = native->GetPoint2WorldPosition();
	Local<v8::ArrayBuffer> ab = v8::ArrayBuffer::New(v8::Isolate::GetCurrent(), 3 * sizeof(double));
	Local<v8::Float64Array> at = v8::Float64Array::New(ab, 0, 3);
	memcpy(ab->GetContents().Data(), r, 3 * sizeof(double));
	info.GetReturnValue().Set(at);
...
void VtkLineRepresentationWrap::GetRestrictFlagMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkLineRepresentationWrap>(info.Holder());
	vtkLineRepresentation *native = (vtkLineRepresentation *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetRestrictFlagMaxValue();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkLineRepresentationWrap::GetRestrictFlagMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkLineRepresentationWrap>(info.Holder());
	vtkLineRepresentation *native = (vtkLineRepresentation *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetRestrictFlagMinValue();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkLineRepresentationWrap::SetDirectionalLine(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkLineRepresentationWrap>(info.Holder());
	vtkLineRepresentation *native = (vtkLineRepresentation *)wrapper->native.GetPointer();
...
void VtkLineRepresentationWrap::SetRestrictFlag(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLineRepresentationWrap *wrapper = ObjectWrap::Unwrap<VtkLineRepresentationWrap>(info.Holder());
	vtkLineRepresentation *native = (vtkLineRepresentation *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
