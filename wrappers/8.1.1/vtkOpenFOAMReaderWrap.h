...
class VtkOpenFOAMReaderWrap : public VtkMultiBlockDataSetAlgorithmWrap
{
	...
	private:
		...
		static void GetSkipZeroTime(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetTimeValues(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetUse64BitFloats(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetUse64BitLabels(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetSkipZeroTime(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetTimeValue(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetUse64BitFloats(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetUse64BitLabels(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SkipZeroTimeOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SkipZeroTimeOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void Use64BitFloatsOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void Use64BitFloatsOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void Use64BitLabelsOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void Use64BitLabelsOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
