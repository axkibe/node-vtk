...
#ifdef VTK_NODE_PLUS_VTKCOMPOSITEDATAGEOMETRYFILTERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKCOMPOSITEDATAGEOMETRYFILTERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkCompositeDataGeometryFilterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkCompositeDataGeometryFilterWrap* obj = new VtkCompositeDataGeometryFilterWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
