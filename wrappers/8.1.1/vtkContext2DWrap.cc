...
void VtkContext2DWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "DrawLines", DrawLines);
	Nan::SetPrototypeMethod(tpl, "drawLines", DrawLines);
	...
	Nan::SetPrototypeMethod(tpl, "DrawPolyData", DrawPolyData);
	Nan::SetPrototypeMethod(tpl, "drawPolyData", DrawPolyData);
...
void VtkContext2DWrap::DrawLines(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkContext2DWrap *wrapper = ObjectWrap::Unwrap<VtkContext2DWrap>(info.Holder());
	vtkContext2D *native = (vtkContext2D *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkPoints2DWrap::ptpl))->HasInstance(info[0]))
...
void VtkContext2DWrap::DrawPolyData(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkContext2DWrap *wrapper = ObjectWrap::Unwrap<VtkContext2DWrap>(info.Holder());
	vtkContext2D *native = (vtkContext2D *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsNumber())
	{
		if(info.Length() > 1 && info[1]->IsNumber())
		{
			if(info.Length() > 2 && info[2]->IsObject() && (Nan::New(VtkPolyDataWrap::ptpl))->HasInstance(info[2]))
			{
				VtkPolyDataWrap *a2 = ObjectWrap::Unwrap<VtkPolyDataWrap>(info[2]->ToObject());
				if(info.Length() > 3 && info[3]->IsObject() && (Nan::New(VtkUnsignedCharArrayWrap::ptpl))->HasInstance(info[3]))
				{
					VtkUnsignedCharArrayWrap *a3 = ObjectWrap::Unwrap<VtkUnsignedCharArrayWrap>(info[3]->ToObject());
					if(info.Length() > 4 && info[4]->IsInt32())
					{
						...
						native->DrawPolyData(
							info[0]->NumberValue(),
							info[1]->NumberValue(),
							(vtkPolyData *) a2->native.GetPointer(),
							(vtkUnsignedCharArray *) a3->native.GetPointer(),
							info[4]->Int32Value()
						);
						return;
