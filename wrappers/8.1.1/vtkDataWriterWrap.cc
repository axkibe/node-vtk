...
void VtkDataWriterWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetWriteArrayMetaData", GetWriteArrayMetaData);
	Nan::SetPrototypeMethod(tpl, "getWriteArrayMetaData", GetWriteArrayMetaData);
	...
	Nan::SetPrototypeMethod(tpl, "SetWriteArrayMetaData", SetWriteArrayMetaData);
	Nan::SetPrototypeMethod(tpl, "setWriteArrayMetaData", SetWriteArrayMetaData);

	Nan::SetPrototypeMethod(tpl, "SetWriteToOutputString", SetWriteToOutputString);
	Nan::SetPrototypeMethod(tpl, "setWriteToOutputString", SetWriteToOutputString);

	Nan::SetPrototypeMethod(tpl, "WriteArrayMetaDataOff", WriteArrayMetaDataOff);
	Nan::SetPrototypeMethod(tpl, "writeArrayMetaDataOff", WriteArrayMetaDataOff);

	Nan::SetPrototypeMethod(tpl, "WriteArrayMetaDataOn", WriteArrayMetaDataOn);
	Nan::SetPrototypeMethod(tpl, "writeArrayMetaDataOn", WriteArrayMetaDataOn);
...
void VtkDataWriterWrap::GetWriteArrayMetaData(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataWriterWrap *wrapper = ObjectWrap::Unwrap<VtkDataWriterWrap>(info.Holder());
	vtkDataWriter *native = (vtkDataWriter *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetWriteArrayMetaData();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkDataWriterWrap::SetWriteArrayMetaData(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataWriterWrap *wrapper = ObjectWrap::Unwrap<VtkDataWriterWrap>(info.Holder());
	vtkDataWriter *native = (vtkDataWriter *)wrapper->native.GetPointer();
...
void VtkDataWriterWrap::WriteArrayMetaDataOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataWriterWrap *wrapper = ObjectWrap::Unwrap<VtkDataWriterWrap>(info.Holder());
	vtkDataWriter *native = (vtkDataWriter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->WriteArrayMetaDataOff();
}

void VtkDataWriterWrap::WriteArrayMetaDataOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataWriterWrap *wrapper = ObjectWrap::Unwrap<VtkDataWriterWrap>(info.Holder());
	vtkDataWriter *native = (vtkDataWriter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
