...
class VtkLineRepresentationWrap : public VtkWidgetRepresentationWrap
{
	...
	private:
		...
		static void DirectionalLineOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void DirectionalLineOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetDirectionalLine(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetRestrictFlagMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetRestrictFlagMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetDirectionalLine(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetRestrictFlag(const Nan::FunctionCallbackInfo<v8::Value>& info);
