...
void VtkRenderWindowWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetRenderTimer", GetRenderTimer);
	Nan::SetPrototypeMethod(tpl, "getRenderTimer", GetRenderTimer);
...
void VtkRenderWindowWrap::GetRenderTimer(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowWrap>(info.Holder());
	vtkRenderWindow *native = (vtkRenderWindow *)wrapper->native.GetPointer();
	vtkRenderTimerLog * r;
...
void VtkRenderWindowWrap::GetRenderingBackend(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowWrap>(info.Holder());
	vtkRenderWindow *native = (vtkRenderWindow *)wrapper->native.GetPointer();
	char const * r;
...
void VtkRenderWindowWrap::GetUseOffScreenBuffers(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowWrap>(info.Holder());
	vtkRenderWindow *native = (vtkRenderWindow *)wrapper->native.GetPointer();
	bool r;
...
void VtkRenderWindowWrap::GetUseSRGBColorSpace(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowWrap>(info.Holder());
	vtkRenderWindow *native = (vtkRenderWindow *)wrapper->native.GetPointer();
	bool r;
...
void VtkRenderWindowWrap::SetUseOffScreenBuffers(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowWrap>(info.Holder());
	vtkRenderWindow *native = (vtkRenderWindow *)wrapper->native.GetPointer();
...
void VtkRenderWindowWrap::SetUseSRGBColorSpace(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowWrap>(info.Holder());
	vtkRenderWindow *native = (vtkRenderWindow *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
...
void VtkRenderWindowWrap::UseSRGBColorSpaceOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowWrap>(info.Holder());
	vtkRenderWindow *native = (vtkRenderWindow *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkRenderWindowWrap::UseSRGBColorSpaceOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkRenderWindowWrap>(info.Holder());
	vtkRenderWindow *native = (vtkRenderWindow *)wrapper->native.GetPointer();
		if(info.Length() != 0)
