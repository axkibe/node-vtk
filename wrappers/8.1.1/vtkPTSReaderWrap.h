...
class VtkPTSReaderWrap : public VtkPolyDataAlgorithmWrap
{
	...
	private:
		...
		static void CreateCellsOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void CreateCellsOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetCreateCells(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetFileName(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetIncludeColorAndLuminance(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void IncludeColorAndLuminanceOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void IncludeColorAndLuminanceOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetCreateCells(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetFileName(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetIncludeColorAndLuminance(const Nan::FunctionCallbackInfo<v8::Value>& info);
