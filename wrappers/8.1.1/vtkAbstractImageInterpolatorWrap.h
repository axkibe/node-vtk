...
class VtkAbstractImageInterpolatorWrap : public VtkObjectWrap
{
	...
	private:
		...
		static void GetSlidingWindow(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetSlidingWindow(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetTolerance(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SlidingWindowOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SlidingWindowOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
