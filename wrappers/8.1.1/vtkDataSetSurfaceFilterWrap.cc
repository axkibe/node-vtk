...
void VtkDataSetSurfaceFilterWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "StructuredWithBlankingExecute", StructuredWithBlankingExecute);
	Nan::SetPrototypeMethod(tpl, "structuredWithBlankingExecute", StructuredWithBlankingExecute);
...
void VtkDataSetSurfaceFilterWrap::StructuredWithBlankingExecute(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataSetSurfaceFilterWrap *wrapper = ObjectWrap::Unwrap<VtkDataSetSurfaceFilterWrap>(info.Holder());
	vtkDataSetSurfaceFilter *native = (vtkDataSetSurfaceFilter *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject() && (Nan::New(VtkStructuredGridWrap::ptpl))->HasInstance(info[0]))
	{
		...
		if(info.Length() > 1 && info[1]->IsObject() && (Nan::New(VtkPolyDataWrap::ptpl))->HasInstance(info[1]))
		{
			...
			r = native->StructuredWithBlankingExecute(
