...
class VtkQuadricDecimationWrap : public VtkPolyDataAlgorithmWrap
{
	...
	private:
		...
		static void GetVolumePreservation(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetVolumePreservation(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void VolumePreservationOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void VolumePreservationOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
