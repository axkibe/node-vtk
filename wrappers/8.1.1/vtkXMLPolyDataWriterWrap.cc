...
#ifdef VTK_NODE_PLUS_VTKXMLPOLYDATAWRITERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKXMLPOLYDATAWRITERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkXMLPolyDataWriterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkXMLPolyDataWriterWrap* obj = new VtkXMLPolyDataWriterWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
