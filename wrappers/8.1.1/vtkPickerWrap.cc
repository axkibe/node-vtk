...
void VtkPickerWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetCompositeDataSet", GetCompositeDataSet);
	Nan::SetPrototypeMethod(tpl, "getCompositeDataSet", GetCompositeDataSet);
...
void VtkPickerWrap::GetCompositeDataSet(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPickerWrap *wrapper = ObjectWrap::Unwrap<VtkPickerWrap>(info.Holder());
	vtkPicker *native = (vtkPicker *)wrapper->native.GetPointer();
...
void VtkPickerWrap::Pick3DPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPickerWrap *wrapper = ObjectWrap::Unwrap<VtkPickerWrap>(info.Holder());
	vtkPicker *native = (vtkPicker *)wrapper->native.GetPointer();
	size_t i;
...
void VtkPickerWrap::Pick3DRay(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPickerWrap *wrapper = ObjectWrap::Unwrap<VtkPickerWrap>(info.Holder());
	vtkPicker *native = (vtkPicker *)wrapper->native.GetPointer();
	size_t i;
