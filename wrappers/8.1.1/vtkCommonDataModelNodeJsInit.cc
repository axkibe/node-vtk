...
extern void vtkCommonDataModelNodeJsInit( v8::Local<v8::Object> exports )
{
	...
	VtkHyperTreeGridCursorWrap::Init( exports );
	...
	VtkLagrangeCurveWrap::Init( exports );
	VtkLagrangeHexahedronWrap::Init( exports );
	VtkLagrangeQuadrilateralWrap::Init( exports );
	VtkLagrangeTetraWrap::Init( exports );
	VtkLagrangeTriangleWrap::Init( exports );
	VtkLagrangeWedgeWrap::Init( exports );
