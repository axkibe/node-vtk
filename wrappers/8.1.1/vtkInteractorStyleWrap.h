...
class VtkInteractorStyleWrap : public VtkInteractorObserverWrap
{
	...
	private:
		...
		static void EndTwoPointer(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void OnFifthButtonDown(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void OnFifthButtonUp(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void OnFourthButtonDown(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void OnFourthButtonUp(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void OnLongTap(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void OnRotate(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void OnSwipe(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void OnTap(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void StartTwoPointer(const Nan::FunctionCallbackInfo<v8::Value>& info);
