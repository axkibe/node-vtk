...
#ifdef VTK_NODE_PLUS_VTKPARAMETRICENNEPERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPARAMETRICENNEPERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkParametricEnneperWrap::Evaluate(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkParametricEnneperWrap::EvaluateScalar(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricEnneperWrap *wrapper = ObjectWrap::Unwrap<VtkParametricEnneperWrap>(info.Holder());
	vtkParametricEnneper *native = (vtkParametricEnneper *)wrapper->native.GetPointer();
	size_t i;
