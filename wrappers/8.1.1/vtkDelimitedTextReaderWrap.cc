...
void VtkDelimitedTextReaderWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "AddTabFieldDelimiterOff", AddTabFieldDelimiterOff);
	Nan::SetPrototypeMethod(tpl, "addTabFieldDelimiterOff", AddTabFieldDelimiterOff);

	Nan::SetPrototypeMethod(tpl, "AddTabFieldDelimiterOn", AddTabFieldDelimiterOn);
	Nan::SetPrototypeMethod(tpl, "addTabFieldDelimiterOn", AddTabFieldDelimiterOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetAddTabFieldDelimiter", GetAddTabFieldDelimiter);
	Nan::SetPrototypeMethod(tpl, "getAddTabFieldDelimiter", GetAddTabFieldDelimiter);
	...
	Nan::SetPrototypeMethod(tpl, "SetAddTabFieldDelimiter", SetAddTabFieldDelimiter);
	Nan::SetPrototypeMethod(tpl, "setAddTabFieldDelimiter", SetAddTabFieldDelimiter);
...
void VtkDelimitedTextReaderWrap::AddTabFieldDelimiterOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	native->AddTabFieldDelimiterOff();
}

void VtkDelimitedTextReaderWrap::AddTabFieldDelimiterOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDelimitedTextReaderWrap *wrapper = ObjectWrap::Unwrap<VtkDelimitedTextReaderWrap>(info.Holder());
	vtkDelimitedTextReader *native = (vtkDelimitedTextReader *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkDelimitedTextReaderWrap::GetAddTabFieldDelimiter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDelimitedTextReaderWrap *wrapper = ObjectWrap::Unwrap<VtkDelimitedTextReaderWrap>(info.Holder());
	vtkDelimitedTextReader *native = (vtkDelimitedTextReader *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetAddTabFieldDelimiter();
...
void VtkDelimitedTextReaderWrap::SetAddTabFieldDelimiter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDelimitedTextReaderWrap *wrapper = ObjectWrap::Unwrap<VtkDelimitedTextReaderWrap>(info.Holder());
	vtkDelimitedTextReader *native = (vtkDelimitedTextReader *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
	{
		...
		native->SetAddTabFieldDelimiter(
			info[0]->BooleanValue()
		);
		return;
	}
