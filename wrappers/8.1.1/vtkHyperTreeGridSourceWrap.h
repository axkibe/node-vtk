...
class VtkHyperTreeGridSourceWrap : public VtkHyperTreeGridAlgorithmWrap
{
	...
	private:
		...
		static void GenerateInterfaceFieldsOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GenerateInterfaceFieldsOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetGenerateInterfaceFields(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetGenerateInterfaceFields(const Nan::FunctionCallbackInfo<v8::Value>& info);
