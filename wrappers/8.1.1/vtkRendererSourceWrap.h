...
class VtkRendererSourceWrap : public VtkAlgorithmWrap
{
	...
	private:
		...
		static void DepthValuesOnlyOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void DepthValuesOnlyOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetDepthValuesOnly(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetDepthValuesOnly(const Nan::FunctionCallbackInfo<v8::Value>& info);
