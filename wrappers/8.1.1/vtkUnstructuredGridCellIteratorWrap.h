...
#ifndef NATIVE_EXTENSION_VTK_VTKUNSTRUCTUREDGRIDCELLITERATORWRAP_H
#define NATIVE_EXTENSION_VTK_VTKUNSTRUCTUREDGRIDCELLITERATORWRAP_H
...
class VtkUnstructuredGridCellIteratorWrap : public VtkCellIteratorWrap
{
	public:
		...
		VtkUnstructuredGridCellIteratorWrap(vtkSmartPointer<vtkUnstructuredGridCellIterator>);
		VtkUnstructuredGridCellIteratorWrap();
		~VtkUnstructuredGridCellIteratorWrap( );
