...
void VtkMoleculeMapperWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetLatticeColor", GetLatticeColor);
	Nan::SetPrototypeMethod(tpl, "getLatticeColor", GetLatticeColor);
	...
	Nan::SetPrototypeMethod(tpl, "GetRenderLattice", GetRenderLattice);
	Nan::SetPrototypeMethod(tpl, "getRenderLattice", GetRenderLattice);
	...
	Nan::SetPrototypeMethod(tpl, "RenderLatticeOff", RenderLatticeOff);
	Nan::SetPrototypeMethod(tpl, "renderLatticeOff", RenderLatticeOff);

	Nan::SetPrototypeMethod(tpl, "RenderLatticeOn", RenderLatticeOn);
	Nan::SetPrototypeMethod(tpl, "renderLatticeOn", RenderLatticeOn);
	...
	Nan::SetPrototypeMethod(tpl, "SetAtomicRadiusTypeToCustomArrayRadius", SetAtomicRadiusTypeToCustomArrayRadius);
	Nan::SetPrototypeMethod(tpl, "setAtomicRadiusTypeToCustomArrayRadius", SetAtomicRadiusTypeToCustomArrayRadius);
	...
	Nan::SetPrototypeMethod(tpl, "SetLatticeColor", SetLatticeColor);
	Nan::SetPrototypeMethod(tpl, "setLatticeColor", SetLatticeColor);
	...
	Nan::SetPrototypeMethod(tpl, "SetRenderLattice", SetRenderLattice);
	Nan::SetPrototypeMethod(tpl, "setRenderLattice", SetRenderLattice);
...
void VtkMoleculeMapperWrap::GetLatticeColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMoleculeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMoleculeMapperWrap>(info.Holder());
	vtkMoleculeMapper *native = (vtkMoleculeMapper *)wrapper->native.GetPointer();
	unsigned char const * r;
...
void VtkMoleculeMapperWrap::GetRenderLattice(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMoleculeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMoleculeMapperWrap>(info.Holder());
	vtkMoleculeMapper *native = (vtkMoleculeMapper *)wrapper->native.GetPointer();
	bool r;
...
void VtkMoleculeMapperWrap::RenderLatticeOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMoleculeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMoleculeMapperWrap>(info.Holder());
	vtkMoleculeMapper *native = (vtkMoleculeMapper *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->RenderLatticeOff();
}

void VtkMoleculeMapperWrap::RenderLatticeOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMoleculeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMoleculeMapperWrap>(info.Holder());
	vtkMoleculeMapper *native = (vtkMoleculeMapper *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkMoleculeMapperWrap::SetAtomicRadiusTypeToCustomArrayRadius(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMoleculeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMoleculeMapperWrap>(info.Holder());
	vtkMoleculeMapper *native = (vtkMoleculeMapper *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->SetAtomicRadiusTypeToCustomArrayRadius();
}
...
void VtkMoleculeMapperWrap::SetLatticeColor(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMoleculeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMoleculeMapperWrap>(info.Holder());
	vtkMoleculeMapper *native = (vtkMoleculeMapper *)wrapper->native.GetPointer();
	size_t i;
...
void VtkMoleculeMapperWrap::SetRenderLattice(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMoleculeMapperWrap *wrapper = ObjectWrap::Unwrap<VtkMoleculeMapperWrap>(info.Holder());
	vtkMoleculeMapper *native = (vtkMoleculeMapper *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
