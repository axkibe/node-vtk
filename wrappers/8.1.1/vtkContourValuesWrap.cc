...
{
	Nan::SetAccessor(exports, Nan::New("vtkContourValues").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("ContourValues").ToLocalChecked(), ConstructorGetter);
}

void VtkContourValuesWrap::ConstructorGetter(
...
void VtkContourValuesWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKCONTOURVALUESWRAP_INITPTPL
	VTK_NODE_PLUS_VTKCONTOURVALUESWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkContourValuesWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkContourValuesWrap* obj = new VtkContourValuesWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
