...
{
	Nan::SetAccessor(exports, Nan::New("vtkPolyDataReader").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("PolyDataReader").ToLocalChecked(), ConstructorGetter);
}

void VtkPolyDataReaderWrap::ConstructorGetter(
...
void VtkPolyDataReaderWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKPOLYDATAREADERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPOLYDATAREADERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPolyDataReaderWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPolyDataReaderWrap* obj = new VtkPolyDataReaderWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkPolyDataReaderWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	VtkPolyDataReaderWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkPolyDataReaderWrap::ptpl)->GetFunction();
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
