...
class VtkDiscreteMarchingCubesWrap : public VtkMarchingCubesWrap
{
	...
	private:
		...
		static void ComputeAdjacentScalarsOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void ComputeAdjacentScalarsOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetComputeAdjacentScalars(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SafeDownCast(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetComputeAdjacentScalars(const Nan::FunctionCallbackInfo<v8::Value>& info);
