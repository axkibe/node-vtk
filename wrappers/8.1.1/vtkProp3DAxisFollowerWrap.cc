...
void VtkProp3DAxisFollowerWrap::GetScreenOffsetVector(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkProp3DAxisFollowerWrap *wrapper = ObjectWrap::Unwrap<VtkProp3DAxisFollowerWrap>(info.Holder());
	vtkProp3DAxisFollower *native = (vtkProp3DAxisFollower *)wrapper->native.GetPointer();
	double const * r;
...
void VtkProp3DAxisFollowerWrap::SetScreenOffsetVector(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkProp3DAxisFollowerWrap *wrapper = ObjectWrap::Unwrap<VtkProp3DAxisFollowerWrap>(info.Holder());
	vtkProp3DAxisFollower *native = (vtkProp3DAxisFollower *)wrapper->native.GetPointer();
	size_t i;
