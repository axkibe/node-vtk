...
class VtkMoleculeMapperWrap : public VtkMapperWrap
{
	...
	private:
		...
		static void GetLatticeColor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetRenderLattice(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void RenderLatticeOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void RenderLatticeOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetAtomicRadiusTypeToCustomArrayRadius(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetLatticeColor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetRenderLattice(const Nan::FunctionCallbackInfo<v8::Value>& info);
