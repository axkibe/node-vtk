...
void VtkLightWrap::GetInformation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLightWrap *wrapper = ObjectWrap::Unwrap<VtkLightWrap>(info.Holder());
	vtkLight *native = (vtkLight *)wrapper->native.GetPointer();
	vtkInformation * r;
...
void VtkLightWrap::SetInformation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkLightWrap *wrapper = ObjectWrap::Unwrap<VtkLightWrap>(info.Holder());
	vtkLight *native = (vtkLight *)wrapper->native.GetPointer();
