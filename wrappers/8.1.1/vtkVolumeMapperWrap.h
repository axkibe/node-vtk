...
class VtkVolumeMapperWrap : public VtkAbstractVolumeMapperWrap
{
	...
	private:
		...
		static void GetAverageIPScalarRange(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetAverageIPScalarRange(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetBlendModeToAverageIntensity(const Nan::FunctionCallbackInfo<v8::Value>& info);
...
#ifdef VTK_NODE_PLUS_VTKVOLUMEMAPPERWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKVOLUMEMAPPERWRAP_CLASSDEF
#endif
};
