...
class VtkAxisFollowerWrap : public VtkFollowerWrap
{
	...
	private:
		...
		static void GetScreenOffsetVector(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetScreenOffsetVector(const Nan::FunctionCallbackInfo<v8::Value>& info);
