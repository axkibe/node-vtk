...
class VtkUnstructuredGridGeometryFilterWrap : public VtkUnstructuredGridBaseAlgorithmWrap
{
	...
	private:
		...
		static void DuplicateGhostCellClippingOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void DuplicateGhostCellClippingOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetDuplicateGhostCellClipping(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetDuplicateGhostCellClipping(const Nan::FunctionCallbackInfo<v8::Value>& info);
