...
void VtkXMLReaderWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetColumnArraySelection", GetColumnArraySelection);
	Nan::SetPrototypeMethod(tpl, "getColumnArraySelection", GetColumnArraySelection);
...
void VtkXMLReaderWrap::GetColumnArrayName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXMLReaderWrap *wrapper = ObjectWrap::Unwrap<VtkXMLReaderWrap>(info.Holder());
	vtkXMLReader *native = (vtkXMLReader *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkXMLReaderWrap::GetColumnArraySelection(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXMLReaderWrap *wrapper = ObjectWrap::Unwrap<VtkXMLReaderWrap>(info.Holder());
	vtkXMLReader *native = (vtkXMLReader *)wrapper->native.GetPointer();
	vtkDataArraySelection * r;
	...
	r = native->GetColumnArraySelection();
	VtkDataArraySelectionWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
...
void VtkXMLReaderWrap::GetColumnArrayStatus(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXMLReaderWrap *wrapper = ObjectWrap::Unwrap<VtkXMLReaderWrap>(info.Holder());
	vtkXMLReader *native = (vtkXMLReader *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsString())
...
void VtkXMLReaderWrap::GetNumberOfColumnArrays(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXMLReaderWrap *wrapper = ObjectWrap::Unwrap<VtkXMLReaderWrap>(info.Holder());
	vtkXMLReader *native = (vtkXMLReader *)wrapper->native.GetPointer();
	int r;
...
void VtkXMLReaderWrap::SetColumnArrayStatus(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXMLReaderWrap *wrapper = ObjectWrap::Unwrap<VtkXMLReaderWrap>(info.Holder());
	vtkXMLReader *native = (vtkXMLReader *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsString())
