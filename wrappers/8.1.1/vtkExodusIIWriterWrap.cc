...
void VtkExodusIIWriterWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetIgnoreMetaDataWarning", GetIgnoreMetaDataWarning);
	Nan::SetPrototypeMethod(tpl, "getIgnoreMetaDataWarning", GetIgnoreMetaDataWarning);
	...
	Nan::SetPrototypeMethod(tpl, "IgnoreMetaDataWarningOff", IgnoreMetaDataWarningOff);
	Nan::SetPrototypeMethod(tpl, "ignoreMetaDataWarningOff", IgnoreMetaDataWarningOff);

	Nan::SetPrototypeMethod(tpl, "IgnoreMetaDataWarningOn", IgnoreMetaDataWarningOn);
	Nan::SetPrototypeMethod(tpl, "ignoreMetaDataWarningOn", IgnoreMetaDataWarningOn);
	...
	Nan::SetPrototypeMethod(tpl, "SetIgnoreMetaDataWarning", SetIgnoreMetaDataWarning);
	Nan::SetPrototypeMethod(tpl, "setIgnoreMetaDataWarning", SetIgnoreMetaDataWarning);
...
void VtkExodusIIWriterWrap::GetIgnoreMetaDataWarning(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkExodusIIWriterWrap *wrapper = ObjectWrap::Unwrap<VtkExodusIIWriterWrap>(info.Holder());
	vtkExodusIIWriter *native = (vtkExodusIIWriter *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetIgnoreMetaDataWarning();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkExodusIIWriterWrap::IgnoreMetaDataWarningOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkExodusIIWriterWrap *wrapper = ObjectWrap::Unwrap<VtkExodusIIWriterWrap>(info.Holder());
	vtkExodusIIWriter *native = (vtkExodusIIWriter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->IgnoreMetaDataWarningOff();
}

void VtkExodusIIWriterWrap::IgnoreMetaDataWarningOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkExodusIIWriterWrap *wrapper = ObjectWrap::Unwrap<VtkExodusIIWriterWrap>(info.Holder());
	vtkExodusIIWriter *native = (vtkExodusIIWriter *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->IgnoreMetaDataWarningOn();
}
...
void VtkExodusIIWriterWrap::SetIgnoreMetaDataWarning(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkExodusIIWriterWrap *wrapper = ObjectWrap::Unwrap<VtkExodusIIWriterWrap>(info.Holder());
	vtkExodusIIWriter *native = (vtkExodusIIWriter *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
	{
		...
		native->SetIgnoreMetaDataWarning(
			info[0]->BooleanValue()
		);
		return;
	}
