...
#ifdef VTK_NODE_PLUS_VTKGENERICSTREAMTRACERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKGENERICSTREAMTRACERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkGenericStreamTracerWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkGenericStreamTracerWrap* obj = new VtkGenericStreamTracerWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkGenericStreamTracerWrap::GetStartPosition(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkGenericStreamTracerWrap *wrapper = ObjectWrap::Unwrap<VtkGenericStreamTracerWrap>(info.Holder());
	vtkGenericStreamTracer *native = (vtkGenericStreamTracer *)wrapper->native.GetPointer();
	double const * r;
...
void VtkGenericStreamTracerWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkGenericStreamTracerWrap::ptpl)->GetFunction();
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
