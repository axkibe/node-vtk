...
class VtkXMLPDataWriterWrap : public VtkXMLPDataObjectWriterWrap
{
	public:
...
#ifdef VTK_NODE_PLUS_VTKXMLPDATAWRITERWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKXMLPDATAWRITERWRAP_CLASSDEF
#endif
};
