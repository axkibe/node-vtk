...
#ifdef VTK_NODE_PLUS_VTKHYPERTREEGRIDAXISCUTWRAP_INITPTPL
	VTK_NODE_PLUS_VTKHYPERTREEGRIDAXISCUTWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkHyperTreeGridAxisCutWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkHyperTreeGridAxisCutWrap* obj = new VtkHyperTreeGridAxisCutWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkHyperTreeGridAxisCutWrap::GetPlaneNormalAxisMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkHyperTreeGridAxisCutWrap *wrapper = ObjectWrap::Unwrap<VtkHyperTreeGridAxisCutWrap>(info.Holder());
	vtkHyperTreeGridAxisCut *native = (vtkHyperTreeGridAxisCut *)wrapper->native.GetPointer();
	int r;
...
void VtkHyperTreeGridAxisCutWrap::GetPlaneNormalAxisMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkHyperTreeGridAxisCutWrap *wrapper = ObjectWrap::Unwrap<VtkHyperTreeGridAxisCutWrap>(info.Holder());
	vtkHyperTreeGridAxisCut *native = (vtkHyperTreeGridAxisCut *)wrapper->native.GetPointer();
	int r;
