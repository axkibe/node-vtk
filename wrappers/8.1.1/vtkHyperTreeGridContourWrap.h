...
#ifndef NATIVE_EXTENSION_VTK_VTKHYPERTREEGRIDCONTOURWRAP_H
#define NATIVE_EXTENSION_VTK_VTKHYPERTREEGRIDCONTOURWRAP_H
...
class VtkHyperTreeGridContourWrap : public VtkHyperTreeGridAlgorithmWrap
{
	public:
		...
		VtkHyperTreeGridContourWrap(vtkSmartPointer<vtkHyperTreeGridContour>);
		VtkHyperTreeGridContourWrap();
		~VtkHyperTreeGridContourWrap( );
...
#ifdef VTK_NODE_PLUS_VTKHYPERTREEGRIDCONTOURWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKHYPERTREEGRIDCONTOURWRAP_CLASSDEF
#endif
};
