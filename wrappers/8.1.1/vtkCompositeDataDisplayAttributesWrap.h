...
class VtkCompositeDataDisplayAttributesWrap : public VtkObjectWrap
{
	...
	private:
		...
		static void HasBlockMaterial(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void HasBlockMaterials(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void RemoveBlockMaterial(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void RemoveBlockMaterials(const Nan::FunctionCallbackInfo<v8::Value>& info);
