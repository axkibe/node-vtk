...
#ifndef NATIVE_EXTENSION_VTK_VTKTRIQUADRATICHEXAHEDRONWRAP_H
#define NATIVE_EXTENSION_VTK_VTKTRIQUADRATICHEXAHEDRONWRAP_H
...
class VtkTriQuadraticHexahedronWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkTriQuadraticHexahedronWrap(vtkSmartPointer<vtkTriQuadraticHexahedron>);
		VtkTriQuadraticHexahedronWrap();
		~VtkTriQuadraticHexahedronWrap( );
...
#ifdef VTK_NODE_PLUS_VTKTRIQUADRATICHEXAHEDRONWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKTRIQUADRATICHEXAHEDRONWRAP_CLASSDEF
#endif
};
