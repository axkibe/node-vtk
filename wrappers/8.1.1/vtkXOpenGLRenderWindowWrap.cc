...
void VtkXOpenGLRenderWindowWrap::PopContext(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXOpenGLRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkXOpenGLRenderWindowWrap>(info.Holder());
	vtkXOpenGLRenderWindow *native = (vtkXOpenGLRenderWindow *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkXOpenGLRenderWindowWrap::PushContext(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXOpenGLRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkXOpenGLRenderWindowWrap>(info.Holder());
	vtkXOpenGLRenderWindow *native = (vtkXOpenGLRenderWindow *)wrapper->native.GetPointer();
		if(info.Length() != 0)
...
void VtkXOpenGLRenderWindowWrap::SetSwapControl(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkXOpenGLRenderWindowWrap *wrapper = ObjectWrap::Unwrap<VtkXOpenGLRenderWindowWrap>(info.Holder());
	vtkXOpenGLRenderWindow *native = (vtkXOpenGLRenderWindow *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
