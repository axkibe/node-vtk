...
void VtkHyperTreeGridSourceWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GenerateInterfaceFieldsOff", GenerateInterfaceFieldsOff);
	Nan::SetPrototypeMethod(tpl, "generateInterfaceFieldsOff", GenerateInterfaceFieldsOff);

	Nan::SetPrototypeMethod(tpl, "GenerateInterfaceFieldsOn", GenerateInterfaceFieldsOn);
	Nan::SetPrototypeMethod(tpl, "generateInterfaceFieldsOn", GenerateInterfaceFieldsOn);
	...
	Nan::SetPrototypeMethod(tpl, "GetGenerateInterfaceFields", GetGenerateInterfaceFields);
	Nan::SetPrototypeMethod(tpl, "getGenerateInterfaceFields", GetGenerateInterfaceFields);
	...
	Nan::SetPrototypeMethod(tpl, "SetGenerateInterfaceFields", SetGenerateInterfaceFields);
	Nan::SetPrototypeMethod(tpl, "setGenerateInterfaceFields", SetGenerateInterfaceFields);
...
void VtkHyperTreeGridSourceWrap::GenerateInterfaceFieldsOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	native->GenerateInterfaceFieldsOff();
}

void VtkHyperTreeGridSourceWrap::GenerateInterfaceFieldsOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkHyperTreeGridSourceWrap *wrapper = ObjectWrap::Unwrap<VtkHyperTreeGridSourceWrap>(info.Holder());
	vtkHyperTreeGridSource *native = (vtkHyperTreeGridSource *)wrapper->native.GetPointer();
		if(info.Length() != 0)
	...
	native->GenerateInterfaceFieldsOn();
}
...
void VtkHyperTreeGridSourceWrap::GetGenerateInterfaceFields(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkHyperTreeGridSourceWrap *wrapper = ObjectWrap::Unwrap<VtkHyperTreeGridSourceWrap>(info.Holder());
	vtkHyperTreeGridSource *native = (vtkHyperTreeGridSource *)wrapper->native.GetPointer();
	bool r;
	...
	r = native->GetGenerateInterfaceFields();
	info.GetReturnValue().Set(Nan::New(r));
}
...
void VtkHyperTreeGridSourceWrap::GetOrientation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkHyperTreeGridSourceWrap *wrapper = ObjectWrap::Unwrap<VtkHyperTreeGridSourceWrap>(info.Holder());
	vtkHyperTreeGridSource *native = (vtkHyperTreeGridSource *)wrapper->native.GetPointer();
	unsigned int r;
...
void VtkHyperTreeGridSourceWrap::SetGenerateInterfaceFields(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkHyperTreeGridSourceWrap *wrapper = ObjectWrap::Unwrap<VtkHyperTreeGridSourceWrap>(info.Holder());
	vtkHyperTreeGridSource *native = (vtkHyperTreeGridSource *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsBoolean())
	{
		...
		native->SetGenerateInterfaceFields(
			info[0]->BooleanValue()
		);
		return;
	}
...
void VtkHyperTreeGridSourceWrap::SetOrientation(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkHyperTreeGridSourceWrap *wrapper = ObjectWrap::Unwrap<VtkHyperTreeGridSourceWrap>(info.Holder());
	vtkHyperTreeGridSource *native = (vtkHyperTreeGridSource *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsUint32())
