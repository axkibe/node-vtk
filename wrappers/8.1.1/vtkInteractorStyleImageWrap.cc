...
void VtkInteractorStyleImageWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetCurrentImageNumber", GetCurrentImageNumber);
	Nan::SetPrototypeMethod(tpl, "getCurrentImageNumber", GetCurrentImageNumber);
	...
	Nan::SetPrototypeMethod(tpl, "SetCurrentImageNumber", SetCurrentImageNumber);
	Nan::SetPrototypeMethod(tpl, "setCurrentImageNumber", SetCurrentImageNumber);
...
void VtkInteractorStyleImageWrap::GetCurrentImageNumber(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkInteractorStyleImageWrap *wrapper = ObjectWrap::Unwrap<VtkInteractorStyleImageWrap>(info.Holder());
	vtkInteractorStyleImage *native = (vtkInteractorStyleImage *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetCurrentImageNumber();
...
void VtkInteractorStyleImageWrap::SetCurrentImageNumber(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkInteractorStyleImageWrap *wrapper = ObjectWrap::Unwrap<VtkInteractorStyleImageWrap>(info.Holder());
	vtkInteractorStyleImage *native = (vtkInteractorStyleImage *)wrapper->native.GetPointer();
