...
void VtkParametricRandomHillsWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GetAllowRandomGenerationMaxValue", GetAllowRandomGenerationMaxValue);
	Nan::SetPrototypeMethod(tpl, "getAllowRandomGenerationMaxValue", GetAllowRandomGenerationMaxValue);

	Nan::SetPrototypeMethod(tpl, "GetAllowRandomGenerationMinValue", GetAllowRandomGenerationMinValue);
	Nan::SetPrototypeMethod(tpl, "getAllowRandomGenerationMinValue", GetAllowRandomGenerationMinValue);
...
#ifdef VTK_NODE_PLUS_VTKPARAMETRICRANDOMHILLSWRAP_INITPTPL
...
void VtkParametricRandomHillsWrap::GetAllowRandomGenerationMaxValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricRandomHillsWrap *wrapper = ObjectWrap::Unwrap<VtkParametricRandomHillsWrap>(info.Holder());
	vtkParametricRandomHills *native = (vtkParametricRandomHills *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetAllowRandomGenerationMaxValue();
	info.GetReturnValue().Set(Nan::New(r));
}

void VtkParametricRandomHillsWrap::GetAllowRandomGenerationMinValue(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricRandomHillsWrap *wrapper = ObjectWrap::Unwrap<VtkParametricRandomHillsWrap>(info.Holder());
	vtkParametricRandomHills *native = (vtkParametricRandomHills *)wrapper->native.GetPointer();
	int r;
	...
	r = native->GetAllowRandomGenerationMinValue();
	info.GetReturnValue().Set(Nan::New(r));
}
