...
class VtkCameraWrap : public VtkObjectWrap
{
	...
	private:
		...
		static void GetExplicitProjectionTransformMatrix(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetUseExplicitProjectionTransformMatrix(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetUseScissor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetExplicitProjectionTransformMatrix(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetUseExplicitProjectionTransformMatrix(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetUseScissor(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void UseExplicitProjectionTransformMatrixOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void UseExplicitProjectionTransformMatrixOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
