...
class VtkDataWriterWrap : public VtkWriterWrap
{
	...
	private:
		...
		static void GetEdgeFlagsName(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetWriteArrayMetaData(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetEdgeFlagsName(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetWriteArrayMetaData(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetWriteToOutputString(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void WriteArrayMetaDataOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void WriteArrayMetaDataOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
