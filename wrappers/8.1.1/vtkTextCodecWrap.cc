...
#ifdef VTK_NODE_PLUS_VTKTEXTCODECWRAP_INITPTPL
	VTK_NODE_PLUS_VTKTEXTCODECWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkTextCodecWrap::CanHandle(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
