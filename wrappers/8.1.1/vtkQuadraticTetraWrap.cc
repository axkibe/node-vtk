...
#ifdef VTK_NODE_PLUS_VTKQUADRATICTETRAWRAP_INITPTPL
	VTK_NODE_PLUS_VTKQUADRATICTETRAWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkQuadraticTetraWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkQuadraticTetraWrap* obj = new VtkQuadraticTetraWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkQuadraticTetraWrap::CellBoundary(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkQuadraticTetraWrap::GetParametricCenter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticTetraWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticTetraWrap>(info.Holder());
	vtkQuadraticTetra *native = (vtkQuadraticTetra *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticTetraWrap::GetParametricDistance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticTetraWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticTetraWrap>(info.Holder());
	vtkQuadraticTetra *native = (vtkQuadraticTetra *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticTetraWrap::InterpolateDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticTetraWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticTetraWrap>(info.Holder());
	vtkQuadraticTetra *native = (vtkQuadraticTetra *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticTetraWrap::InterpolateFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticTetraWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticTetraWrap>(info.Holder());
	vtkQuadraticTetra *native = (vtkQuadraticTetra *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticTetraWrap::InterpolationDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticTetraWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticTetraWrap>(info.Holder());
	vtkQuadraticTetra *native = (vtkQuadraticTetra *)wrapper->native.GetPointer();
	size_t i;
...
void VtkQuadraticTetraWrap::InterpolationFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkQuadraticTetraWrap *wrapper = ObjectWrap::Unwrap<VtkQuadraticTetraWrap>(info.Holder());
	vtkQuadraticTetra *native = (vtkQuadraticTetra *)wrapper->native.GetPointer();
	size_t i;
