...
#ifdef VTK_NODE_PLUS_VTKASSIGNATTRIBUTEWRAP_INITPTPL
	VTK_NODE_PLUS_VTKASSIGNATTRIBUTEWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkAssignAttributeWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkAssignAttributeWrap* obj = new VtkAssignAttributeWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
