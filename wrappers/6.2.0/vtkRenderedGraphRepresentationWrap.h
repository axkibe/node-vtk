...
class VtkRenderedGraphRepresentationWrap : public VtkRenderedRepresentationWrap
{
	...
	private:
		...
		static void GetColorVerticesByArray(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetEdgeIconVisibility(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetUseEdgeIconTypeMap(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void GetUseVertexIconTypeMap(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void GetVertexIconVisibility(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetColorVerticesByArray(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetEdgeIconVisibility(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetUseEdgeIconTypeMap(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void SetUseVertexIconTypeMap(const Nan::FunctionCallbackInfo<v8::Value>& info);
		...
		static void SetVertexIconVisibility(const Nan::FunctionCallbackInfo<v8::Value>& info);
