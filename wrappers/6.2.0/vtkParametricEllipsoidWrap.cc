...
#ifdef VTK_NODE_PLUS_VTKPARAMETRICELLIPSOIDWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPARAMETRICELLIPSOIDWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkParametricEllipsoidWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkParametricEllipsoidWrap* obj = new VtkParametricEllipsoidWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkParametricEllipsoidWrap::Evaluate(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkParametricEllipsoidWrap::EvaluateScalar(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricEllipsoidWrap *wrapper = ObjectWrap::Unwrap<VtkParametricEllipsoidWrap>(info.Holder());
	vtkParametricEllipsoid *native = (vtkParametricEllipsoid *)wrapper->native.GetPointer();
	size_t i;
