...
void VtkMeshQualityWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMeshQualityWrap *wrapper = ObjectWrap::Unwrap<VtkMeshQualityWrap>(info.Holder());
	vtkMeshQuality *native = (vtkMeshQuality *)wrapper->native.GetPointer();
	char const * r;
...
void VtkMeshQualityWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkMeshQualityWrap *wrapper = ObjectWrap::Unwrap<VtkMeshQualityWrap>(info.Holder());
	vtkMeshQuality *native = (vtkMeshQuality *)wrapper->native.GetPointer();
