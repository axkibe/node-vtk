...
#ifdef VTK_NODE_PLUS_VTKACTOR2DWRAP_INITPTPL
	VTK_NODE_PLUS_VTKACTOR2DWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkActor2DWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkActor2DWrap* obj = new VtkActor2DWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkActor2DWrap::GetPosition(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkActor2DWrap *wrapper = ObjectWrap::Unwrap<VtkActor2DWrap>(info.Holder());
	vtkActor2D *native = (vtkActor2D *)wrapper->native.GetPointer();
	double const * r;
...
void VtkActor2DWrap::GetPosition2(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkActor2DWrap *wrapper = ObjectWrap::Unwrap<VtkActor2DWrap>(info.Holder());
	vtkActor2D *native = (vtkActor2D *)wrapper->native.GetPointer();
	double const * r;
