...
class VtkFrameBufferObject2Wrap : public VtkObjectWrap
{
	...
	private:
		...
		static void AddColorAttachment(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void AddDepthAttachment(const Nan::FunctionCallbackInfo<v8::Value>& info);
