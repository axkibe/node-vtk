...
#ifdef VTK_NODE_PLUS_VTKMAPPERCOLLECTIONWRAP_INITPTPL
	VTK_NODE_PLUS_VTKMAPPERCOLLECTIONWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkMapperCollectionWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkMapperCollectionWrap* obj = new VtkMapperCollectionWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
