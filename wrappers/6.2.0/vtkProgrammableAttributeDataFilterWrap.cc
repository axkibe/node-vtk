...
#ifdef VTK_NODE_PLUS_VTKPROGRAMMABLEATTRIBUTEDATAFILTERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPROGRAMMABLEATTRIBUTEDATAFILTERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkProgrammableAttributeDataFilterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkProgrammableAttributeDataFilterWrap* obj = new VtkProgrammableAttributeDataFilterWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
