...
{
	Nan::SetAccessor(exports, Nan::New("vtkImageWrapPad").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("ImageWrapPad").ToLocalChecked(), ConstructorGetter);
}

void VtkImageWrapPadWrap::ConstructorGetter(
...
void VtkImageWrapPadWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKIMAGEWRAPPADWRAP_INITPTPL
	VTK_NODE_PLUS_VTKIMAGEWRAPPADWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkImageWrapPadWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkImageWrapPadWrap* obj = new VtkImageWrapPadWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkImageWrapPadWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	VtkImageWrapPadWrap::InitPtpl();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkImageWrapPadWrap::ptpl)->GetFunction();
