...
#ifdef VTK_NODE_PLUS_VTKPOLYDATATOIMAGESTENCILWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPOLYDATATOIMAGESTENCILWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkPolyDataToImageStencilWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPolyDataToImageStencilWrap* obj = new VtkPolyDataToImageStencilWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
