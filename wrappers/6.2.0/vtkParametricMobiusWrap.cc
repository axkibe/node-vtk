...
#ifdef VTK_NODE_PLUS_VTKPARAMETRICMOBIUSWRAP_INITPTPL
	VTK_NODE_PLUS_VTKPARAMETRICMOBIUSWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkParametricMobiusWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkParametricMobiusWrap* obj = new VtkParametricMobiusWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkParametricMobiusWrap::Evaluate(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkParametricMobiusWrap::EvaluateScalar(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParametricMobiusWrap *wrapper = ObjectWrap::Unwrap<VtkParametricMobiusWrap>(info.Holder());
	vtkParametricMobius *native = (vtkParametricMobius *)wrapper->native.GetPointer();
	size_t i;
