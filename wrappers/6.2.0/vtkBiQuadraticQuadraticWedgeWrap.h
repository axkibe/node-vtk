...
#ifndef NATIVE_EXTENSION_VTK_VTKBIQUADRATICQUADRATICWEDGEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKBIQUADRATICQUADRATICWEDGEWRAP_H
...
class VtkBiQuadraticQuadraticWedgeWrap : public VtkNonLinearCellWrap
{
	public:
		...
		VtkBiQuadraticQuadraticWedgeWrap(vtkSmartPointer<vtkBiQuadraticQuadraticWedge>);
		VtkBiQuadraticQuadraticWedgeWrap();
		~VtkBiQuadraticQuadraticWedgeWrap( );
...
#ifdef VTK_NODE_PLUS_VTKBIQUADRATICQUADRATICWEDGEWRAP_CLASSDEF
		VTK_NODE_PLUS_VTKBIQUADRATICQUADRATICWEDGEWRAP_CLASSDEF
#endif
};
