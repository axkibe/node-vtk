...
{
	Nan::SetAccessor(exports, Nan::New("vtkOrientedPolygonalHandleRepresentation3D").ToLocalChecked(), ConstructorGetter);
	Nan::SetAccessor(exports, Nan::New("OrientedPolygonalHandleRepresentation3D").ToLocalChecked(), ConstructorGetter);
}

void VtkOrientedPolygonalHandleRepresentation3DWrap::ConstructorGetter(
...
void VtkOrientedPolygonalHandleRepresentation3DWrap::InitPtpl()
{
...
#ifdef VTK_NODE_PLUS_VTKORIENTEDPOLYGONALHANDLEREPRESENTATION3DWRAP_INITPTPL
	VTK_NODE_PLUS_VTKORIENTEDPOLYGONALHANDLEREPRESENTATION3DWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
