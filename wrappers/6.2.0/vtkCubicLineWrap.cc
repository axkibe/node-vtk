...
#ifdef VTK_NODE_PLUS_VTKCUBICLINEWRAP_INITPTPL
	VTK_NODE_PLUS_VTKCUBICLINEWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkCubicLineWrap::CellBoundary(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkCubicLineWrap::GetParametricCenter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCubicLineWrap *wrapper = ObjectWrap::Unwrap<VtkCubicLineWrap>(info.Holder());
	vtkCubicLine *native = (vtkCubicLine *)wrapper->native.GetPointer();
	size_t i;
...
void VtkCubicLineWrap::GetParametricDistance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCubicLineWrap *wrapper = ObjectWrap::Unwrap<VtkCubicLineWrap>(info.Holder());
	vtkCubicLine *native = (vtkCubicLine *)wrapper->native.GetPointer();
	size_t i;
...
void VtkCubicLineWrap::InterpolateDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCubicLineWrap *wrapper = ObjectWrap::Unwrap<VtkCubicLineWrap>(info.Holder());
	vtkCubicLine *native = (vtkCubicLine *)wrapper->native.GetPointer();
	size_t i;
...
void VtkCubicLineWrap::InterpolateFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCubicLineWrap *wrapper = ObjectWrap::Unwrap<VtkCubicLineWrap>(info.Holder());
	vtkCubicLine *native = (vtkCubicLine *)wrapper->native.GetPointer();
	size_t i;
...
void VtkCubicLineWrap::InterpolationDerivs(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCubicLineWrap *wrapper = ObjectWrap::Unwrap<VtkCubicLineWrap>(info.Holder());
	vtkCubicLine *native = (vtkCubicLine *)wrapper->native.GetPointer();
	size_t i;
...
void VtkCubicLineWrap::InterpolationFunctions(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkCubicLineWrap *wrapper = ObjectWrap::Unwrap<VtkCubicLineWrap>(info.Holder());
	vtkCubicLine *native = (vtkCubicLine *)wrapper->native.GetPointer();
	size_t i;
