...
#ifdef VTK_NODE_PLUS_VTKSQLITETOTABLEREADERWRAP_INITPTPL
	VTK_NODE_PLUS_VTKSQLITETOTABLEREADERWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkSQLiteToTableReaderWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkSQLiteToTableReaderWrap* obj = new VtkSQLiteToTableReaderWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
