...
#ifdef VTK_NODE_PLUS_VTKTHINPLATESPLINETRANSFORMWRAP_INITPTPL
	VTK_NODE_PLUS_VTKTHINPLATESPLINETRANSFORMWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkThinPlateSplineTransformWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkThinPlateSplineTransformWrap* obj = new VtkThinPlateSplineTransformWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
...
void VtkThinPlateSplineTransformWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::FunctionTemplate>(VtkThinPlateSplineTransformWrap::ptpl)->GetFunction();
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
