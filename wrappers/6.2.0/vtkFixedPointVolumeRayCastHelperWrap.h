...
#ifndef NATIVE_EXTENSION_VTK_VTKFIXEDPOINTVOLUMERAYCASTHELPERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKFIXEDPOINTVOLUMERAYCASTHELPERWRAP_H
...
class VtkFixedPointVolumeRayCastHelperWrap : public VtkObjectWrap
{
	public:
		...
		VtkFixedPointVolumeRayCastHelperWrap(vtkSmartPointer<vtkFixedPointVolumeRayCastHelper>);
		VtkFixedPointVolumeRayCastHelperWrap();
		~VtkFixedPointVolumeRayCastHelperWrap( );
