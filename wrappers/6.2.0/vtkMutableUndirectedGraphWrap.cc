...
#ifdef VTK_NODE_PLUS_VTKMUTABLEUNDIRECTEDGRAPHWRAP_INITPTPL
	VTK_NODE_PLUS_VTKMUTABLEUNDIRECTEDGRAPHWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkMutableUndirectedGraphWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkMutableUndirectedGraphWrap* obj = new VtkMutableUndirectedGraphWrap(native);
		obj->Wrap(info.This());
	}
	else
	{
