...
void VtkDataSetWrap::InitPtpl()
{
	...
	Nan::SetPrototypeMethod(tpl, "GenerateGhostLevelArray", GenerateGhostLevelArray);
	Nan::SetPrototypeMethod(tpl, "generateGhostLevelArray", GenerateGhostLevelArray);
...
void VtkDataSetWrap::GenerateGhostLevelArray(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataSetWrap *wrapper = ObjectWrap::Unwrap<VtkDataSetWrap>(info.Holder());
	vtkDataSet *native = (vtkDataSet *)wrapper->native.GetPointer();
	size_t i;
	if(info.Length() > 0 && info[0]->IsInt32Array())
	{
		...
		native->GenerateGhostLevelArray(
