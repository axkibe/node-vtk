...
#ifdef VTK_NODE_PLUS_VTKSPHEREWRAP_INITPTPL
	VTK_NODE_PLUS_VTKSPHEREWRAP_INITPTPL
#endif
	ptpl.Reset( tpl );
}
...
void VtkSphereWrap::GetCenter(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkSphereWrap *wrapper = ObjectWrap::Unwrap<VtkSphereWrap>(info.Holder());
	vtkSphere *native = (vtkSphere *)wrapper->native.GetPointer();
	double const * r;
