...
#ifndef NATIVE_EXTENSION_VTK_VTKCIRCULARLAYOUTSTRATEGYWRAP_H
#define NATIVE_EXTENSION_VTK_VTKCIRCULARLAYOUTSTRATEGYWRAP_H
...
class VtkCircularLayoutStrategyWrap : public VtkGraphLayoutStrategyWrap
{
	public:
		...
		VtkCircularLayoutStrategyWrap(vtkSmartPointer<vtkCircularLayoutStrategy>);
		VtkCircularLayoutStrategyWrap();
		~VtkCircularLayoutStrategyWrap( );
