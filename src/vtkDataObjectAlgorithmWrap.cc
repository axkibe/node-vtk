...
Nan::Persistent<v8::Function> VtkDataObjectAlgorithmWrap::constructor;
...
void VtkDataObjectAlgorithmWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkDataObjectAlgorithm").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("DataObjectAlgorithm").ToLocalChecked(),tpl->GetFunction());
}

void VtkDataObjectAlgorithmWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkDataObjectAlgorithmWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkDataObjectAlgorithmWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
