...
void VtkLogoWidgetWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkLogoWidget").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("LogoWidget").ToLocalChecked(),tpl->GetFunction());
}

void VtkLogoWidgetWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
