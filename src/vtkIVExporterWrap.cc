...
void VtkIVExporterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkIVExporter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("IVExporter").ToLocalChecked(),tpl->GetFunction());
}

void VtkIVExporterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkIVExporterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkIVExporterWrap* obj = new VtkIVExporterWrap(native);		obj->Wrap(info.This());
	}
	else
	{
