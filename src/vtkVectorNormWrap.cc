...
void VtkVectorNormWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkVectorNorm").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("VectorNorm").ToLocalChecked(),tpl->GetFunction());
}

void VtkVectorNormWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkVectorNormWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkVectorNormWrap* obj = new VtkVectorNormWrap(native);		obj->Wrap(info.This());
	}
	else
	{
