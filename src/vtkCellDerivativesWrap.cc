...
Nan::Persistent<v8::Function> VtkCellDerivativesWrap::constructor;
...
void VtkCellDerivativesWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkCellDerivatives").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("CellDerivatives").ToLocalChecked(),tpl->GetFunction());
}

void VtkCellDerivativesWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkCellDerivativesWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkCellDerivativesWrap* obj = new VtkCellDerivativesWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkCellDerivativesWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkCellDerivativesWrap::constructor);
