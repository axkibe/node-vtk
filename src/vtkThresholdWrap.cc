...
void VtkThresholdWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkThreshold").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Threshold").ToLocalChecked(),tpl->GetFunction());
}

void VtkThresholdWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
