...
void VtkImageActorWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkImageSliceWrap::InitTpl(tpl);
	InitTpl(tpl);

	constructor.Reset( tpl->GetFunction() );

	exports->Set(Nan::New("vtkImageActor").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ImageActor").ToLocalChecked(),tpl->GetFunction());
}

void VtkImageActorWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
