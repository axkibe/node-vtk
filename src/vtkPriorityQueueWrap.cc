...
void VtkPriorityQueueWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkPriorityQueue").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("PriorityQueue").ToLocalChecked(),tpl->GetFunction());
}

void VtkPriorityQueueWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
