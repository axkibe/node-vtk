...
Nan::Persistent<v8::Function> VtkApproximatingSubdivisionFilterWrap::constructor;
...
void VtkApproximatingSubdivisionFilterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkApproximatingSubdivisionFilter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ApproximatingSubdivisionFilter").ToLocalChecked(),tpl->GetFunction());
}

void VtkApproximatingSubdivisionFilterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkApproximatingSubdivisionFilterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkApproximatingSubdivisionFilterWrap::constructor);
