...
Nan::Persistent<v8::Function> VtkKMeansDistanceFunctorWrap::constructor;
...
void VtkKMeansDistanceFunctorWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkKMeansDistanceFunctorWrap* obj = new VtkKMeansDistanceFunctorWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkKMeansDistanceFunctorWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkKMeansDistanceFunctorWrap *wrapper = ObjectWrap::Unwrap<VtkKMeansDistanceFunctorWrap>(info.Holder());
	vtkKMeansDistanceFunctor *native = (vtkKMeansDistanceFunctor *)wrapper->native.GetPointer();
	char const * r;
...
void VtkKMeansDistanceFunctorWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkKMeansDistanceFunctorWrap *wrapper = ObjectWrap::Unwrap<VtkKMeansDistanceFunctorWrap>(info.Holder());
	vtkKMeansDistanceFunctor *native = (vtkKMeansDistanceFunctor *)wrapper->native.GetPointer();
...
void VtkKMeansDistanceFunctorWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkKMeansDistanceFunctorWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
