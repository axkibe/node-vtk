...
Nan::Persistent<v8::Function> VtkIconGlyphFilterWrap::constructor;
...
void VtkIconGlyphFilterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkIconGlyphFilter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("IconGlyphFilter").ToLocalChecked(),tpl->GetFunction());
}

void VtkIconGlyphFilterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkIconGlyphFilterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkIconGlyphFilterWrap::constructor);
