...
Nan::Persistent<v8::Function> VtkPixelWrap::constructor;
...
void VtkPixelWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkPixel").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Pixel").ToLocalChecked(),tpl->GetFunction());
}

void VtkPixelWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkPixelWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkPixelWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
