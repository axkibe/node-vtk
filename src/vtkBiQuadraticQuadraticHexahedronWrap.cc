...
void VtkBiQuadraticQuadraticHexahedronWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkBiQuadraticQuadraticHexahedron").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("BiQuadraticQuadraticHexahedron").ToLocalChecked(),tpl->GetFunction());
}

void VtkBiQuadraticQuadraticHexahedronWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
