...
Nan::Persistent<v8::Function> VtkIdTypeArrayWrap::constructor;
...
void VtkIdTypeArrayWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkIdTypeArray").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("IdTypeArray").ToLocalChecked(),tpl->GetFunction());
}

void VtkIdTypeArrayWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
