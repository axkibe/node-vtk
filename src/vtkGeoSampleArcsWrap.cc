...
void VtkGeoSampleArcsWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkGeoSampleArcs").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("GeoSampleArcs").ToLocalChecked(),tpl->GetFunction());
}

void VtkGeoSampleArcsWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkGeoSampleArcsWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkGeoSampleArcsWrap* obj = new VtkGeoSampleArcsWrap(native);		obj->Wrap(info.This());
	}
	else
	{
