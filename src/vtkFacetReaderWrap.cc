...
Nan::Persistent<v8::Function> VtkFacetReaderWrap::constructor;
...
void VtkFacetReaderWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkFacetReader").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("FacetReader").ToLocalChecked(),tpl->GetFunction());
}

void VtkFacetReaderWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkFacetReaderWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkFacetReaderWrap::constructor);
