...
Nan::Persistent<v8::Function> VtkKMeansStatisticsWrap::constructor;
...
void VtkKMeansStatisticsWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkKMeansStatisticsWrap* obj = new VtkKMeansStatisticsWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkKMeansStatisticsWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkKMeansStatisticsWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
