...
void VtkTrivialProducerWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkTrivialProducer").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("TrivialProducer").ToLocalChecked(),tpl->GetFunction());
}

void VtkTrivialProducerWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
