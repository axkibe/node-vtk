...
#ifndef NATIVE_EXTENSION_VTK_VTKMETAIMAGEWRITERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKMETAIMAGEWRITERWRAP_H
...
class VtkMetaImageWriterWrap : public VtkImageWriterWrap
{
	...
	private:
		...
		static void GetRAWFileName(const Nan::FunctionCallbackInfo<v8::Value>& info);
