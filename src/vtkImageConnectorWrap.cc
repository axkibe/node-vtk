...
Nan::Persistent<v8::Function> VtkImageConnectorWrap::constructor;
...
void VtkImageConnectorWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkImageConnector").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ImageConnector").ToLocalChecked(),tpl->GetFunction());
}

void VtkImageConnectorWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
