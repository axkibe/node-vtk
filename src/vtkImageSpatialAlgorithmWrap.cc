...
Nan::Persistent<v8::Function> VtkImageSpatialAlgorithmWrap::constructor;
...
void VtkImageSpatialAlgorithmWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkImageSpatialAlgorithm").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ImageSpatialAlgorithm").ToLocalChecked(),tpl->GetFunction());
}

void VtkImageSpatialAlgorithmWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkImageSpatialAlgorithmWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkImageSpatialAlgorithmWrap::constructor);
