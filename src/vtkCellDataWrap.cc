...
Nan::Persistent<v8::Function> VtkCellDataWrap::constructor;
...
void VtkCellDataWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkFieldDataWrap::InitTpl(tpl);
	VtkDataSetAttributesWrap::InitTpl(tpl);
	InitTpl(tpl);

	constructor.Reset( tpl->GetFunction() );

	exports->Set(Nan::New("vtkCellData").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("CellData").ToLocalChecked(),tpl->GetFunction());
}

void VtkCellDataWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
