...
Nan::Persistent<v8::Function> VtkPixelBufferObjectWrap::constructor;
...
void VtkPixelBufferObjectWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPixelBufferObjectWrap* obj = new VtkPixelBufferObjectWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkPixelBufferObjectWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkPixelBufferObjectWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
