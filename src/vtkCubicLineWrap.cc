...
Nan::Persistent<v8::Function> VtkCubicLineWrap::constructor;
...
void VtkCubicLineWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkCubicLine").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("CubicLine").ToLocalChecked(),tpl->GetFunction());
}

void VtkCubicLineWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkCubicLineWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkCubicLineWrap* obj = new VtkCubicLineWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkCubicLineWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkCubicLineWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
