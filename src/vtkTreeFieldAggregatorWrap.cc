...
void VtkTreeFieldAggregatorWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkTreeFieldAggregator").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("TreeFieldAggregator").ToLocalChecked(),tpl->GetFunction());
}

void VtkTreeFieldAggregatorWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
