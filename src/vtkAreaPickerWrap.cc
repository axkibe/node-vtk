...
Nan::Persistent<v8::Function> VtkAreaPickerWrap::constructor;
...
void VtkAreaPickerWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkAreaPicker").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("AreaPicker").ToLocalChecked(),tpl->GetFunction());
}

void VtkAreaPickerWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkAreaPickerWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkAreaPickerWrap* obj = new VtkAreaPickerWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkAreaPickerWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkAreaPickerWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
