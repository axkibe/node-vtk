...
void VtkGenericCutterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkGenericCutterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkGenericCutterWrap* obj = new VtkGenericCutterWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkGenericCutterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkGenericCutterWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
