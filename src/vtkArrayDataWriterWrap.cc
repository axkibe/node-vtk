...
Nan::Persistent<v8::Function> VtkArrayDataWriterWrap::constructor;
...
void VtkArrayDataWriterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkArrayDataWriter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ArrayDataWriter").ToLocalChecked(),tpl->GetFunction());
}

void VtkArrayDataWriterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkArrayDataWriterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkArrayDataWriterWrap::constructor);
