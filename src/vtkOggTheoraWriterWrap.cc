...
Nan::Persistent<v8::Function> VtkOggTheoraWriterWrap::constructor;
...
void VtkOggTheoraWriterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkGenericMovieWriterWrap::InitTpl(tpl);
	InitTpl(tpl);
...
void VtkOggTheoraWriterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkOggTheoraWriterWrap::constructor);
