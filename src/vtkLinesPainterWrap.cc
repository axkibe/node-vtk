...
Nan::Persistent<v8::Function> VtkLinesPainterWrap::constructor;
...
void VtkLinesPainterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkLinesPainter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("LinesPainter").ToLocalChecked(),tpl->GetFunction());
}

void VtkLinesPainterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkLinesPainterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkLinesPainterWrap::constructor);
