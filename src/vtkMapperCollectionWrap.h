...
#ifndef NATIVE_EXTENSION_VTK_VTKMAPPERCOLLECTIONWRAP_H
#define NATIVE_EXTENSION_VTK_VTKMAPPERCOLLECTIONWRAP_H
...
class VtkMapperCollectionWrap : public VtkCollectionWrap
{
	public:
		...
		VtkMapperCollectionWrap(vtkSmartPointer<vtkMapperCollection>);
		VtkMapperCollectionWrap();
		~VtkMapperCollectionWrap( );
