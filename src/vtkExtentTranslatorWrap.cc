...
void VtkExtentTranslatorWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkExtentTranslator").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ExtentTranslator").ToLocalChecked(),tpl->GetFunction());
}

void VtkExtentTranslatorWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
