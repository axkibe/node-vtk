...
void VtkTextCodecWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkTextCodec").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("TextCodec").ToLocalChecked(),tpl->GetFunction());
}

void VtkTextCodecWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
