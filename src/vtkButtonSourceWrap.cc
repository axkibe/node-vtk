...
void VtkButtonSourceWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkButtonSource").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ButtonSource").ToLocalChecked(),tpl->GetFunction());
}

void VtkButtonSourceWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
