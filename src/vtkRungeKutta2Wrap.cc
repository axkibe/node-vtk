...
void VtkRungeKutta2Wrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkRungeKutta2").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("RungeKutta2").ToLocalChecked(),tpl->GetFunction());
}

void VtkRungeKutta2Wrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
