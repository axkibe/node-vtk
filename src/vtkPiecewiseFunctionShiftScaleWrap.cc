...
void VtkPiecewiseFunctionShiftScaleWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkPiecewiseFunctionAlgorithmWrap::InitTpl(tpl);
	InitTpl(tpl);

	constructor.Reset( tpl->GetFunction() );

	exports->Set(Nan::New("vtkPiecewiseFunctionShiftScale").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("PiecewiseFunctionShiftScale").ToLocalChecked(),tpl->GetFunction());
}

void VtkPiecewiseFunctionShiftScaleWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkPiecewiseFunctionShiftScaleWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPiecewiseFunctionShiftScaleWrap* obj = new VtkPiecewiseFunctionShiftScaleWrap(native);		obj->Wrap(info.This());
	}
	else
	{
