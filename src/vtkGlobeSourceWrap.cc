...
void VtkGlobeSourceWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkGlobeSource").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("GlobeSource").ToLocalChecked(),tpl->GetFunction());
}

void VtkGlobeSourceWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
