...
#ifndef NATIVE_EXTENSION_VTK_VTKWIDGETSETWRAP_H
#define NATIVE_EXTENSION_VTK_VTKWIDGETSETWRAP_H
...
class VtkWidgetSetWrap : public VtkObjectWrap
{
	public:
		...
		VtkWidgetSetWrap(vtkSmartPointer<vtkWidgetSet>);
		VtkWidgetSetWrap();
		~VtkWidgetSetWrap( );
	...
	private:
		...
		static void AddWidget(const Nan::FunctionCallbackInfo<v8::Value>& info);
