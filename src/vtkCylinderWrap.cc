...
void VtkCylinderWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkCylinder").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Cylinder").ToLocalChecked(),tpl->GetFunction());
}

void VtkCylinderWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkCylinderWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkCylinderWrap* obj = new VtkCylinderWrap(native);		obj->Wrap(info.This());
	}
	else
	{
