...
#ifndef NATIVE_EXTENSION_VTK_VTKCONVEXPOINTSETWRAP_H
#define NATIVE_EXTENSION_VTK_VTKCONVEXPOINTSETWRAP_H
...
class VtkConvexPointSetWrap : public VtkCell3DWrap
{
	...
	private:
		...
		static void HasFixedTopology(const Nan::FunctionCallbackInfo<v8::Value>& info);
