...
Nan::Persistent<v8::Function> VtkTexturedSphereSourceWrap::constructor;
...
void VtkTexturedSphereSourceWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkTexturedSphereSource").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("TexturedSphereSource").ToLocalChecked(),tpl->GetFunction());
}

void VtkTexturedSphereSourceWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkTexturedSphereSourceWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkTexturedSphereSourceWrap::constructor);
