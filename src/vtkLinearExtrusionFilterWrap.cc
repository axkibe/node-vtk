...
Nan::Persistent<v8::Function> VtkLinearExtrusionFilterWrap::constructor;
...
void VtkLinearExtrusionFilterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkLinearExtrusionFilter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("LinearExtrusionFilter").ToLocalChecked(),tpl->GetFunction());
}

void VtkLinearExtrusionFilterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkLinearExtrusionFilterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkLinearExtrusionFilterWrap::constructor);
