...
Nan::Persistent<v8::Function> VtkMutableUndirectedGraphWrap::constructor;
...
void VtkMutableUndirectedGraphWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkUndirectedGraphWrap::InitTpl(tpl);
	InitTpl(tpl);

	constructor.Reset( tpl->GetFunction() );

	exports->Set(Nan::New("vtkMutableUndirectedGraph").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("MutableUndirectedGraph").ToLocalChecked(),tpl->GetFunction());
}

void VtkMutableUndirectedGraphWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkMutableUndirectedGraphWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkMutableUndirectedGraphWrap::constructor);
