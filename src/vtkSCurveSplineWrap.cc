...
void VtkSCurveSplineWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkSCurveSplineWrap* obj = new VtkSCurveSplineWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkSCurveSplineWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkSCurveSplineWrap *wrapper = ObjectWrap::Unwrap<VtkSCurveSplineWrap>(info.Holder());
	vtkSCurveSpline *native = (vtkSCurveSpline *)wrapper->native.GetPointer();
	char const * r;
...
void VtkSCurveSplineWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkSCurveSplineWrap *wrapper = ObjectWrap::Unwrap<VtkSCurveSplineWrap>(info.Holder());
	vtkSCurveSpline *native = (vtkSCurveSpline *)wrapper->native.GetPointer();
...
void VtkSCurveSplineWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkSCurveSplineWrap::constructor);
