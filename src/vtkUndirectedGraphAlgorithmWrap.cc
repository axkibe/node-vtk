...
Nan::Persistent<v8::Function> VtkUndirectedGraphAlgorithmWrap::constructor;
...
void VtkUndirectedGraphAlgorithmWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkUndirectedGraphAlgorithm").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("UndirectedGraphAlgorithm").ToLocalChecked(),tpl->GetFunction());
}

void VtkUndirectedGraphAlgorithmWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkUndirectedGraphAlgorithmWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkUndirectedGraphAlgorithmWrap* obj = new VtkUndirectedGraphAlgorithmWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkUndirectedGraphAlgorithmWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkUndirectedGraphAlgorithmWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
