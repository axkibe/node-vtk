...
Nan::Persistent<v8::Function> VtkTableToSparseArrayWrap::constructor;
...
void VtkTableToSparseArrayWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkTableToSparseArrayWrap* obj = new VtkTableToSparseArrayWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkTableToSparseArrayWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkTableToSparseArrayWrap::constructor);
