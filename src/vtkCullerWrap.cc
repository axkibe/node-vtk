...
Nan::Persistent<v8::Function> VtkCullerWrap::constructor;
...
void VtkCullerWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkCuller").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Culler").ToLocalChecked(),tpl->GetFunction());
}

void VtkCullerWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
