...
void VtkParametricEnneperWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkParametricEnneper").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ParametricEnneper").ToLocalChecked(),tpl->GetFunction());
}

void VtkParametricEnneperWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
