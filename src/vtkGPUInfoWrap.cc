...
void VtkGPUInfoWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkGPUInfo").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("GPUInfo").ToLocalChecked(),tpl->GetFunction());
}

void VtkGPUInfoWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
