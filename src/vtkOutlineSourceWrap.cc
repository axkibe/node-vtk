...
Nan::Persistent<v8::Function> VtkOutlineSourceWrap::constructor;
...
void VtkOutlineSourceWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkOutlineSource").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("OutlineSource").ToLocalChecked(),tpl->GetFunction());
}

void VtkOutlineSourceWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkOutlineSourceWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkOutlineSourceWrap::constructor);
