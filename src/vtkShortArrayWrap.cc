...
Nan::Persistent<v8::Function> VtkShortArrayWrap::constructor;
...
void VtkShortArrayWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkShortArray").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ShortArray").ToLocalChecked(),tpl->GetFunction());
}

void VtkShortArrayWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkShortArrayWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkShortArrayWrap* obj = new VtkShortArrayWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkShortArrayWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkShortArrayWrap::constructor);
