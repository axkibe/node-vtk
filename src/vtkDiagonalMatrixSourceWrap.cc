...
Nan::Persistent<v8::Function> VtkDiagonalMatrixSourceWrap::constructor;
...
void VtkDiagonalMatrixSourceWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkDiagonalMatrixSourceWrap* obj = new VtkDiagonalMatrixSourceWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkDiagonalMatrixSourceWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkDiagonalMatrixSourceWrap::constructor);
