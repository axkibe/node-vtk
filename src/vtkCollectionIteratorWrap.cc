...
void VtkCollectionIteratorWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkCollectionIterator").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("CollectionIterator").ToLocalChecked(),tpl->GetFunction());
}

void VtkCollectionIteratorWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
