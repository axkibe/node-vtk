...
void VtkCircularLayoutStrategyWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkCircularLayoutStrategy").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("CircularLayoutStrategy").ToLocalChecked(),tpl->GetFunction());
}

void VtkCircularLayoutStrategyWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
