...
Nan::Persistent<v8::Function> VtkEmptyRepresentationWrap::constructor;
...
void VtkEmptyRepresentationWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkEmptyRepresentationWrap* obj = new VtkEmptyRepresentationWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkEmptyRepresentationWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkEmptyRepresentationWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
