...
void VtkParametricBoyWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkParametricBoy").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ParametricBoy").ToLocalChecked(),tpl->GetFunction());
}

void VtkParametricBoyWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
