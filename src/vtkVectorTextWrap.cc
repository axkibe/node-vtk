...
Nan::Persistent<v8::Function> VtkVectorTextWrap::constructor;
...
void VtkVectorTextWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkVectorText").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("VectorText").ToLocalChecked(),tpl->GetFunction());
}

void VtkVectorTextWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkVectorTextWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkVectorTextWrap::constructor);
