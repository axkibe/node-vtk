...
Nan::Persistent<v8::Function> VtkImplicitPlaneWidgetWrap::constructor;
...
void VtkImplicitPlaneWidgetWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkImplicitPlaneWidgetWrap* obj = new VtkImplicitPlaneWidgetWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkImplicitPlaneWidgetWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkImplicitPlaneWidgetWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
