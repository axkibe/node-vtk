...
Nan::Persistent<v8::Function> VtkGhostArrayWrap::constructor;
...
void VtkGhostArrayWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkGhostArray").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("GhostArray").ToLocalChecked(),tpl->GetFunction());
}

void VtkGhostArrayWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkGhostArrayWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkGhostArrayWrap::constructor);
