...
Nan::Persistent<v8::Function> VtkQuadWrap::constructor;
...
void VtkQuadWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkQuad").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Quad").ToLocalChecked(),tpl->GetFunction());
}

void VtkQuadWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkQuadWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkQuadWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
