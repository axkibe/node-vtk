...
void VtkSuperquadricWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkSuperquadric").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Superquadric").ToLocalChecked(),tpl->GetFunction());
}

void VtkSuperquadricWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
