...
Nan::Persistent<v8::Function> VtkContextBufferIdWrap::constructor;
...
void VtkContextBufferIdWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkAbstractContextBufferIdWrap::InitTpl(tpl);
	InitTpl(tpl);
...
void VtkContextBufferIdWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkContextBufferIdWrap::constructor);
