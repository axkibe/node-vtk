...
void VtkTubeFilterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkTubeFilter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("TubeFilter").ToLocalChecked(),tpl->GetFunction());
}

void VtkTubeFilterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
