...
Nan::Persistent<v8::Function> VtkImageTracerWidgetWrap::constructor;
...
void VtkImageTracerWidgetWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
	...
	Nan::SetPrototypeMethod(tpl, "SetProp", SetProp);
	Nan::SetPrototypeMethod(tpl, "setProp", SetProp);
...
void VtkImageTracerWidgetWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkImageTracerWidgetWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
...
void VtkImageTracerWidgetWrap::SetProp(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkImageTracerWidgetWrap *wrapper = ObjectWrap::Unwrap<VtkImageTracerWidgetWrap>(info.Holder());
	vtkImageTracerWidget *native = (vtkImageTracerWidget *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject())
