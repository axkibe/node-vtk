...
Nan::Persistent<v8::Function> VtkCellWrap::constructor;
...
void VtkCellWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkCell").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Cell").ToLocalChecked(),tpl->GetFunction());
}

void VtkCellWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
