...
Nan::Persistent<v8::Function> VtkArrayDataAlgorithmWrap::constructor;
...
void VtkArrayDataAlgorithmWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkArrayDataAlgorithm").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ArrayDataAlgorithm").ToLocalChecked(),tpl->GetFunction());
}

void VtkArrayDataAlgorithmWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkArrayDataAlgorithmWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkArrayDataAlgorithmWrap* obj = new VtkArrayDataAlgorithmWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkArrayDataAlgorithmWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkArrayDataAlgorithmWrap::GetOutput(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() > 0 && info[0]->IsInt32())
	{
		...
		v8::Local<v8::Function> cons =
			Nan::New<v8::Function>(VtkArrayDataWrap::constructor);
...
void VtkArrayDataAlgorithmWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkArrayDataAlgorithmWrap *wrapper = ObjectWrap::Unwrap<VtkArrayDataAlgorithmWrap>(info.Holder());
	vtkArrayDataAlgorithm *native = (vtkArrayDataAlgorithm *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkArrayDataAlgorithmWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkArrayDataAlgorithmWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
