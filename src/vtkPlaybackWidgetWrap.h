...
#ifndef NATIVE_EXTENSION_VTK_VTKPLAYBACKWIDGETWRAP_H
#define NATIVE_EXTENSION_VTK_VTKPLAYBACKWIDGETWRAP_H
...
class VtkPlaybackWidgetWrap : public VtkBorderWidgetWrap
{
	public:
		...
		VtkPlaybackWidgetWrap(vtkSmartPointer<vtkPlaybackWidget>);
		VtkPlaybackWidgetWrap();
		~VtkPlaybackWidgetWrap( );
