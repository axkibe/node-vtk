...
Nan::Persistent<v8::Function> VtkDelaunay3DWrap::constructor;
...
void VtkDelaunay3DWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkDelaunay3D").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Delaunay3D").ToLocalChecked(),tpl->GetFunction());
}

void VtkDelaunay3DWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkDelaunay3DWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkDelaunay3DWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
