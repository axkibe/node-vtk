...
void VtkGPUInfoListWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkGPUInfoList").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("GPUInfoList").ToLocalChecked(),tpl->GetFunction());
}

void VtkGPUInfoListWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
