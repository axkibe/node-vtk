...
Nan::Persistent<v8::Function> VtkMutexLockWrap::constructor;
...
void VtkMutexLockWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkMutexLock").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("MutexLock").ToLocalChecked(),tpl->GetFunction());
}

void VtkMutexLockWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkMutexLockWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkMutexLockWrap* obj = new VtkMutexLockWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkMutexLockWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkMutexLockWrap::constructor);
