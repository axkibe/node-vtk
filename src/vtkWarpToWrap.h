...
#ifndef NATIVE_EXTENSION_VTK_VTKWARPTOWRAP_H
#define NATIVE_EXTENSION_VTK_VTKWARPTOWRAP_H
...
class VtkWarpToWrap : public VtkPointSetAlgorithmWrap
{
	public:
		...
		VtkWarpToWrap(vtkSmartPointer<vtkWarpTo>);
		VtkWarpToWrap();
		~VtkWarpToWrap( );
	...
	private:
		...
		static void AbsoluteOff(const Nan::FunctionCallbackInfo<v8::Value>& info);
		static void AbsoluteOn(const Nan::FunctionCallbackInfo<v8::Value>& info);
