...
void VtkMedicalImagePropertiesWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkMedicalImageProperties").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("MedicalImageProperties").ToLocalChecked(),tpl->GetFunction());
}

void VtkMedicalImagePropertiesWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
