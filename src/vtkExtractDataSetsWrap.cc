...
Nan::Persistent<v8::Function> VtkExtractDataSetsWrap::constructor;
...
void VtkExtractDataSetsWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkExtractDataSets").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ExtractDataSets").ToLocalChecked(),tpl->GetFunction());
}

void VtkExtractDataSetsWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkExtractDataSetsWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkExtractDataSetsWrap::constructor);
