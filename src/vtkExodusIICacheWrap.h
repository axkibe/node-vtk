...
#ifndef NATIVE_EXTENSION_VTK_VTKEXODUSIICACHEWRAP_H
#define NATIVE_EXTENSION_VTK_VTKEXODUSIICACHEWRAP_H
...
class VtkExodusIICacheWrap : public VtkObjectWrap
{
	public:
		...
		VtkExodusIICacheWrap(vtkSmartPointer<vtkExodusIICache>);
		VtkExodusIICacheWrap();
		~VtkExodusIICacheWrap( );
	...
	private:
		...
		static void GetSpaceLeft(const Nan::FunctionCallbackInfo<v8::Value>& info);
