...
Nan::Persistent<v8::Function> VtkContextClipWrap::constructor;
...
void VtkContextClipWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkContextClipWrap* obj = new VtkContextClipWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkContextClipWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkContextClipWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkContextClipWrap::constructor);
