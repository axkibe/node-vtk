...
void VtkSQLDatabaseTableSourceWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkSQLDatabaseTableSource").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("SQLDatabaseTableSource").ToLocalChecked(),tpl->GetFunction());
}

void VtkSQLDatabaseTableSourceWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
