...
Nan::Persistent<v8::Function> VtkSimpleBondPerceiverWrap::constructor;
...
void VtkSimpleBondPerceiverWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkSimpleBondPerceiverWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkSimpleBondPerceiverWrap::constructor);
