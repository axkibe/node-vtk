...
void VtkQuadricDecimationWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkQuadricDecimation").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("QuadricDecimation").ToLocalChecked(),tpl->GetFunction());
}

void VtkQuadricDecimationWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
