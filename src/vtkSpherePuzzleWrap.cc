...
void VtkSpherePuzzleWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkSpherePuzzle").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("SpherePuzzle").ToLocalChecked(),tpl->GetFunction());
}

void VtkSpherePuzzleWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
