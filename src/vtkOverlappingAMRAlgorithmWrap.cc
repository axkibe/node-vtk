...
Nan::Persistent<v8::Function> VtkOverlappingAMRAlgorithmWrap::constructor;
...
void VtkOverlappingAMRAlgorithmWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkOverlappingAMRAlgorithm").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("OverlappingAMRAlgorithm").ToLocalChecked(),tpl->GetFunction());
}

void VtkOverlappingAMRAlgorithmWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkOverlappingAMRAlgorithmWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkOverlappingAMRAlgorithmWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
