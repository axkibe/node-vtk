...
void VtkImageNormalizeWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkImageNormalize").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ImageNormalize").ToLocalChecked(),tpl->GetFunction());
}

void VtkImageNormalizeWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
