...
Nan::Persistent<v8::Function> VtkSTLWriterWrap::constructor;
...
void VtkSTLWriterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkSTLWriter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("STLWriter").ToLocalChecked(),tpl->GetFunction());
}

void VtkSTLWriterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkSTLWriterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkSTLWriterWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
