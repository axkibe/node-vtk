...
Nan::Persistent<v8::Function> VtkGeoRandomGraphSourceWrap::constructor;
...
void VtkGeoRandomGraphSourceWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkGeoRandomGraphSource").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("GeoRandomGraphSource").ToLocalChecked(),tpl->GetFunction());
}

void VtkGeoRandomGraphSourceWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkGeoRandomGraphSourceWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkGeoRandomGraphSourceWrap::constructor);
