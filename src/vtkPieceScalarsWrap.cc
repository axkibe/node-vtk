...
void VtkPieceScalarsWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkPieceScalars").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("PieceScalars").ToLocalChecked(),tpl->GetFunction());
}

void VtkPieceScalarsWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
