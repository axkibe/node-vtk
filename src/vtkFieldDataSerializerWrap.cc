...
void VtkFieldDataSerializerWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkFieldDataSerializer").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("FieldDataSerializer").ToLocalChecked(),tpl->GetFunction());
}

void VtkFieldDataSerializerWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
