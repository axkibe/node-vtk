...
void VtkHardwareSelectionPolyDataPainterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkStandardPolyDataPainterWrap::InitTpl(tpl);
	InitTpl(tpl);
...
void VtkHardwareSelectionPolyDataPainterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkHardwareSelectionPolyDataPainterWrap* obj = new VtkHardwareSelectionPolyDataPainterWrap(native);		obj->Wrap(info.This());
	}
	else
	{
