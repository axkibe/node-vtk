...
Nan::Persistent<v8::Function> VtkCPExodusIIElementBlockWrap::constructor;
...
void VtkCPExodusIIElementBlockWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkUnstructuredGridBaseWrap::InitTpl(tpl);
	InitTpl(tpl);

	constructor.Reset( tpl->GetFunction() );

	exports->Set(Nan::New("vtkCPExodusIIElementBlock").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("CPExodusIIElementBlock").ToLocalChecked(),tpl->GetFunction());
}

void VtkCPExodusIIElementBlockWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkCPExodusIIElementBlockWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkCPExodusIIElementBlockWrap* obj = new VtkCPExodusIIElementBlockWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkCPExodusIIElementBlockWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkCPExodusIIElementBlockWrap::constructor);
