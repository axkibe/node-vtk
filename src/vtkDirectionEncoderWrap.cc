...
void VtkDirectionEncoderWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkDirectionEncoder").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("DirectionEncoder").ToLocalChecked(),tpl->GetFunction());
}

void VtkDirectionEncoderWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
