...
void VtkParticleReaderWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkParticleReader").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ParticleReader").ToLocalChecked(),tpl->GetFunction());
}

void VtkParticleReaderWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkParticleReaderWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkParticleReaderWrap* obj = new VtkParticleReaderWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkParticleReaderWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkParticleReaderWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkParticleReaderWrap *wrapper = ObjectWrap::Unwrap<VtkParticleReaderWrap>(info.Holder());
	vtkParticleReader *native = (vtkParticleReader *)wrapper->native.GetPointer();
