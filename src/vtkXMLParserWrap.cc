...
void VtkXMLParserWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkXMLParser").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("XMLParser").ToLocalChecked(),tpl->GetFunction());
}

void VtkXMLParserWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
