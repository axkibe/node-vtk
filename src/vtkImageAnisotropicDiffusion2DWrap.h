...
#ifndef NATIVE_EXTENSION_VTK_VTKIMAGEANISOTROPICDIFFUSION2DWRAP_H
#define NATIVE_EXTENSION_VTK_VTKIMAGEANISOTROPICDIFFUSION2DWRAP_H
...
class VtkImageAnisotropicDiffusion2DWrap : public VtkImageSpatialAlgorithmWrap
{
	public:
		...
		VtkImageAnisotropicDiffusion2DWrap(vtkSmartPointer<vtkImageAnisotropicDiffusion2D>);
		VtkImageAnisotropicDiffusion2DWrap();
		~VtkImageAnisotropicDiffusion2DWrap( );
