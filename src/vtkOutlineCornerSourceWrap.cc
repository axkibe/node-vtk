...
void VtkOutlineCornerSourceWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkOutlineSourceWrap::InitTpl(tpl);
	InitTpl(tpl);
...
void VtkOutlineCornerSourceWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkOutlineCornerSourceWrap* obj = new VtkOutlineCornerSourceWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkOutlineCornerSourceWrap::GetClassName(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkOutlineCornerSourceWrap::GetOutputPointsPrecision(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOutlineCornerSourceWrap *wrapper = ObjectWrap::Unwrap<VtkOutlineCornerSourceWrap>(info.Holder());
	vtkOutlineCornerSource *native = (vtkOutlineCornerSource *)wrapper->native.GetPointer();
	int r;
...
void VtkOutlineCornerSourceWrap::IsA(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOutlineCornerSourceWrap *wrapper = ObjectWrap::Unwrap<VtkOutlineCornerSourceWrap>(info.Holder());
	vtkOutlineCornerSource *native = (vtkOutlineCornerSource *)wrapper->native.GetPointer();
...
void VtkOutlineCornerSourceWrap::SetOutputPointsPrecision(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkOutlineCornerSourceWrap *wrapper = ObjectWrap::Unwrap<VtkOutlineCornerSourceWrap>(info.Holder());
	vtkOutlineCornerSource *native = (vtkOutlineCornerSource *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
