...
void VtkParametricRandomHillsWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkParametricRandomHills").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ParametricRandomHills").ToLocalChecked(),tpl->GetFunction());
}

void VtkParametricRandomHillsWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
