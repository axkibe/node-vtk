...
#ifndef NATIVE_EXTENSION_VTK_VTKPLINEAREXTRUSIONFILTERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKPLINEAREXTRUSIONFILTERWRAP_H
...
class VtkPLinearExtrusionFilterWrap : public VtkLinearExtrusionFilterWrap
{
	public:
		...
		VtkPLinearExtrusionFilterWrap(vtkSmartPointer<vtkPLinearExtrusionFilter>);
		VtkPLinearExtrusionFilterWrap();
		~VtkPLinearExtrusionFilterWrap( );
