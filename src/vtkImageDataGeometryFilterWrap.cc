...
void VtkImageDataGeometryFilterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkImageDataGeometryFilter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ImageDataGeometryFilter").ToLocalChecked(),tpl->GetFunction());
}

void VtkImageDataGeometryFilterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
