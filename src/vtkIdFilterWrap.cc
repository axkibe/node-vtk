...
void VtkIdFilterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkIdFilter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("IdFilter").ToLocalChecked(),tpl->GetFunction());
}

void VtkIdFilterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkIdFilterWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkIdFilterWrap* obj = new VtkIdFilterWrap(native);		obj->Wrap(info.This());
	}
	else
	{
