...
Nan::Persistent<v8::Function> VtkDiscretizableColorTransferFunctionWrap::constructor;
...
void VtkDiscretizableColorTransferFunctionWrap::Init(v8::Local<v8::Object> exports)
{
	...
	VtkColorTransferFunctionWrap::InitTpl(tpl);
	InitTpl(tpl);
...
void VtkDiscretizableColorTransferFunctionWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkDiscretizableColorTransferFunctionWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
