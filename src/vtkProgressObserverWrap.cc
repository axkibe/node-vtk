...
void VtkProgressObserverWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkProgressObserver").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ProgressObserver").ToLocalChecked(),tpl->GetFunction());
}

void VtkProgressObserverWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
