...
void VtkAMRCutPlaneWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkAMRCutPlane").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("AMRCutPlane").ToLocalChecked(),tpl->GetFunction());
}

void VtkAMRCutPlaneWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
