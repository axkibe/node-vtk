...
void VtkStripperWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkStripper").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Stripper").ToLocalChecked(),tpl->GetFunction());
}

void VtkStripperWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
