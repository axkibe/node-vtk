...
Nan::Persistent<v8::Function> VtkSocketWrap::constructor;
...
void VtkSocketWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkSocket").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Socket").ToLocalChecked(),tpl->GetFunction());
}

void VtkSocketWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
