...
void VtkTableExtentTranslatorWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkTableExtentTranslator").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("TableExtentTranslator").ToLocalChecked(),tpl->GetFunction());
}

void VtkTableExtentTranslatorWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
