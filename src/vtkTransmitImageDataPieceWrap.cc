...
Nan::Persistent<v8::Function> VtkTransmitImageDataPieceWrap::constructor;
...
void VtkTransmitImageDataPieceWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkTransmitImageDataPiece").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("TransmitImageDataPiece").ToLocalChecked(),tpl->GetFunction());
}

void VtkTransmitImageDataPieceWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkTransmitImageDataPieceWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkTransmitImageDataPieceWrap* obj = new VtkTransmitImageDataPieceWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkTransmitImageDataPieceWrap::CreateGhostCellsOff(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
...
void VtkTransmitImageDataPieceWrap::CreateGhostCellsOn(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTransmitImageDataPieceWrap *wrapper = ObjectWrap::Unwrap<VtkTransmitImageDataPieceWrap>(info.Holder());
	vtkTransmitImageDataPiece *native = (vtkTransmitImageDataPiece *)wrapper->native.GetPointer();
	if(info.Length() != 0)
...
void VtkTransmitImageDataPieceWrap::GetController(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTransmitImageDataPieceWrap *wrapper = ObjectWrap::Unwrap<VtkTransmitImageDataPieceWrap>(info.Holder());
	vtkTransmitImageDataPiece *native = (vtkTransmitImageDataPiece *)wrapper->native.GetPointer();
...
void VtkTransmitImageDataPieceWrap::GetCreateGhostCells(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTransmitImageDataPieceWrap *wrapper = ObjectWrap::Unwrap<VtkTransmitImageDataPieceWrap>(info.Holder());
	vtkTransmitImageDataPiece *native = (vtkTransmitImageDataPiece *)wrapper->native.GetPointer();
	int r;
...
void VtkTransmitImageDataPieceWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkTransmitImageDataPieceWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
...
void VtkTransmitImageDataPieceWrap::SetController(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTransmitImageDataPieceWrap *wrapper = ObjectWrap::Unwrap<VtkTransmitImageDataPieceWrap>(info.Holder());
	vtkTransmitImageDataPiece *native = (vtkTransmitImageDataPiece *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsObject())
...
void VtkTransmitImageDataPieceWrap::SetCreateGhostCells(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkTransmitImageDataPieceWrap *wrapper = ObjectWrap::Unwrap<VtkTransmitImageDataPieceWrap>(info.Holder());
	vtkTransmitImageDataPiece *native = (vtkTransmitImageDataPiece *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
