...
Nan::Persistent<v8::Function> VtkParametricFunctionWrap::constructor;
...
void VtkParametricFunctionWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkParametricFunction").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ParametricFunction").ToLocalChecked(),tpl->GetFunction());
}

void VtkParametricFunctionWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
