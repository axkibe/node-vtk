...
void VtkGeoAlignedImageSourceWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkGeoAlignedImageSource").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("GeoAlignedImageSource").ToLocalChecked(),tpl->GetFunction());
}

void VtkGeoAlignedImageSourceWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
