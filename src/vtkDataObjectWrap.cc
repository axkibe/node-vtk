...
Nan::Persistent<v8::Function> VtkDataObjectWrap::constructor;
...
void VtkDataObjectWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkDataObject").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("DataObject").ToLocalChecked(),tpl->GetFunction());
}

void VtkDataObjectWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
	...
	Nan::SetPrototypeMethod(tpl, "DATA_GEOMETRY_UNMODIFIED", DATA_GEOMETRY_UNMODIFIED);
	...
	Nan::SetPrototypeMethod(tpl, "DATA_RESOLUTION", DATA_RESOLUTION);
	...
	Nan::SetPrototypeMethod(tpl, "FIELD_ARRAY_NAME", FIELD_ARRAY_NAME);
	...
	Nan::SetPrototypeMethod(tpl, "PIECE_FIELD_RANGE", PIECE_FIELD_RANGE);
...
void VtkDataObjectWrap::DATA_GEOMETRY_UNMODIFIED(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataObjectWrap *wrapper = ObjectWrap::Unwrap<VtkDataObjectWrap>(info.Holder());
	vtkDataObject *native = (vtkDataObject *)wrapper->native.GetPointer();
	vtkInformationIntegerKey * r;
	...
	r = native->DATA_GEOMETRY_UNMODIFIED();
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkInformationIntegerKeyWrap::constructor);
...
void VtkDataObjectWrap::DATA_RESOLUTION(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataObjectWrap *wrapper = ObjectWrap::Unwrap<VtkDataObjectWrap>(info.Holder());
	vtkDataObject *native = (vtkDataObject *)wrapper->native.GetPointer();
...
void VtkDataObjectWrap::FIELD_ARRAY_NAME(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataObjectWrap *wrapper = ObjectWrap::Unwrap<VtkDataObjectWrap>(info.Holder());
	vtkDataObject *native = (vtkDataObject *)wrapper->native.GetPointer();
	vtkInformationStringKey * r;
...
void VtkDataObjectWrap::PIECE_FIELD_RANGE(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkDataObjectWrap *wrapper = ObjectWrap::Unwrap<VtkDataObjectWrap>(info.Holder());
	vtkDataObject *native = (vtkDataObject *)wrapper->native.GetPointer();
	vtkInformationDoubleVectorKey * r;
