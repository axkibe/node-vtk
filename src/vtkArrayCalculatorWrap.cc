...
void VtkArrayCalculatorWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkArrayCalculator").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ArrayCalculator").ToLocalChecked(),tpl->GetFunction());
}

void VtkArrayCalculatorWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
