...
void VtkMaskFieldsWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkMaskFields").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("MaskFields").ToLocalChecked(),tpl->GetFunction());
}

void VtkMaskFieldsWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
