...
Nan::Persistent<v8::Function> VtkPolyDataWrap::constructor;
...
void VtkPolyDataWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkPolyData").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("PolyData").ToLocalChecked(),tpl->GetFunction());
}

void VtkPolyDataWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
	...
	Nan::SetPrototypeMethod(tpl, "InsertNextLinkedPoint", InsertNextLinkedPoint);
	Nan::SetPrototypeMethod(tpl, "insertNextLinkedPoint", InsertNextLinkedPoint);
...
void VtkPolyDataWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPolyDataWrap* obj = new VtkPolyDataWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkPolyDataWrap::InsertNextCell(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPolyDataWrap *wrapper = ObjectWrap::Unwrap<VtkPolyDataWrap>(info.Holder());
	vtkPolyData *native = (vtkPolyData *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
...
void VtkPolyDataWrap::InsertNextLinkedPoint(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	VtkPolyDataWrap *wrapper = ObjectWrap::Unwrap<VtkPolyDataWrap>(info.Holder());
	vtkPolyData *native = (vtkPolyData *)wrapper->native.GetPointer();
	if(info.Length() > 0 && info[0]->IsInt32())
	{
		...
		r = native->InsertNextLinkedPoint(
			info[0]->Int32Value()
		);
		info.GetReturnValue().Set(Nan::New(r));
		return;
