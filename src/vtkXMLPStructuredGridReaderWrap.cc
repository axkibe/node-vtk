...
Nan::Persistent<v8::Function> VtkXMLPStructuredGridReaderWrap::constructor;
...
void VtkXMLPStructuredGridReaderWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkXMLPStructuredGridReader").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("XMLPStructuredGridReader").ToLocalChecked(),tpl->GetFunction());
}

void VtkXMLPStructuredGridReaderWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkXMLPStructuredGridReaderWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkXMLPStructuredGridReaderWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
