...
void VtkFixedPointVolumeRayCastCompositeShadeHelperWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkFixedPointVolumeRayCastCompositeShadeHelper").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("FixedPointVolumeRayCastCompositeShadeHelper").ToLocalChecked(),tpl->GetFunction());
}

void VtkFixedPointVolumeRayCastCompositeShadeHelperWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkFixedPointVolumeRayCastCompositeShadeHelperWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkFixedPointVolumeRayCastCompositeShadeHelperWrap* obj = new VtkFixedPointVolumeRayCastCompositeShadeHelperWrap(native);		obj->Wrap(info.This());
	}
	else
	{
