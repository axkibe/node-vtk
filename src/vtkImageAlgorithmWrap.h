...
#ifndef NATIVE_EXTENSION_VTK_VTKIMAGEALGORITHMWRAP_H
#define NATIVE_EXTENSION_VTK_VTKIMAGEALGORITHMWRAP_H
...
class VtkImageAlgorithmWrap : public VtkAlgorithmWrap
{
	public:
		...
		VtkImageAlgorithmWrap(vtkSmartPointer<vtkImageAlgorithm>);
		VtkImageAlgorithmWrap();
		~VtkImageAlgorithmWrap( );
	...
	private:
		...
		static void GetImageDataInput(const Nan::FunctionCallbackInfo<v8::Value>& info);
