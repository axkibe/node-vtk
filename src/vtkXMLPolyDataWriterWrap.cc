...
void VtkXMLPolyDataWriterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkXMLPolyDataWriter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("XMLPolyDataWriter").ToLocalChecked(),tpl->GetFunction());
}

void VtkXMLPolyDataWriterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
