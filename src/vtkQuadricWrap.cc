...
void VtkQuadricWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkQuadric").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("Quadric").ToLocalChecked(),tpl->GetFunction());
}

void VtkQuadricWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
