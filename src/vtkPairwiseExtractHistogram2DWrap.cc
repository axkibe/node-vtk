...
Nan::Persistent<v8::Function> VtkPairwiseExtractHistogram2DWrap::constructor;
...
void VtkPairwiseExtractHistogram2DWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkPairwiseExtractHistogram2DWrap* obj = new VtkPairwiseExtractHistogram2DWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkPairwiseExtractHistogram2DWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkPairwiseExtractHistogram2DWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
