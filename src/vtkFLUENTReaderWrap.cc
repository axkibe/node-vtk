...
Nan::Persistent<v8::Function> VtkFLUENTReaderWrap::constructor;
...
void VtkFLUENTReaderWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkFLUENTReaderWrap* obj = new VtkFLUENTReaderWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkFLUENTReaderWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkFLUENTReaderWrap::constructor);
