...
Nan::Persistent<v8::Function> VtkEmptyCellWrap::constructor;
...
void VtkEmptyCellWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkEmptyCell").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("EmptyCell").ToLocalChecked(),tpl->GetFunction());
}

void VtkEmptyCellWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkEmptyCellWrap::New(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	if(info.Length() == 0)
	{
		...
		VtkEmptyCellWrap* obj = new VtkEmptyCellWrap(native);		obj->Wrap(info.This());
	}
	else
	{
...
void VtkEmptyCellWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkEmptyCellWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
