...
#ifndef NATIVE_EXTENSION_VTK_VTKGENERICGEOMETRYFILTERWRAP_H
#define NATIVE_EXTENSION_VTK_VTKGENERICGEOMETRYFILTERWRAP_H
...
class VtkGenericGeometryFilterWrap : public VtkPolyDataAlgorithmWrap
{
	public:
		...
		VtkGenericGeometryFilterWrap(vtkSmartPointer<vtkGenericGeometryFilter>);
		VtkGenericGeometryFilterWrap();
		~VtkGenericGeometryFilterWrap( );
