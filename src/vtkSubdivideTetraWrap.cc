...
void VtkSubdivideTetraWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkSubdivideTetra").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("SubdivideTetra").ToLocalChecked(),tpl->GetFunction());
}

void VtkSubdivideTetraWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
