...
void VtkArrayIteratorWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkArrayIterator").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ArrayIterator").ToLocalChecked(),tpl->GetFunction());
}

void VtkArrayIteratorWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
