...
Nan::Persistent<v8::Function> VtkImageToPolyDataFilterWrap::constructor;
...
void VtkImageToPolyDataFilterWrap::Init(v8::Local<v8::Object> exports)
{
	...
	exports->Set(Nan::New("vtkImageToPolyDataFilter").ToLocalChecked(),tpl->GetFunction());
	exports->Set(Nan::New("ImageToPolyDataFilter").ToLocalChecked(),tpl->GetFunction());
}

void VtkImageToPolyDataFilterWrap::InitTpl(v8::Local<v8::FunctionTemplate> tpl)
{
...
void VtkImageToPolyDataFilterWrap::NewInstance(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
	...
	v8::Local<v8::Value> argv[1] =
		{ Nan::New(vtkNodeJsNoWrap) };
	v8::Local<v8::Function> cons =
		Nan::New<v8::Function>(VtkImageToPolyDataFilterWrap::constructor);
	v8::Local<v8::Object> wo = cons->NewInstance(1, argv);
